...
// ===== c8: الاختبارات الفنية — الناقص =====

  "c8-s1-0": {
    title: "Visual Inspection",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "مبتدئ",
    objectives: [
      "معرفة ما يُفحص في Visual Inspection قبل تركيب الكيابل",
      "إتقان إجراء الفحص المنهجي للطبل والكيبل",
      "توثيق نتائج الفحص في نماذج SEC المعتمدة",
      "تحديد حالات الرفض والإجراء المتخذ"
    ],
    content: `<h3>Visual Inspection — الدفاع الأول عن الجودة</h3><p><strong>Visual Inspection</strong> أبسط الاختبارات لكنه لا يُستهان به — كثير من العيوب الخطيرة تُكتشف بالعين المدرّبة قبل أي اختبار كهربائي. يُجرى عند استلام الكيابل في الموقع وقبل أي سحب أو تركيب.</p><h3>الفحص على مستوى الطبل</h3><ul><li><strong>الطبل نفسه</strong>: تأكد من عدم وجود تشوه أو كسر في الجوانب الخشبية/المعدنية. طبل مُشوَّه = كيبل داخله قد تعرض لضغط غير طبيعي</li><li><strong>Drum Label</strong>: طابق رقم الطبل، نوع الكيبل، الطول، Batch Number مع Material Requisition Order</li><li><strong>اتجاه الطبل</strong>: تحقق من علامات A-End وB-End لتجنب سحب الكيبل بالعكس</li></ul><h3>الفحص على مستوى الكيبل</h3><ul><li><strong>HDPE Outer Jacket</strong>: ابحث عن خدوش عميقة > 0.5mm، بقع بيضاء (Crazing)، تشقق أو تشوه</li><li><strong>أطراف الكيابل</strong>: يجب أن تكون مختومة بـ Heat Shrink End Caps — كيبل مكشوف يحتاج Moisture Test إضافياً</li><li><strong>لون الـ Jacket</strong>: أسود موحد — أي تغيير يُشير لتعرض حراري أو كيميائي</li></ul><h3>التوثيق</h3><p>يُملأ <strong>Incoming Material Inspection Report</strong> موقَّعاً من مفتش QC ومفتش SEC. يُحدد القبول المباشر أو القبول المشروط أو الرفض مع سبب مفصَّل.</p>`,
    tools: [
      { name: "Measuring Tape", icon: "ruler" },
      { name: "Digital Camera", icon: "camera" },
      { name: "Inspection Report Form", icon: "file-text" },
      { name: "Drum Label Check Checklist", icon: "check-circle" }
    ],
    hseWarnings: [
      "الصعود على الطبل للفحص دون سلم ثابت — استخدم منصة آمنة دائماً",
      "الطبل الكبير (> 10 طن) ينتقل فجأة إذا لم يُثبَّت — تأكد من Chocks قبل الفحص"
    ],
    commonMistakes: [
      "اعتبار Drum Label كافياً دون فحص الكيبل الظاهر — الطبل قد يحتوي كيابل من دفعات مختلفة",
      "إهمال توثيق الملاحظات البسيطة — تراكمها يكشف مشكلة منهجية في النقل"
    ],
    references: [
      "SEC TMSS — Material Receiving Inspection",
      "IEC 62067 — Visual Inspection Requirements",
      "SEC ITP — Visual Inspection Hold Points"
    ]
  },

  "c8-s1-1": {
    title: "Sheath Integrity Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من Sheath Integrity Test ومتى يُجرى",
      "إتقان إجراء الاختبار بـ 10 kV DC بشكل صحيح وآمن",
      "تفسير النتائج والحكم على سلامة الـ Outer Jacket",
      "معرفة إجراء تحديد موقع الثقب عند الفشل"
    ],
    content: `<h3>Sheath Integrity Test — حارس الـ Bonding System</h3><p><strong>Sheath Integrity Test</strong> يتحقق من سلامة الـ HDPE Outer Sheath وعدم وجود ثقوب تكشف الـ Metallic Sheath للتربة. إلزامي لأن نظام Cross Bonding يعتمد على عزل الـ Sheath — أي ثقب يُفسد النظام كاملاً.</p><h3>مواعيد الاختبار</h3><ul><li>قبل الدفن — للتحقق من سلامة ما قبل الموقع</li><li>بعد السحب وقبل الردم — للتحقق من سلامة بعد السحب</li><li>بعد الردم الكامل — الاختبار النهائي في ITP</li><li>سنوياً (EHV) كجزء من برنامج الصيانة</li></ul><h3>إجراء الاختبار</h3><ol><li>توصيل HV Output للـ Metallic Sheath والـ Return للأرضي</li><li>رفع الجهد تدريجياً لـ <strong>10 kV DC</strong></li><li>الاحتفاظ بالجهد لمدة <strong>60 ثانية</strong></li><li>مراقبة التيار — يجب < 1 mA</li></ol><h3>تفسير النتائج</h3><ul><li><strong>تيار < 1 mA بلا Breakdown</strong>: مقبول</li><li><strong>Breakdown مفاجئ</strong>: ثقب في الـ Jacket — Fault Location فوري</li><li><strong>تيار مرتفع تدريجياً</strong>: رطوبة على السطح — نظّف وأعد</li></ul>`,
    tools: [
      { name: "10 kV DC Sheath Tester", icon: "zap" },
      { name: "Conductive Rubber Electrode", icon: "layers" },
      { name: "Fault Location Kit", icon: "search" },
      { name: "Test Report Form", icon: "file-text" }
    ],
    hseWarnings: [
      "10 kV DC على سطح الكيبل — Exclusion Zone ≥ 2م. لا أحد يلمس الكيبل أثناء الاختبار",
      "بعد الاختبار، شحنة الـ Jacket تبقى لدقائق — انتظر تفريغ كامل قبل لمس الكيبل"
    ],
    commonMistakes: [
      "إجراء Sheath Test على كيبل مبلل — الرطوبة تُوصل تيار وتُعطي Breakdown مصطنع",
      "إهمال توصيل الـ Metallic Sheath بـ Return — يُسبب ارتفاع جهد خطير"
    ],
    references: [
      "IEC 60229 — Sheath Tests",
      "IEC 60840 — Outer Sheath Voltage Test",
      "SEC TMSS — Sheath Integrity Test Procedure"
    ]
  },

  "c8-s1-2": {
    title: "Megger Test (IR)",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم مبدأ قياس مقاومة العزل (IR) بجهاز Megger",
      "معرفة جهود الاختبار المناسبة لكل نوع كيبل",
      "تفسير النتائج وقيم IR المقبولة في مشاريع SEC",
      "فهم مؤشرات PI وDAR وأهميتهما"
    ],
    content: `<h3>Megger Test — مقاومة العزل الأساسية</h3><p><strong>Insulation Resistance (IR) Test</strong> يقيس مقاومة عزل الكيبل بتطبيق جهد DC منخفض نسبياً. المقاومة المرتفعة = عزل جيد. المنخفضة = تلف أو رطوبة.</p><h3>جهود الاختبار حسب الكيابل</h3><ul><li><strong>كيابل MV (11-33 kV)</strong>: 2.5-5 kV DC</li><li><strong>كيابل HV (69-132 kV)</strong>: 5 kV DC</li><li><strong>كيابل EHV (230-380 kV)</strong>: 5 kV DC (للكشف الأولي)</li></ul><h3>قيم IR المقبولة</h3><ul><li><strong>XLPE جديد</strong>: > 1000 MΩ (وغالباً > 10,000 MΩ)</li><li><strong>XLPE بعد 20 سنة</strong>: > 100 MΩ كحد أدنى</li><li><strong>تستلزم تحقيقاً</strong>: < 100 MΩ أو هبوط > 50% عن قياس سابق</li></ul><h3>مؤشر الاستقطاب PI</h3><pre>PI = R₁₀ min / R₁ min</pre><ul><li><strong>PI > 2.0</strong>: عزل جيد</li><li><strong>PI = 1-2</strong>: مقبول</li><li><strong>PI < 1.0</strong>: متدهور أو رطوبة</li></ul>`,
    tools: [
      { name: "Digital Megger (5 kV DC)", icon: "activity" },
      { name: "Insulation Test Leads", icon: "zap" },
      { name: "IR Test Record Form", icon: "file-text" },
      { name: "Stopwatch", icon: "settings" }
    ],
    hseWarnings: [
      "جهاز Megger 5 kV يُولّد جهداً خطيراً — لا أحد يلمس أطراف الكيبل أثناء الاختبار",
      "بعد الاختبار الكيبل مشحون — انتظر De-charge كامل قبل الإفراج"
    ],
    commonMistakes: [
      "قياس IR بجهد 500V على كيابل HV — الجهد غير كافٍ ويُعطي قيمة مضللة",
      "تسجيل القراءة بعد 10 ثوانٍ فقط — الدقيقة الكاملة إلزامية للاستقرار"
    ],
    references: [
      "IEEE 43 — Recommended Practice for IR Testing",
      "IEC 60060-1 — High-Voltage Testing Techniques",
      "SEC TMSS — IR Test Requirements"
    ]
  },

  "c8-s1-3": {
    title: "Drum Continuity Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "6 دقائق",
    difficulty: "مبتدئ",
    objectives: [
      "فهم أهداف Drum Continuity Test وما يكشفه",
      "إتقان إجراء اختبار الاستمرارية على الطبل",
      "التمييز بين اختبار الموصل واختبار الشاشة",
      "معرفة القيم المرجعية للمقاومة لكل مقطع"
    ],
    content: `<h3>Drum Continuity Test — التحقق قبل الاستثمار</h3><p><strong>Drum Continuity Test</strong> يُجرى على الطبل قبل السحب للتحقق من استمرارية الموصل، واستمرارية الشاشة المعدنية، وعدم وجود قصر بين الموصل والشاشة.</p><h3>الاختبارات الثلاثة</h3><ul><li><strong>1. Conductor Continuity</strong>: قياس مقاومة الموصل DC. مثال: كيبل 1200mm² Cu، طول 500م: R ≈ 0.0076 Ω. أي قطع = مقاومة لانهائية</li><li><strong>2. Screen Continuity</strong>: نفس الإجراء على الشاشة النحاسية. مقاومتها أعلى بكثير من الموصل</li><li><strong>3. Conductor-to-Screen IR</strong>: Megger بين الموصل والشاشة. يجب > 1000 MΩ</li></ul><h3>التوثيق</h3><p>تُسجَّل القيم في <strong>Drum Test Certificate</strong> مع رقم الطبل والتاريخ ودرجة الحرارة لتصحيح القيمة لـ 20°C. هذه الشهادة جزء من حزمة FAT.</p>`,
    tools: [
      { name: "Digital Multimeter", icon: "activity" },
      { name: "Kelvin Bridge (Precision R)", icon: "settings" },
      { name: "Megger (5 kV DC)", icon: "zap" },
      { name: "Drum Test Certificate Form", icon: "file-text" }
    ],
    hseWarnings: [
      "قياس مقاومة الموصل يستلزم فصل طرفَي الكيبل من أي مصدر — لا قياس على كيبل متصل بالشبكة",
      "مقاومة صفر بين الموصل والشاشة = قصر داخلي. لا تسحب الكيبل. أبلغ فوراً"
    ],
    commonMistakes: [
      "قياس المقاومة بـ Multimeter العادي للقيم الصغيرة جداً — استخدم Kelvin Bridge أو Micro-ohmmeter",
      "تسجيل قيمة المقاومة دون تصحيح درجة الحرارة — مقاومة النحاس تتغير 0.39%/°C"
    ],
    references: [
      "IEC 60228 — Conductor Resistance at 20°C",
      "IEC 60840 — Drum Tests",
      "SEC FAT Procedure — Drum Continuity Requirements"
    ]
  },
  ...
  "c8-s2-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من Duct Proving وما يُثبته",
      "إتقان إجراء Duct Proving الكامل خطوة بخطوة",
      "معرفة معايير القبول لكل أنبوب",
      "توثيق نتائج Duct Proving في ITP"
    ],
    content: `<h3>Duct Proving — التحقق الشامل قبل السحب</h3><p><strong>Duct Proving</strong> منظومة اختبارات على الأنابيب قبل سحب الكيابل للتأكد من أنها نظيفة، مستقيمة، مستمرة، وبأقطار تتيح سحب الكيابل بأمان.</p><h3>تسلسل اختبارات Duct Proving</h3><ol><li><strong>Visual Inspection</strong>: فحص بصري لجميع توصيلات الأنابيب في المناهيل</li><li><strong>Foam Swab (Pigging)</strong>: تمرير كرة إسفنجية بضغط هواء. تخرج نظيفة = الأنبوب نظيف. تخرج ملوثة = حطام يُزال بالـ Rodding</li><li><strong>Mandrel Test</strong>: تمرير Mandrel قطره 95% من القطر الداخلي. النجاح = الأنبوب مستقيم وكافٍ</li><li><strong>Air Pressure Test (اختياري)</strong>: ضخ هواء مضغوط والتحقق من الضغط 15 دقيقة — يكشف التسريب</li></ol><h3>التوثيق</h3><p>كل أنبوب يحمل رقماً تسلسلياً. النتيجة تُسجَّل في <strong>Duct Proving Certificate</strong> موقَّع من مفتش SEC. لا يُسحب أي كيبل في أنبوب لم يجتز الاختبارات.</p>`,
    tools: [
      { name: "Foam Pig (Swab Ball)", icon: "box" },
      { name: "Mandrel (95% ID)", icon: "wrench" },
      { name: "Air Compressor", icon: "wind" },
      { name: "Duct Proving Certificate", icon: "file-text" }
    ],
    hseWarnings: [
      "ضغط الهواء في Foam Swab لا يتجاوز 2 bar — ضغط أعلى قد يُفجر توصيلات ضعيفة",
      "Mandrel العالق في الأنبوب لا تُخرجه بقوة الـ Winch مباشرة — حدد الموقع وافتح الخندق"
    ],
    commonMistakes: [
      "البدء بـ Mandrel مباشرة دون Foam Swab أولاً — الحطام يُعطي نتيجة فشل كاذبة",
      "تجاهل أنابيب الـ Spare Ducts في الاختبار — قد تُستخدم مستقبلاً"
    ],
    references: [
      "SEC TMSS — Duct Proving Requirements",
      "BS EN 61386-24 — Conduit Systems Testing",
      "SEC ITP — Duct Proving Hold Points"
    ]
  },
  ...
  "c8-s2-1": {
    ...
    difficulty: "متوسط",
    objectives: [
      "إتقان إجراء Mandrel Test بدقة",
      "حساب قطر Mandrel المناسب لكل أنبوب",
      "تحديد موقع الفشل باستخدام CCTV وطول الحبل",
      "معرفة الإجراءات التصحيحية عند فشل الـ Mandrel Test"
    ],
    content: `<h3>Mandrel Test — التحقق الميكانيكي للأنابيب</h3><p><strong>Mandrel Test</strong> يتحقق من أن القطر الداخلي الفعلي للأنبوب ≥ 95% من القطر الاسمي على طوله كله، وأنه مستقيم دون انكسارات.</p><h3>حساب قطر Mandrel</h3><pre>D_mandrel = 0.95 × ID_nominal</pre><ul><li>أنبوب HDPE 160mm (ID ≈ 135mm): Mandrel = <strong>128mm</strong></li><li>أنبوب HDPE 200mm (ID ≈ 168mm): Mandrel = <strong>160mm</strong></li><li>أنبوب GRP 200mm (ID = 200mm): Mandrel = <strong>190mm</strong></li></ul><h3>خطوات Mandrel Test</h3><ol><li>تمرير Guide Rope من منهل للآخر بالـ Rodding</li><li>ربط Mandrel بالـ Guide Rope مع Foam Swab أمامه</li><li>سحب الـ Mandrel ببطء بسرعة ≤ 1م/دقيقة</li><li>إذا توقف: تحديد الموضع بقياس طول الحبل من نقطة الإدخال</li><li>تأكيد بـ CCTV Pipe Camera إن أمكن</li></ol><h3>الإجراءات التصحيحية</h3><ul><li>انضغاط خارجي: حفر فوق الموضع، فحص السبب، استبدال القطعة التالفة</li><li>حطام داخلي: Rodding ثم Foam Swab ثم إعادة Mandrel</li></ul>`,
    tools: [
      { name: "Mandrel (Steel/PVC)", icon: "wrench" },
      { name: "CCTV Pipe Camera", icon: "camera" },
      { name: "Measuring Tape (50m+)", icon: "ruler" },
      { name: "Mandrel Test Certificate", icon: "file-text" }
    ],
    hseWarnings: [
      "إخراج Mandrel عالق بـ Winch بدون تحديد الموضع — قد يُتلف الأنبوب أو يكسره",
      "CCTV Camera في أنبوب مشتبه به بمياه — تحقق من عدم وجود مياه ضغط عالٍ"
    ],
    commonMistakes: [
      "استخدام Mandrel بقطر 90% بدلاً من 95% — يُعطي نجاحاً كاذباً لأنابيب بها تشوه",
      "تسجيل نتيجة نجاح بدون توقيع مفتش SEC — لا قيمة رسمية لها"
    ],
    references: [
      "SEC TMSS — Mandrel Test Requirements",
      "ISO 14488 — Underground Cable Duct Systems",
      "SEC ITP — Duct Proving Witness Points"
    ]
  },
  ...
  "c8-s2-2": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "معرفة طرق تحديد هوية الكيابل بعد السحب",
      "إتقان استخدام Cable Identifier في الكيابل الحية",
      "معرفة نظام تسمية الكيابل في مشاريع SEC",
      "توثيق نتائج Cable Identification في السجلات الرسمية"
    ],
    content: `<h3>Cable Identification — من هذا الكيبل؟</h3><p>في المناهيل حيث تتجمع كيابل متعددة، تحديد هوية كل كيبل بشكل دقيق ضرورة مطلقة قبل أي عمل. الخطأ في التحديد = العمل على الكيبل الخاطئ = عطل أو حادثة.</p><h3>طرق Cable Identification</h3><ul><li><strong>Cable Tags</strong>: بطاقات معدنية مثبَّتة على الكيابل في كل منهل. تحمل رقم الكيبل، الفاز، الاتجاه، الجهد</li><li><strong>اختبار الاستمرارية</strong>: قصر طرف الكيبل في المنهل البعيد، ثم قياس Continuity من المنهل القريب</li><li><strong>Signal Injection (TDR)</strong>: حقن إشارة في كيبل معروف وكشفها في الطرف الآخر</li></ul><h3>نظام تسمية SEC</h3><p>مثال: <strong>CB-RYH-110-001</strong> يعني: CB = Cable Bay، RYH = Riyadh-Al Hayat، 110 = الجهد، 001 = رقم تسلسلي. يظهر في As-Built وجميع وثائق التشغيل.</p>`,
    tools: [
      { name: "Cable Tags (Stainless Steel)", icon: "layers" },
      { name: "Non-Contact Voltage Detector", icon: "zap" },
      { name: "Cable Locator (Active Mode)", icon: "radio" },
      { name: "Multimeter (Continuity)", icon: "activity" }
    ],
    hseWarnings: [
      "لا تفترض أبداً أن كيبلاً ما خاملاً لأنه لا يحمل بطاقة — استخدم Voltage Detector دائماً",
      "الكيابل الخاملة في المناهيل بجانب كيابل حية تحمل Induced Voltage"
    ],
    commonMistakes: [
      "الاعتماد على لون الكيبل للتمييز — في المناهيل القديمة كل الكيابل HDPE أسود",
      "عدم تحديث الـ Cable Tags عند تغيير أي كيبل — يُسبب ارتباكاً في الصيانة"
    ],
    references: [
      "SEC TMSS — Cable Identification Requirements",
      "SEC Naming Convention Manual",
      "IEC 60445 — Identification of Equipment Terminals"
    ]
  },
  ...
  "c8-s2-3": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم أهمية اختبار الطور قبل التشغيل",
      "إتقان طريقة اختبار الطور بـ Phasing Stick وPhase Meter",
      "معرفة خطورة الخطأ في الطور على الشبكة",
      "توثيق نتائج Phasing Test"
    ],
    content: `<h3>Phasing Test — التحقق من R-S-T</h3><p><strong>Phasing Test</strong> يتحقق من أن الفازات الثلاث للكيبل الجديد (R, S, T) متزامنة مع فازات نقطة التوصيل في المحطة. الخطأ في الطور يُسبب تيار قصر ضخم لحظة التشغيل.</p><h3>أسباب خطأ الطور</h3><ul><li>تبديل فازَيْن عند الـ Jointing</li><li>خطأ في توصيل الـ Termination في المحطة</li><li>خطأ في توصيل CT أو Relay</li></ul><h3>طرق Phasing Test</h3><ul><li><strong>Phasing Stick (Offline)</strong>: قياس Continuity بين أطراف الكيابل من الطرفين للتحقق من التوافق</li><li><strong>Phase Comparator (Online)</strong>: مثل Horstmann Phase Master — يُحدد الزاوية بين طور الكيبل الجديد وطور المحطة</li></ul><h3>تسلسل الفحص</h3><ol><li>التأكد من تسمية الأطراف في المحطتين</li><li>Continuity Test (كيبل مفصول)</li><li>Phasing Test قبل الوصل للشينة</li><li>توثيق النتيجة في Phasing Certificate</li><li>موافقة مشغل المحطة قبل التوصيل النهائي</li></ol>`,
    tools: [
      { name: "Phase Comparator (Horstmann)", icon: "settings" },
      { name: "Phasing Stick (HV Rated)", icon: "zap" },
      { name: "Multimeter", icon: "activity" },
      { name: "Phasing Test Certificate", icon: "file-text" }
    ],
    hseWarnings: [
      "Phase Comparator على كيابل حية يستلزم معدات مُعزَّزة للجهد الكامل",
      "خطأ في تحديد الطور قبل التوصيل = قصر ثلاثي الفازات لحظة الإغلاق"
    ],
    commonMistakes: [
      "الاكتفاء بـ Continuity Test دون Phase Comparison — الاستمرارية لا تكشف تبادل الفازات",
      "إجراء Phasing Test بأداة غير مُعايَرة للجهد المطلوب"
    ],
    references: [
      "SEC Safety Rules — Phasing Requirements before Energization",
      "IEC 61481 — Phase Comparators",
      "SEC TMSS — Phasing Test Protocol"
    ]
  },

  "c8-s3-0": {
    title: "Sheath Test — 10 kV DC × 1 دقيقة",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "إتقان إجراء Sheath Test النهائي بعد الدفن الكامل",
      "معرفة الفرق بين Sheath Test قبل الدفن وبعده",
      "فهم تأثير التربة الرطبة على نتائج Sheath Test",
      "معرفة الحد الأقصى للتيار المقبول"
    ],
    content: `<h3>Sheath Test النهائي — التحقق بعد الدفن</h3><p>Sheath Test بعد الدفن الكامل هو الأهم — يُثبت أن الـ HDPE Jacket لم يتضرر من السحب أو الدفن أو ضغط التربة. يُجرى في مرحلة Commissioning كـ Hold Point رسمي في ITP قبل HV Test.</p><h3>الفرق عن Sheath Test قبل الدفن</h3><ul><li><strong>قبل الدفن</strong>: الكيبل في الهواء — اختبار مرحلي</li><li><strong>بعد الدفن</strong>: الكيبل محاط بالتربة الموصلة — التربة تعمل كـ Return Electrode. أي ثقب يتصل مباشرة بالتربة</li></ul><h3>إجراء Sheath Test بعد الدفن</h3><ol><li>توصيل HV Terminal للـ Metallic Sheath</li><li>توصيل Return Terminal لـ Earth Rod في التربة</li><li>رفع الجهد تدريجياً: 0 → 2.5 → 5 → 7.5 → 10 kV (كل خطوة 30 ثانية)</li><li>الاحتفاظ بـ 10 kV لمدة <strong>60 ثانية</strong></li></ol><h3>قيم التيار المقبولة</h3><ul><li><strong>< 0.5 mA</strong>: ممتاز</li><li><strong>0.5-1.0 mA</strong>: مقبول</li><li><strong>> 1.0 mA</strong>: مرفوض — Fault Location وإصلاح</li></ul>`,
    tools: [
      { name: "10 kV DC Test Set", icon: "zap" },
      { name: "Earth Rod (Return)", icon: "layers" },
      { name: "Leakage Current Meter", icon: "activity" },
      { name: "Sheath Test Record", icon: "file-text" }
    ],
    hseWarnings: [
      "الـ Metallic Sheath تحت 10 kV DC — Exclusion Zone ≥ 3م حول المناهيل أثناء الاختبار",
      "في Cross Bonding، افصل SVL Links قبل Sheath Test — وجودها يُصرّف الجهد ويُعطي فشلاً كاذباً"
    ],
    commonMistakes: [
      "إجراء Sheath Test بينما SVL Links موصلة — يُعطي تيار مرتفع مصطنع",
      "رفع الجهد للـ 10 kV مباشرة بدون رفع تدريجي"
    ],
    references: [
      "IEC 60229 — Sheath Tests After Installation",
      "IEC 60840 — Sheath Test Requirements",
      "SEC TMSS — Post-Installation Sheath Test Protocol"
    ]
  },

  "c8-s3-1": {
    title: "Sheath Test — تفسير النتائج",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "إتقان تفسير منحنى التيار مقابل الجهد في Sheath Test",
      "التمييز بين الفشل الحقيقي والفشل الكاذب",
      "معرفة أسباب ارتفاع تيار التسرب",
      "فهم خصائص تيار التسرب في الـ HDPE السليم"
    ],
    content: `<h3>تفسير منحنى Sheath Test</h3><p>تيار التسرب منحنى زمني — قراءته الصحيحة تُمكّن من التمييز بين مشاكل حقيقية وظروف مؤقتة.</p><h3>الحالة الطبيعية</h3><ul><li>عند رفع الجهد: يرتفع التيار مؤقتاً (Capacitive Charging)</li><li>خلال 10-20 ثانية: ينخفض أسّياً حتى يستقر</li><li>القيمة المستقرة: < 0.5 mA</li></ul><h3>تشخيص ارتفاع التيار</h3><ul><li><strong>ارتفاع مستمر لا يستقر</strong>: ثقب يوصّل للتربة — فشل حقيقي</li><li><strong>ارتفاع ثم استقرار > 1 mA</strong>: رطوبة على السطح — نظّف وأعد</li><li><strong>Breakdown مفاجئ</strong>: ثقب حاد — Fault Location فوري</li><li><strong>تيار يرتفع تدريجياً</strong>: رطوبة عند نقطة ضعيفة — حالة حدية</li></ul><h3>العوامل المؤثرة</h3><ul><li>طول الكيبل: أطول = Capacitance أعلى = Charging Current أعلى</li><li>رطوبة التربة: تربة رطبة = تيار أعلى طبيعياً</li><li>درجة الحرارة: ارتفاعها يُقلل مقاومة HDPE قليلاً</li></ul>`,
    tools: [
      { name: "Current-Time Chart Recorder", icon: "activity" },
      { name: "Sheath Test Analysis Software", icon: "cpu" },
      { name: "Temperature Logger", icon: "thermometer" }
    ],
    hseWarnings: [
      "منحنى التيار غير الطبيعي قد يكون بسبب SVL موصَّل — تأكد من فصل جميع SVL أولاً",
      "تيار > 5 mA = عطل حاد — أوقف الاختبار فوراً وصرّف الكيبل"
    ],
    commonMistakes: [
      "تسجيل التيار في اللحظة الأولى (Charging عالٍ) كـ Final Reading — انتظر الاستقرار",
      "اعتبار 0.8 mA 'قريب من الحد' ومقبول — أي قيمة > 1 mA فشل رسمي في SEC ITP"
    ],
    references: [
      "IEC 60229 — Interpretation of Sheath Test Results",
      "CIGRÉ Technical Brochure — Sheath Fault Analysis",
      "SEC TMSS — Sheath Test Acceptance Criteria"
    ]
  },

  "c8-s3-2": {
    title: "Sheath Test — Troubleshooting",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متقدم",
    objectives: [
      "إتقان منهجية تحديد موقع عيب الـ Jacket",
      "معرفة Step Voltage Method وكيفية تطبيقها",
      "فهم تقنية Current Clamp Pinpointing",
      "معرفة إجراءات إصلاح الـ Jacket بعد تحديد العيب"
    ],
    content: `<h3>منهجية Troubleshooting عيوب الـ Jacket</h3><p>عند فشل Sheath Test، الخطوات: تأكيد الفشل الحقيقي → عزل المقطع المعطوب → تحديد موقع العيب بدقة → الإصلاح → إعادة الاختبار.</p><h3>الخطوة 1: تأكيد الفشل وعزل المقطع</h3><ul><li>افصل جميع SVL Links وتأكد من عدم توصيل أي ECC</li><li>اختبر كل مقطع بين المناهيل منفصلاً — المقطع الفاشل هو المعطوب</li></ul><h3>الخطوة 2: Step Voltage Method</h3><p>تُطبق نبضات جهد DC على الـ Metallic Sheath. التيار يسري من الشاشة عبر الثقب للتربة. فوق نقطة الثقب تُولَّد تدرجات جهد في التربة. جهاز الكشف يقيس هذا التدرج ويُحدد الموقع بدقة ±0.5-2م.</p><h3>الخطوة 3: Current Clamp Pinpointing</h3><p>Clamp يُحيط بالكيبل في كل نقطة ويقيس التيار السائر. التيار يتناقص بعد نقطة الثقب — القراءة الأعلى هي بالقرب من الثقب.</p><h3>الخطوة 4: إصلاح الـ Jacket</h3><ul><li>حفر بعناية فوق نقطة الثقب</li><li>إصلاح بـ Heat Shrink Repair Sleeve أو HDPE Patch</li><li>إعادة Sheath Test للتأكيد</li></ul>`,
    tools: [
      { name: "Sheath Fault Locator (Step Voltage)", icon: "search" },
      { name: "Current Clamp (Sheath Current)", icon: "activity" },
      { name: "Heat Shrink Repair Sleeve", icon: "box" },
      { name: "Signal Generator (DC Pulse)", icon: "zap" }
    ],
    hseWarnings: [
      "Sheath Fault Location يستلزم تطبيق جهد على الـ Metallic Sheath — Exclusion Zone كاملة",
      "الحفر فوق نقطة الثقب يستلزم إيقاف الجهد أولاً وتفريغ الكيبل"
    ],
    commonMistakes: [
      "الحفر بدون تحديد دقيق للموقع — قد يكون الثقب على مسافة 20م من التخمين",
      "إصلاح الثقب بـ PVC Tape فقط — لا يوفر العزل الكافٍ لـ 10 kV. يجب Heat Shrink Sleeve"
    ],
    references: [
      "IEC 62067 — Sheath Fault Location Methods",
      "CIGRÉ Technical Brochure — Cable Sheath Diagnostics",
      "SEC TMSS — Jacket Repair and Retesting"
    ]
  },

  "c8-s5-3": {
    title: "PD — IEC 60270 (المعيار)",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "11 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم مبدأ قياس PD وفق IEC 60270",
      "معرفة معايير القبول لـ PD في كيابل HV وEHV",
      "إتقان إجراء PD Test في الموقع",
      "فهم PD Location وكيف يُحدد موضع التفريغ"
    ],
    content: `<h3>Partial Discharge — الكشف المبكر عن العيوب</h3><p><strong>Partial Discharge</strong> تفريغات كهربائية جزئية في نقاط ضعف موضعية في العزل. قياسها أثناء HV Test يكشف عن العيوب قبل Breakdown الكامل.</p><h3>مبدأ القياس وفق IEC 60270</h3><p>كل تفريغ جزئي يُحدث نبضة تيار (pC). IEC 60270 يُعرّف طريقة قياسها كهربائياً عبر Coupling Capacitor وPD Detector وBand Pass Filter (30-300 kHz).</p><h3>معايير القبول (SEC TMSS)</h3><ul><li><strong>كيابل EHV (230-380 kV)</strong>: < 5 pC عند 1.5 × U₀</li><li><strong>كيابل HV (110-132 kV)</strong>: < 10 pC عند 1.5 × U₀</li><li><strong>الوصلات والنهايات</strong>: < 10 pC (EHV) و< 20 pC (HV)</li></ul><h3>إجراء PD Test في الموقع</h3><ol><li>تجهيز بيئة منخفضة الضوضاء (Noise Level < 3 pC)</li><li>ربط PD Detector بالكيبل عبر Coupling Capacitor</li><li>رفع الجهد تدريجياً مع HV Test Set</li><li>تسجيل PD Level عند: U₀، 1.3 × U₀، 1.5 × U₀</li><li>إذا ظهر PD > الحد: تحديد الموضع بـ PD Location</li></ol>`,
    tools: [
      { name: "PD Detector (IEC 60270 Calibrated)", icon: "activity" },
      { name: "Coupling Capacitor (HV Rated)", icon: "zap" },
      { name: "PD Location System", icon: "search" },
      { name: "Calibration Pulse Injector", icon: "settings" }
    ],
    hseWarnings: [
      "PD Detector موصَّل بكيابل تحت HV Test — العزل بين دائرة الاختبار ودائرة القياس يجب أن يتحمل الجهد الكامل",
      "Coupling Capacitor تحت جهد HV — أي عطل فيها يُسبب Arc Flash"
    ],
    commonMistakes: [
      "قياس PD في موقع ذو ضوضاء (Noise > 10 pC) — الضوضاء تُقلّد PD وتُعطي نتائج خاطئة",
      "عدم معايرة جهاز PD قبل الاختبار — النتائج بدون معايرة غير معترف بها في SEC"
    ],
    references: [
      "IEC 60270 — Partial Discharge Measurements",
      "IEC 60840 — PD Requirements for HV Cables",
      "CIGRÉ Technical Brochure 728 — On-Site PD Testing"
    ]
  },

  "c8-s6-0": {
    title: "Tan Delta — XLPE الجديد <0.1%",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم معنى Tan Delta وماذا يقيس في عزل الكيابل",
      "معرفة معيار القبول لـ Tan Delta في XLPE الجديد",
      "إتقان إجراء قياس Tan Delta في الموقع",
      "التمييز بين Tan Delta الثابت والمتزايد مع الجهد"
    ],
    content: `<h3>Tan Delta — نبض جودة العزل</h3><p><strong>Tan Delta (tanδ)</strong> يقيس نسبة الطاقة المُبدَّدة في العزل إلى الطاقة التفاعلية المُخزَّنة. XLPE مثالي: طاقة مُبدَّدة ≈ صفر. XLPE متدهور: طاقة مُبدَّدة مرتفعة بسبب الملوثات والرطوبة.</p><h3>معادلة Tan Delta</h3><pre>tan δ = I_R / I_C = مكوّن المقاومة / مكوّن السعة</pre><h3>معايير القبول (SEC)</h3><ul><li><strong>tan δ < 1 × 10⁻⁴ (0.01%)</strong>: ممتاز</li><li><strong>tan δ < 4 × 10⁻⁴ (0.04%)</strong>: جيد جداً</li><li><strong>tan δ < 10⁻³ (0.1%)</strong>: الحد الأقصى للقبول</li><li><strong>tan δ > 10⁻³</strong>: مرفوض</li></ul><h3>إجراء القياس</h3><ol><li>تطبيق جهد AC متغير (VLF 0.1 Hz أو 50 Hz)</li><li>قياس الزاوية δ بين تيار الشحن الكلي ومكوّنه السعوي</li><li>تسجيل النتيجة عند: 0.5 × U₀، U₀، 1.5 × U₀</li></ol><h3>Tan Delta المتزايد مع الجهد — علامة تحذير</h3><p>إذا <strong>ارتفع tan δ مع الجهد</strong>، يُشير إلى Space Charges أو عيوب في الـ Jointing أو Water Trees في العزل.</p>`,
    tools: [
      { name: "Tan Delta Bridge (Schering Bridge)", icon: "activity" },
      { name: "VLF Test Set (0.1 Hz)", icon: "zap" },
      { name: "Temperature Logger", icon: "thermometer" },
      { name: "Tan Delta Report Form", icon: "file-text" }
    ],
    hseWarnings: [
      "قياس Tan Delta يُطبق HV على الكيبل — نفس إجراءات HV Test من حيث Exclusion Zone والـ PTW",
      "جهاز Schering Bridge حساس للضوضاء — أبعده عن مصادر التداخل في الموقع"
    ],
    commonMistakes: [
      "قياس Tan Delta بـ 50 Hz في الموقع بدون شبكة نقية — VLF (0.1 Hz) أدق ميدانياً",
      "مقارنة قيم Tan Delta بمعايير PILC للـ XLPE — المعايير مختلفة تماماً"
    ],
    references: [
      "IEC 60250 — Measurement of Dielectric Properties",
      "IEEE 400.2 — VLF Testing with Tan Delta",
      "SEC TMSS — Tan Delta Acceptance Criteria"
    ]
  },

  "c8-s6-1": {
    title: "Tan Delta — تفسير النتائج",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متقدم",
    objectives: [
      "إتقان تفسير قيم Tan Delta ومنحنياتها",
      "التمييز بين أسباب ارتفاع Tan Delta المختلفة",
      "فهم الدلالة التشخيصية لـ Tip-Up (Δtanδ)",
      "اتخاذ قرار الفحص الإضافي بناءً على Tan Delta"
    ],
    content: `<h3>تفسير نتائج Tan Delta</h3><h3>1. Tan Delta مرتفع عند جميع مستويات الجهد</h3><ul><li><strong>السبب المحتمل</strong>: تلوث عام في العزل، ناتج تشابك عالٍ، رطوبة موزعة</li><li><strong>الإجراء</strong>: مراجعة شهادات التصنيع إن كان كيابل جديداً</li></ul><h3>2. Tip-Up — المؤشر الأهم</h3><pre>Δtanδ = tanδ (1.5 × U₀) - tanδ (0.5 × U₀)</pre><ul><li><strong>Δtanδ < 0.1 × 10⁻³</strong>: عزل جيد</li><li><strong>Δtanδ = 0.1-0.5 × 10⁻³</strong>: تحت المراقبة</li><li><strong>Δtanδ > 0.5 × 10⁻³</strong>: Space Charges أو Water Trees — PD إضافي مطلوب</li></ul><h3>3. Tan Delta غير مستقر (Oscillating)</h3><p>يتذبذب خلال قياسات متعددة. سببه: تفريغات جزئية متقطعة. يستلزم: PD Test متزامن.</p><h3>4. قراءة الاتجاه (Trend) أهم من القيمة المطلقة</h3><p>ارتفاع سنوي > 20% مقلق حتى لو القيمة لا تزال < 10⁻³. الفائدة الأكبر من Tan Delta هي المقارنة مع الزمن.</p>`,
    tools: [
      { name: "Tan Delta Trending Software", icon: "cpu" },
      { name: "Historical Data Database", icon: "hard-drive" },
      { name: "PD Test Set (Follow-up)", icon: "activity" }
    ],
    hseWarnings: [
      "كيبل ذو Δtanδ > 1 × 10⁻³ تحت التشغيل — خطر Thermal Breakdown تدريجي. لا ترفع حمله لأقصى قيمة"
    ],
    commonMistakes: [
      "تجاهل Tip-Up لأن القيمة المطلقة ≤ 0.1% — Tip-Up هو المؤشر الأكثر حساسيةً للتدهور المبكر",
      "مقارنة Tan Delta مقاس بـ VLF مع نتيجة سابقة بـ 50 Hz — التردد يُؤثر على القيمة"
    ],
    references: [
      "IEEE 400.2 — Tan Delta for Cable Diagnostics",
      "CIGRÉ Technical Brochure — Tan Delta Interpretation",
      "IEC 60270 — Tan Delta and PD Combined Testing"
    ]
  },

  "c8-s6-2": {
    title: "Tan Delta — طرق القياس",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متقدم",
    objectives: [
      "معرفة طرق قياس Tan Delta الثلاث",
      "التمييز بين القياس بـ 50 Hz وVLF 0.1 Hz",
      "معرفة حدود كل طريقة ومتى تُستخدم",
      "إتقان إجراء VLF-TD Test في الموقع"
    ],
    content: `<h3>طرق قياس Tan Delta</h3><h3>1. Schering Bridge (50 Hz)</h3><p>الطريقة الكلاسيكية. دقة عالية جداً (< 10⁻⁶). تستلزم مصدر جهد 50 Hz ضخم. تُستخدم في FAT بالمصنع.</p><h3>2. VLF Tan Delta (0.1 Hz)</h3><p>الأكثر استخداماً ميدانياً. جهاز خفيف محمول لأن Charging Current عند 0.1 Hz = أقل 500 مرة من 50 Hz. مناسب لكيابل حتى 33-69 kV ميدانياً.</p><ul><li>القيد: tan δ عند 0.1 Hz أعلى قليلاً منه عند 50 Hz — استخدم معايير مصحَّحة</li></ul><h3>3. Resonant TD (Power Frequency)</h3><p>Resonant Test Set يُولّد جهد 50 Hz بطاقة أقل. يُتيح قياس Tan Delta بتردد الشبكة الحقيقي لكيابل HV/EHV في الموقع. الأكثر دقةً لكيابل 110 kV فأعلى.</p>`,
    tools: [
      { name: "VLF Tan Delta Test Set (BAUR/HV Technologies)", icon: "zap" },
      { name: "Resonant Test Set (للـ HV)", icon: "activity" },
      { name: "Schering Bridge (للمصنع)", icon: "settings" }
    ],
    hseWarnings: [
      "VLF Test Set على كيابل 33 kV يطبق 3 × U₀ = 57 kV — جهاز صغير لا يعني جهداً منخفضاً",
      "قياس Tan Delta بـ Resonant Set — نفس احتياطيات HV Test كاملة"
    ],
    commonMistakes: [
      "مقارنة VLF Tan Delta (0.1 Hz) مع معيار 50 Hz — القيم غير قابلة للمقارنة المباشرة",
      "استخدام VLF-TD على كيابل 110 kV — جهاز VLF القياسي لا يوفر جهداً كافياً"
    ],
    references: [
      "IEEE 400.2 — VLF Tan Delta Testing",
      "IEC 60250 — Measurement of Dissipation Factor",
      "BAUR/HV Technologies VLF-TD Application Notes"
    ]
  },

  "c8-s7-0": {
    title: "Sheath Bonding — Induced Voltage Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "إتقان إجراء قياس الجهد المستحث على شاشة الكيبل",
      "مقارنة القيمة المقيسة بالقيمة المحسوبة",
      "تفسير نتائج Induced Voltage وتحديد صحة نظام الـ Bonding",
      "معرفة متطلبات التوثيق في ITP"
    ],
    content: `<h3>Induced Voltage Test — التحقق الميداني من الـ Bonding</h3><p><strong>Induced Voltage Test</strong> يقيس الجهد الفعلي المستحث على شاشة الكيبل في التشغيل ويُقارنه بالقيمة المحسوبة نظرياً. التوافق يُؤكد صحة نظام الـ Bonding.</p><h3>إجراء القياس</h3><ol><li>تشغيل الكيبل بتيار معروف</li><li>فصل Link في Link Box وتوصيل HV Voltmeter بين الشاشة والأرضي</li><li>قياس الجهد (V_induced) وتسجيل التيار المتدفق في نفس الوقت</li><li>حساب: V_induced / I_load = X_m الفعلية</li><li>مقارنة X_m الفعلية بالمحسوبة — يجب توافق ± 15%</li></ol><h3>قيم القبول</h3><ul><li><strong>V_induced ≤ 65V</strong>: مطابق لمعيار SEC للسلامة</li><li><strong>V_induced ≤ 50V</strong>: ممتاز مع هامش أمان</li><li><strong>V_induced > 65V</strong>: مرفوض — يستلزم مراجعة التصميم</li></ul><h3>في Cross Bonding</h3><p>عند توازن مثالي، V_induced ≈ صفر. أي قيمة > 20V تُشير لخلل في التوصيلات أو عدم توازن الأطوال.</p>`,
    tools: [
      { name: "HV AC Voltmeter (True RMS)", icon: "activity" },
      { name: "Current Transformer (Clamp)", icon: "zap" },
      { name: "Link Box Disconnection Tool", icon: "wrench" },
      { name: "Induced Voltage Test Form", icon: "file-text" }
    ],
    hseWarnings: [
      "قياس الجهد على الشاشة المعزولة — استخدم Voltmeter بقضبان عازلة فقط",
      "فصل Link في Link Box على كيبل حي بحمل كامل — قد يُسبب ارتفاعاً مفاجئاً في جهد الشاشة"
    ],
    commonMistakes: [
      "قياس Induced Voltage عند حمل خفيف (20%) وتعميم النتيجة — القيمة تتناسب مع التيار",
      "مقارنة القيمة المقيسة بالمحسوبة دون مراعاة الفرق في درجة الحرارة"
    ],
    references: [
      "IEC 60840 — Sheath Bonding Verification",
      "CIGRÉ Technical Brochure 283 — Induced Voltage Testing",
      "SEC TMSS — Bonding System Verification Protocol"
    ]
  },

  "c8-s7-1": {
    title: "Sheath Bonding — SVL Functional Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم الغرض من SVL Functional Test",
      "إتقان إجراء الاختبار الكهربائي للـ SVL",
      "تفسير نتائج SVL Test والحكم على سلامته",
      "معرفة الاختبار الدوري المطلوب"
    ],
    content: `<h3>SVL Functional Test — التحقق من جاهزية الحماية</h3><p><strong>SVL Functional Test</strong> يتحقق من أن SVL Arresters في Link Boxes تعمل بشكل صحيح: عزل جيد في الظروف الطبيعية، واستجابة فعّالة عند الجهود العابرة.</p><h3>الاختبارات الرئيسية</h3><ul><li><strong>1. DC Insulation Resistance</strong>: Megger 500V-1 kV DC. القيمة المتوقعة: > 1000 MΩ. < 100 MΩ تُشير لبداية التدهور</li><li><strong>2. Leakage Current Test (الأهم)</strong>: تطبيق جهد DC مساوٍ لـ MCOV. قياس التيار المستمر. القيمة < 1 mA. تيار > ضعف القيمة المرجعية = SVL متدهور</li><li><strong>3. Voltage-Current Characteristic</strong>: رسم منحنى V-I ومقارنته بمنحنى المصنع. انحراف > 20% = تغيير في خصائص MOV</li></ul><h3>التكرار في SEC</h3><ul><li>عند التركيب الأول: اختبار كامل</li><li>سنوياً: Leakage Current Test</li><li>بعد كل عاصفة كهربائية شديدة: فحص شامل</li></ul>`,
    tools: [
      { name: "Megger (1 kV DC)", icon: "activity" },
      { name: "SVL Leakage Current Test Set", icon: "zap" },
      { name: "Surge Counter (Read-out)", icon: "cpu" },
      { name: "IR Camera (Thermal)", icon: "thermometer" }
    ],
    hseWarnings: [
      "SVL في Link Box بالقرب من شاشة تحمل جهد مستحث — قياس الجهد وعزل الكيابل قبل فتح Link Box",
      "SVL Failed Short يُولّد حرارة مستمرة — IR Camera تكشفه قبل أن يُسبب حريقاً"
    ],
    commonMistakes: [
      "اختبار SVL بـ Megger 250V فقط — جهد منخفض جداً لكشف التدهور في الـ ZnO",
      "إهمال قراءة Surge Counter — يخبرك عدد الصواعق التي امتصّها SVL"
    ],
    references: [
      "IEC 60099-4 — Surge Arrester Testing",
      "CIGRÉ Technical Brochure 283 — SVL Testing",
      "SEC TMSS — SVL Inspection and Testing Protocol"
    ]
  },

  "c8-s7-2": {
    title: "Sheath Bonding — DC Continuity (ECC)",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "6 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم أهمية التحقق من استمرارية ECC على طول المسار",
      "إتقان إجراء DC Continuity Test للـ ECC",
      "تفسير قيم المقاومة وتحديد مقبوليتها",
      "معرفة نقاط الفحص الدورية"
    ],
    content: `<h3>ECC Continuity Test — التحقق من خط الأمان</h3><p>ECC يجب أن يكون مستمراً كهربائياً من محطة لمحطة. أي انقطاع يعني أنه لن يُوفّر مسار عودة لتيار القصر الأرضي — وهذا يُلغي وظيفته الأساسية.</p><h3>إجراء DC Continuity Test</h3><ol><li>فصل ECC من نقاط التأريض في المحطتين</li><li>وصّل Lead المقياس بين طرفَي ECC</li><li>اقرأ المقاومة بـ Kelvin Bridge أو Micro-ohmmeter</li></ol><h3>القيمة المرجعية</h3><p>مثال: ECC 95mm² Cu، طول 2 كم:</p><pre>R = 0.0181 × 2 / 0.095 ≈ 0.38 Ω</pre><ul><li>مقيسة ≠ حسابية بفارق > 10%: يُحقق في نقاط التوصيل</li><li>مقاومة لانهائية: انقطاع كامل — Fault Location فوري</li></ul><h3>نقاط الفحص الدورية</h3><ul><li>التحقق من توصيلات ECC في المناهيل بصرياً</li><li>قياس مقاومة التوصيل عند كل وصلة (< 0.01 Ω)</li><li>فحص وصلات Crimping من الأكسدة</li></ul>`,
    tools: [
      { name: "Kelvin 4-Wire Resistance Bridge", icon: "activity" },
      { name: "Micro-ohmmeter", icon: "settings" },
      { name: "ECC Resistance Calculation Sheet", icon: "file-text" }
    ],
    hseWarnings: [
      "عند قياس ECC، تأكد من عدم وجود جهد مستحث على الشاشة — فصل الكيابل أو قياس الجهد أولاً",
      "ECC مدفون بجانب كيابل حية — اتبع إجراءات Safe Digging"
    ],
    commonMistakes: [
      "قياس ECC بـ Multimeter العادي — مقاومته منخفضة جداً تحتاج Kelvin Bridge",
      "إهمال التحقق من توصيلات ECC في المناهيل بعد أعمال الصيانة"
    ],
    references: [
      "IEC 60840 — ECC Continuity Requirements",
      "CIGRÉ Technical Brochure 283 — ECC Testing",
      "SEC TMSS — Earth Continuity Conductor Verification"
    ]
  },

  "c8-s7-3": {
    title: "Sheath Bonding — Sheath Resistance",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم أهمية قياس مقاومة الشاشة المعدنية",
      "إتقان إجراء Sheath Resistance Test",
      "مقارنة القيم المقيسة بالقيم النظرية",
      "تحديد أسباب ارتفاع مقاومة الشاشة"
    ],
    content: `<h3>Sheath Resistance Test — صحة الشاشة المعدنية</h3><p><strong>Sheath Resistance Test</strong> يقيس مقاومة الشاشة النحاسية DC من طرف لطرف للتحقق من سلامتها وعدم وجود تآكل يرفع المقاومة عن القيمة النظرية.</p><h3>أهمية مقاومة الشاشة في نظام الـ Bonding</h3><p>في Solid Bonding، Circulating Currents تعتمد على مقاومة الشاشة:</p><pre>I_sheath ≈ V_induced / R_sheath</pre><p>مقاومة مرتفعة غير متوقعة = بعض أسلاك الشاشة مقطوعة.</p><h3>إجراء القياس</h3><ol><li>فصل الشاشة من جميع نقاط التأريض والـ SVL</li><li>توصيل Kelvin Bridge بين طرفَي الشاشة</li><li>قياس وتصحيح القيمة لدرجة الحرارة 20°C</li><li>مقارنة بالقيمة النظرية</li></ol><h3>قيم مرجعية</h3><p>مثال: شاشة 95mm² Cu، طول 1 كم:</p><pre>R_sheath = 0.0181 × 1 / 0.095 ≈ 0.19 Ω/km</pre><ul><li>مقيسة = 0.19 ± 5%: ممتاز</li><li>مقيسة > 0.22 Ω/km: أسلاك مقطوعة</li><li>مقيسة < 0.17 Ω/km: احتمال Short مع موصل آخر</li></ul>`,
    tools: [
      { name: "Kelvin 4-Wire Resistance Bridge", icon: "activity" },
      { name: "Temperature Probe", icon: "thermometer" },
      { name: "Sheath Resistance Calculation Sheet", icon: "file-text" }
    ],
    hseWarnings: [
      "فصل الشاشة من التأريض يجعلها طافيةً — قياس الجهد عليها قبل أي لمس إلزامي",
      "Sheath Resistance مرتفع يُشير لأسلاك حادة مقطوعة — لا تجرّب السطح بيدك"
    ],
    commonMistakes: [
      "قياس Sheath Resistance بدون فصل SVL — يُضيف مسار موازٍ ويُعطي قيمة منخفضة مصطنعة",
      "عدم تصحيح المقاومة لـ 20°C — النحاس عند 50°C مقاومته أعلى بـ 12%"
    ],
    references: [
      "IEC 60228 — Screen/Sheath Resistance",
      "IEEE 400 — Cable Testing Standard",
      "SEC TMSS — Metallic Screen Resistance Requirements"
    ]
  },

  "c8-s8-0": {
    title: "Phase Sequence — اختبار Phasing",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم الفرق بين Phase Sequence وPhase Identification",
      "إتقان إجراء اختبار Phase Sequence",
      "معرفة خطورة خطأ الـ Phase Sequence على المعدات",
      "توثيق النتائج قبل التشغيل"
    ],
    content: `<h3>Phase Sequence Test — R-S-T بالترتيب الصحيح</h3><p><strong>Phase Sequence Test</strong> يتحقق من أن تسلسل الفازات الثلاث في الكيبل الجديد يتطابق مع تسلسل المحطة. خطأ في التسلسل يُسبب دوران المحركات بالعكس وأعطالاً في المعدات.</p><h3>الفرق بين Phase Identification وPhase Sequence</h3><ul><li><strong>Phase Identification</strong>: تحديد أي سلك R وأيهم S وأيهم T</li><li><strong>Phase Sequence</strong>: التحقق أن الترتيب R→S→T يتطابق (CW) مع الشبكة</li></ul><h3>أدوات Phase Sequence Test</h3><ul><li><strong>Phase Sequence Meter</strong>: يتصل بالفازات الثلاث ويُشير CW أو CCW</li><li><strong>Phase Comparator</strong>: للتحقق من مطابقة تسلسل الكيبل مع شينة المحطة</li></ul><h3>إجراء الاختبار</h3><ol><li>وصّل Phase Sequence Meter بطرف الكيبل الجديد</li><li>وصّل Phase Sequence Meter بشينة المحطة</li><li>قارن الاتجاهين — يجب أن يكونا متطابقَيْن</li><li>توثيق النتيجة في Phasing Certificate</li></ol>`,
    tools: [
      { name: "Phase Sequence Meter", icon: "settings" },
      { name: "Phase Comparator", icon: "activity" },
      { name: "Insulating Extension Leads", icon: "zap" }
    ],
    hseWarnings: [
      "Phase Sequence Meter على كيابل EHV حية — استخدم جهازاً مُعزَّزاً مع HV Extension Leads",
      "لا توصّل Phase Sequence Meter مباشرةً بكيابل EHV — استخدم VT Secondary أو Capacitive Divider"
    ],
    commonMistakes: [
      "الخلط بين Phase Sequence Test وPhase Identification — كلاهما مطلوب لكنهما مختلفان",
      "إهمال Phase Sequence Test لكيبل جديد — قد يكون مُوصَّلاً بترتيب مختلف"
    ],
    references: [
      "IEC 61481 — Phase Sequence Testers",
      "SEC Safety Rules — Phase Sequence Verification",
      "SEC TMSS — Pre-Energization Testing Requirements"
    ]
  },
  ...
  "c8-s8-1": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم الغرض من Rotation Test في مشاريع UGC",
      "معرفة المعدات التي تتأثر بخطأ الاتجاه",
      "إتقان إجراء Rotation Test",
      "فهم العلاقة بين Rotation Test وPhase Sequence"
    ],
    content: `<h3>Rotation Test — التأكد من الاتجاه الصحيح</h3><p><strong>Rotation Test</strong> يتحقق من أن المحركات والمراوح والمضخات المتصلة بالكيابل الجديدة تدور في الاتجاه الصحيح. ارتباطه الوثيق بـ Phase Sequence — إذا تطابق التسلسل، الاتجاه صحيح تلقائياً.</p><h3>التطبيق في مشاريع UGC</h3><ul><li><strong>مراوح التهوية في التونلات</strong>: يجب أن تُهوّي للخارج</li><li><strong>مضخات Dewatering في المناهيل</strong>: يجب أن تُصرّف للخارج</li><li><strong>مراوح تبريد المحولات</strong>: يُؤثر اتجاهها على كفاءة التبريد</li></ul><h3>إجراء Rotation Test</h3><ol><li>تشغيل المحرك لثانيتين فقط</li><li>فحص اتجاه الدوران بصرياً</li><li>إذا خاطئ: تبديل أي فازتين في اللوحة الكهربائية للمحرك فقط</li></ol><h3>تنبيه مهم</h3><p><strong>لا تُبدّل فازات في المحطة الرئيسية</strong> لتصحيح اتجاه محرك — بدّل فقط في لوحة المحرك.</p>`,
    tools: [
      { name: "Phase Sequence Meter", icon: "settings" },
      { name: "Non-Contact Tachometer", icon: "activity" },
      { name: "Rotation Direction Chalk Mark", icon: "pen-line" }
    ],
    hseWarnings: [
      "تشغيل محرك للاختبار دون حواجز حماية — تثبيت Guards قبل التشغيل",
      "بعد تبديل فازات المحرك، تأكد من ربط جميع التوصيلات بإحكام"
    ],
    commonMistakes: [
      "تبديل فازات في المحطة الرئيسية — يُغيّر Phase Sequence لجميع الأحمال المتصلة",
      "إهمال Rotation Test على مضخات Dewatering — تعكس الاتجاه بدون إنذار حتى تفشل"
    ],
    references: [
      "IEC 60034-11 — Rotating Electrical Machines",
      "SEC TMSS — Auxiliary Equipment Commissioning",
      "SEC Installation Standards — Motor Rotation Check"
    ]
  },

  "c8-s8-2": {
    title: "أدوات Phase Sequence Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "5 دقائق",
    difficulty: "مبتدئ",
    objectives: [
      "التعرف على أشيع أدوات Phase Sequence Test",
      "معرفة حدود كل أداة من حيث الجهد والتردد",
      "إتقان استخدام Phase Comparator في الموقع",
      "معرفة متطلبات معايرة هذه الأدوات"
    ],
    content: `<h3>أدوات Phase Sequence Test المستخدمة في مشاريع SEC</h3><h3>1. Phase Sequence Meter (Rotation Tester)</h3><ul><li>جهاز صغير بثلاثة terminals — الإخراج: CW أو CCW</li><li>النطاق: 100-600V AC، 50/60 Hz</li><li>أمثلة: Fluke 9040، Megger MPRT، Hioki 3129</li><li>الاستخدام: للجهود المتوسطة عبر VT Secondary</li></ul><h3>2. Phase Comparator</h3><ul><li>يُقارن الطور والتتابع بين نقطتين مختلفتين (الكيبل + الشينة)</li><li>النطاق: حتى 765 kV مع Capacitive Test Leads</li><li>أمثلة: Horstmann Phase Master، GreeMoss Comparator</li></ul><h3>3. VT Secondary</h3><p>في المحطات الكبيرة، يُستخدم Secondary لـ VT للحصول على جهد منخفض آمن (110V) للاختبار.</p><h3>شروط المعايرة</h3><ul><li>Phase Sequence Meter: معايرة سنوية من مختبر معتمد</li><li>Phase Comparator: معايرة مع كل عملية تشغيل جديدة</li></ul>`,
    tools: [
      { name: "Fluke 9040 Phase Meter", icon: "settings" },
      { name: "Horstmann Phase Comparator", icon: "activity" },
      { name: "HV Capacitive Test Leads", icon: "zap" }
    ],
    hseWarnings: [
      "Phase Comparator بقضبان غير مُعزَّزة على كيابل EHV — تأكد من أن الأدوات مُقيَّمة للجهد الكامل",
      "خطأ في ربط أحد leads في Phase Sequence Meter يُعطي نتيجة خاطئة"
    ],
    commonMistakes: [
      "استخدام Phase Sequence Meter بنطاق 480V على نظام 6.6 kV بدون VT — خطر",
      "الاكتفاء بالـ Phase Sequence Meter دون Phase Comparator — يُؤكد الترتيب لكن لا يُؤكد المطابقة مع الشبكة"
    ],
    references: [
      "IEC 61481 — Phase Comparators and Sequence Testers",
      "Fluke 9040 Operating Manual",
      "SEC Safety Rules — Tool Requirements for HV Testing"
    ]
  },

  "c8-s9-0": {
    title: "System Tests — Closed Loop Test",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "14 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم أهداف Closed Loop Test الكاملة",
      "إتقان إجراء Closed Loop Test خطوة بخطوة",
      "معرفة القياسات المطلوبة ومعايير القبول",
      "توثيق نتائج الاختبار في نموذج SEC المعتمد"
    ],
    content: `<h3>Closed Loop Test — الاختبار الجامع</h3><p><strong>Closed Loop Test</strong> يُثبت أن الكيبل يستطيع حمل التيار الاسمي بأمان وأن جميع أنظمة المراقبة والحماية تعمل. يُسبق التشغيل الفعلي للشبكة.</p><h3>الأهداف الكاملة</h3><ol><li>التحقق من Ampacity الفعلية بمقارنة الارتفاع الحراري بالمحسوب</li><li>الكشف عن Hot Spots على طول المسار عبر DTS</li><li>التحقق من صحة نظام Bonding تحت الحمل الكامل</li><li>التحقق من حماية Differential (87L) وCT Ratios</li><li>التحقق من SCADA والقياسات</li></ol><h3>إجراء Closed Loop Test</h3><p><strong>التحضير:</strong> توصيل Shorting Links في المحطة البعيدة بين الفازات الثلاث، وتوصيل مصدر التيار في المحطة القريبة.</p><p><strong>التنفيذ:</strong></p><ol><li>رفع التيار تدريجياً: 25% → 50% → 75% → 100%</li><li>الاحتفاظ بكل مستوى ساعتين للوصول لـ Thermal Equilibrium</li><li>تسجيل القياسات كل 15 دقيقة</li></ol><p><strong>معايير القبول:</strong></p><ul><li>درجة حرارة الكيبل ≤ 90°C في جميع النقاط</li><li>لا Hot Spots غير مبررة في DTS</li><li>تيار الشاشة ضمن الحدود المحسوبة</li><li>CT Ratio Error ≤ ±1%</li></ul>`,
    tools: [
      { name: "Current Injection Transformer", icon: "zap" },
      { name: "DTS System (Raman)", icon: "thermometer" },
      { name: "Precision Ammeters (3 Phase)", icon: "activity" },
      { name: "Data Logger (15-min intervals)", icon: "hard-drive" }
    ],
    hseWarnings: [
      "Shorting Links في المحطة البعيدة = تشغيل خاطئ للكيابل يُسبب قصراً كاملاً",
      "Closed Loop Test يُولّد حرارة في الكيابل والمناهيل — لا دخول للمناهيل أثناء الاختبار"
    ],
    commonMistakes: [
      "إنهاء Closed Loop Test قبل Thermal Equilibrium — القيم قبل الاستقرار لا تمثل التشغيل الحقيقي",
      "إهمال قياس تيار الشاشة أثناء الاختبار — يُفوّت التحقق من Bonding System"
    ],
    references: [
      "IEC 60840 — Closed Loop Test Requirements",
      "CIGRÉ Technical Brochure 531 — Commissioning Tests",
      "SEC TMSS — Closed Loop Test Protocol"
    ]
  },

  "c8-s9-1": {
    title: "System Tests — Protection Relays",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "10 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم أنواع الحماية الرئيسية لكيابل HV/EHV",
      "إتقان إجراء اختبار كل نوع في الموقع",
      "معرفة أدوات اختبار الحماية المعتمدة",
      "توثيق نتائج Relay Testing"
    ],
    content: `<h3>حماية كيابل HV/EHV في مشاريع SEC</h3><h3>1. Differential Protection (87L) — الحماية الرئيسية</h3><p>تُقارن التيار في طرفَي الكيبل. أي فرق = عطل داخلي → فصل فوري عبر الفايبر الضوئي.</p><ul><li><strong>اختبار 87L</strong>: حقن تيار محاكٍ في CTs من الطرفين بالتزامن (End-to-End). يُتحقق من زمن العمل (< 30 ms)</li><li><strong>أداة الاختبار</strong>: OMICRON CMC 356</li></ul><h3>2. Distance Protection (21) — الحماية الاحتياطية</h3><p>تقيس Impedance الظاهر للكيبل. Zone 1 عند 80% من الطول، Zone 2 عند 120%.</p><ul><li>Impedance كيابل XLPE يختلف عن OHL — يجب إعادة حساب معاملات الـ Relay</li></ul><h3>3. Overcurrent Protection (50/51)</h3><ul><li><strong>50 (Instantaneous)</strong>: يعمل فوراً عند تيار > 1.5-2 × Irated</li><li><strong>51 (Time-Delayed)</strong>: يعمل بتأخير عكسي</li></ul><h3>Earth Fault Protection (50N/51N)</h3><p>في كيابل Cross Bonding مع ECC، إعداد العتبة يأخذ بعين الاعتبار تيار الـ ECC الطبيعي.</p>`,
    tools: [
      { name: "OMICRON CMC 356 Test Set", icon: "settings" },
      { name: "SEL-411L Relay (End-to-End 87L)", icon: "cpu" },
      { name: "Relay Test Leads (HV Rated)", icon: "zap" },
      { name: "Relay Test Report Form", icon: "file-text" }
    ],
    hseWarnings: [
      "اختبار Relay Trip يُفصل القاطع — تنسيق مسبق مع مركز التحكم إلزامي",
      "ربط Test Set بـ CTs ثانوية على كيابل حية يستلزم Short-Circuit CT Secondary أولاً"
    ],
    commonMistakes: [
      "اختبار 87L من طرف واحد فقط — End-to-End Test إلزامي",
      "إهمال اختبار 21 بعد تغيير مسار الكيابل — Impedance الجديد يستلزم إعادة ضبط Zone"
    ],
    references: [
      "IEC 60255 — Measuring Relays and Protection Equipment",
      "SEC Protection Standards — Relay Settings for HV Cables",
      "OMICRON Application Note — Cable Differential Protection Testing"
    ]
  },

  "c8-s9-2": {
    title: "System Tests — CT/VT Tests",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم متطلبات CTs وVTs لكيابل HV/EHV",
      "إتقان اختبارات Ratio وPolarity وSaturation",
      "معرفة تأثير خطأ CT على حماية 87L",
      "توثيق نتائج CT/VT Tests"
    ],
    content: `<h3>CT/VT Tests — دقة القياس تُحدد دقة الحماية</h3><p>جودة الحماية (87L، 21، 50/51) تعتمد كلياً على دقة CTs وVTs. CT بنسبة خاطئة أو قطبية معكوسة يُسبب عمل خاطئ للحماية.</p><h3>1. CT Ratio Test</h3><ul><li>حقن تيار AC معروف في Primary وقياس Secondary</li><li>الخطأ المقبول: ≤ ±0.5% (Class 0.5) أو ±1% (Class 1)</li></ul><h3>2. CT Polarity Test</h3><ul><li>حقن نبضة DC في Primary ومراقبة اتجاه انحراف Galvanometer في Secondary</li><li>انحراف للأمام: قطبية صحيحة</li></ul><h3>3. CT Saturation Curve (Knee Point)</h3><ul><li>رفع جهد Secondary تدريجياً ورسم منحنى (Voltage vs Current)</li><li>Knee Point = النقطة التي يزداد فيها التيار أسرع من الجهد</li><li>يجب أن يكون Knee Point > 2 × Vk_required</li></ul><h3>4. VT Ratio وPolarity</h3><p>نفس المبدأ بجهد بدلاً من التيار. خطأ Ratio يُؤثر على قياسات الطاقة ودقة Distance Relay.</p>`,
    tools: [
      { name: "CT Analyzer (OMICRON CT Analyzer)", icon: "activity" },
      { name: "CT Ratio Test Set", icon: "settings" },
      { name: "Galvanometer (Polarity Test)", icon: "zap" },
      { name: "CT Test Record Form", icon: "file-text" }
    ],
    hseWarnings: [
      "CT Secondary لا تُفتح أبداً بينما Primary حي — يُولّد جهداً عالياً خطيراً",
      "VT Primary لا تُقصّر أبداً — تُسبب Transformer Short Circuit"
    ],
    commonMistakes: [
      "إجراء CT Ratio Test بدون Short-Circuit Secondary الآخر — التيار الزائد يُتلف الـ CT",
      "قبول Knee Point Test بدون رسم المنحنى الكامل"
    ],
    references: [
      "IEC 61869-2 — Current Transformers",
      "IEEE C57.13 — CT/VT Requirements",
      "SEC TMSS — CT/VT Acceptance Tests"
    ]
  },

  "c8-s9-3": {
    title: "System Tests — SCADA Verification",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم ما يُختبر في SCADA Verification",
      "معرفة إجراء التحقق من القياسات والإنذارات والتحكم",
      "إتقان الربط بين SCADA وقياسات الموقع الفعلية",
      "توثيق نتائج SCADA Verification"
    ],
    content: `<h3>SCADA Verification — العيون الرقمية للشبكة</h3><p><strong>SCADA Verification</strong> يتحقق من أن نظام المراقبة والتحكم يعكس الحالة الفعلية للكيابل بدقة، وأن جميع الأوامر تُنفَّذ بشكل صحيح.</p><h3>ما يُختبر</h3><ul><li><strong>القياسات</strong>: مقارنة قراءة SCADA مع Clamp Meter — خطأ < 1% للتيار، < 0.5% للجهد</li><li><strong>درجة الحرارة DTS</strong>: مقارنة قراءة SCADA مع جهاز DTS مباشرة</li><li><strong>الإنذارات (Alarms)</strong>: تشغيل كل حالة إنذار يدوياً وتأكيد ظهورها: قاطع مفتوح، حرارة عالية، عطل Sheath</li><li><strong>التحكم عن بعد</strong>: فتح وغلق القواطع من SCADA. زمن الاستجابة: أمر → تنفيذ < 2 ثانية</li><li><strong>بروتوكول الاتصال</strong>: IEC 61850 (GOOSE/MMS) أو DNP3</li></ul>`,
    tools: [
      { name: "SCADA HMI (Control Room)", icon: "cpu" },
      { name: "True RMS Clamp Meter", icon: "activity" },
      { name: "IEC 61850 Protocol Analyzer", icon: "radio" },
      { name: "SCADA Test Record Form", icon: "file-text" }
    ],
    hseWarnings: [
      "اختبار Remote Control من SCADA يُفصل القاطع فعلياً — تنسيق إلزامي مع الموقع قبل أي أمر",
      "إرسال أمر Close على قاطع مفتوح بسبب عطل — تأكد من عدم وجود عطل أولاً"
    ],
    commonMistakes: [
      "قبول قراءة SCADA بدون مقارنة مع جهاز مرجعي — SCADA قد يعرض قيمة Cached قديمة",
      "إهمال اختبار Alarm Priorities — إنذار درجة الحرارة يجب أن يظهر كـ Critical"
    ],
    references: [
      "IEC 61850 — SCADA Integration for Power Systems",
      "DNP3 Standard — IEEE Std 1815",
      "SEC TMSS — SCADA Acceptance Test Requirements"
    ]
  },

  "c8-s9-4": {
    title: "System Tests — Interlocking",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من Interlocking Tests",
      "معرفة أنواع Interlocks الشائعة في مشاريع SEC",
      "إتقان إجراء اختبار كل نوع",
      "توثيق نتائج Interlocking Tests"
    ],
    content: `<h3>Interlocking Tests — الحواجز الإلكترونية للسلامة</h3><p><strong>Interlocking</strong> منظومة شروط كهربائية ومنطقية تمنع تنفيذ عمليات خاطئة. اختبار كل Interlock إلزامي قبل التشغيل.</p><h3>أنواع Interlocks الرئيسية</h3><ul><li><strong>1. Busbar-Cable Interlock</strong>: لا يمكن توصيل الكيبل بالشينة ما لم يُكمل Phasing Test بنجاح. الاختبار: محاولة الغلق بدون Phasing Approval — يجب رفض الأمر</li><li><strong>2. Earth Switch Interlock</strong>: لا يمكن إغلاق Earth Switch ما لم يكن القاطع الرئيسي مفتوحاً وجهد الكيبل = صفر. الاختبار: محاولة تشغيله والقاطع مغلق — يجب المنع</li><li><strong>3. Protection Interlock</strong>: عند Trip Signal من 87L، يُفصل القاطع وتُغلق جميع Source Breakers. الاختبار: حقن Trip Signal ومراقبة تسلسل الفصل</li></ul><h3>التوثيق</h3><p>كل Interlock يُوثَّق في <strong>Logic Test Sheet</strong>: الشرط المُختبَر، النتيجة المتوقعة، النتيجة الفعلية، الحكم (Pass/Fail).</p>`,
    tools: [
      { name: "Logic Test Sheet", icon: "file-text" },
      { name: "Relay Trip Injection Set", icon: "zap" },
      { name: "Status Indication Display (SCADA)", icon: "cpu" },
      { name: "Multimeter (Contact Verification)", icon: "activity" }
    ],
    hseWarnings: [
      "اختبار Earth Switch Interlock يستلزم التأكد من أن الكيابل فعلاً خاملة",
      "اختبار Trip Interlock يُفصل القاطع — إشعار مركز التحكم مسبقاً إلزامي"
    ],
    commonMistakes: [
      "اختبار Interlock بـ Bypass لتسريع العمل — يُخفي مشكلة حقيقية في الـ Logic",
      "إهمال توثيق Interlocks الفاشلة — الفشل يستلزم تصحيحاً وإعادة اختبار"
    ],
    references: [
      "IEC 62271-200 — AC Metal-Enclosed Switchgear Interlocking",
      "SEC Protection and Control Standards",
      "SEC TMSS — Interlocking Test Requirements"
    ]
  },

  "c8-s9-5": {
    title: "System Tests — End-to-End Trip",
    category: "الاختبارات الفنية",
    categoryEn: "Technical Testing",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم الغرض من End-to-End Trip Test وسبب حرجيته",
      "إتقان تنسيق إجراء الاختبار بين المحطتَيْن",
      "معرفة القياسات المطلوبة وزمن الاستجابة المقبول",
      "توثيق النتائج في Test Report النهائي"
    ],
    content: `<h3>End-to-End Trip Test — الاختبار النهائي قبل التشغيل</h3><p><strong>End-to-End Trip Test</strong> يُثبت أن منظومة الحماية بأكملها (Relay → CT → Fiber → Communication → Remote Relay → Breaker) تعمل من طرف لطرف في الزمن المطلوب.</p><h3>ما يُثبته</h3><ul><li>الفايبر الضوئي يُرسل الإشارة في الزمن الصحيح (< 10 ms)</li><li>Relay في المحطة البعيدة يستقبل الإشارة ويُطلق Trip</li><li>القاطع في المحطة البعيدة يُفصل في الزمن المحدد</li><li>تسلسل الفصل في كلا المحطتين متزامن</li></ul><h3>تسلسل الاختبار</h3><ol><li>تنسيق مسبق بين مهندس المحطة القريبة والبعيدة</li><li>حقن Current/Voltage من Relay Test Set لمحاكاة قصر في Zone 1</li><li>Relay يُطلق Trip Signal عبر الفايبر</li><li>في المحطة البعيدة: مراقبة استجابة الـ Relay والقاطع</li></ol><h3>زمن الاستجابة المقبول (SEC)</h3><ul><li><strong>87L Total Trip Time</strong>: < 30 ms</li><li><strong>Teleprotection Channel Delay</strong>: < 10 ms</li><li><strong>Breaker Operating Time</strong>: < 60 ms (GIS) أو < 80 ms (AIS)</li></ul>`,
    tools: [
      { name: "OMICRON CMC (End-to-End)", icon: "settings" },
      { name: "GPS Time Synchronizer", icon: "cpu" },
      { name: "Event Recorder (both ends)", icon: "activity" },
      { name: "End-to-End Test Report", icon: "file-text" }
    ],
    hseWarnings: [
      "End-to-End Test يُفصل القاطع فعلياً في كلا المحطتين — تأكد من أن الكيابل معزولة",
      "استخدام GPS Time Sync بدلاً من الاتصال الهاتفي — دقة أعلى بكثير"
    ],
    commonMistakes: [
      "إجراء End-to-End Test بدون GPS Synchronization — زمن الاستجابة المحسوب يكون غير دقيق",
      "إهمال التحقق من Trip في المحطة البعيدة — الكيبل يحتاج التحقق من الطرفين"
    ],
    references: [
      "IEC 60834-1 — End-to-End Testing of Teleprotection",
      "CIGRÉ Technical Brochure — Commissioning of Protection Systems",
      "SEC TMSS — End-to-End Trip Test Protocol"
    ]
  },
// ===== c9: السلامة والجودة =====
  ...
  "c9-s1-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم هيكل نظام PTW في شركة SEC/GRIDCO",
      "معرفة أنواع تصاريح العمل وشروط إصدار كل منها",
      "إتقان إجراءات طلب واستلام وإغلاق PTW",
      "فهم ما يُبطل PTW وكيفية التعامل مع الطوارئ"
    ],
    content: `<h3>نظام PTW — الحصن الأول للسلامة</h3><p><strong>Permit to Work (PTW)</strong> نظام رسمي يضمن أن الأعمال الخطرة تُنفَّذ بعد اتخاذ جميع الاحتياطات وبإذن مكتوب من الجهة المسؤولة. في SEC/GRIDCO هو إلزامي لكل عمل على المنظومة الكهربائية.</p><h3>هيكل نظام PTW في SEC</h3><ul><li><strong>Issuing Authority</strong>: مشغّل المحطة أو مهندس الشبكة — يُصدر PTW بعد التحقق من اكتمال العزل والتأريض</li><li><strong>Receiving Authority</strong>: مشرف المقاول أو قائد الفريق — يستلم PTW ويُقرّ بفهم الشروط</li><li><strong>Working Party</strong>: العمال المُصرَّح لهم — أسماؤهم في PTW</li></ul><h3>أنواع PTW الرئيسية</h3><ul><li><strong>Electrical PTW</strong>: للأعمال على المنظومة الكهربائية</li><li><strong>Civil Works PTW</strong>: للحفر والأعمال المدنية بالقرب من منشآت SEC</li><li><strong>Hot Work PTW</strong>: للحام وأي عمل بالنار</li><li><strong>Confined Space PTW</strong>: للمناهيل والغرف المغلقة</li><li><strong>Working at Height PTW</strong>: للأعمال على المرتفعات</li></ul><h3>تسلسل PTW</h3><ol><li>طلب PTW: المقاول يُقدّم طلباً قبل 24-48 ساعة</li><li>مراجعة الطلب من Issuing Authority</li><li>تنفيذ الإجراءات الأمنية (LOTO، تأريض)</li><li>إصدار PTW وتوقيع الطرفين</li><li>تنفيذ العمل ضمن الحدود المُحددة</li><li>إغلاق PTW عند الانتهاء</li></ol><h3>ما يُبطل PTW فوراً</h3><ul><li>تجاوز نطاق العمل المحدد</li><li>اكتشاف خطر غير متوقع</li><li>حادثة أو Near Miss أثناء العمل</li><li>انقضاء مدة صلاحية PTW</li></ul>`,
    tools: [
      { name: "PTW Form (SEC Standard)", icon: "file-text" },
      { name: "LOTO Lock & Tag Set", icon: "shield" },
      { name: "Voltage Detector (HV)", icon: "zap" },
      { name: "Portable Earth Set", icon: "layers" }
    ],
    hseWarnings: [
      "البدء في أي عمل كهربائي بدون PTW صادر ومُوقَّع = انتهاك صريح يُعرّض للفصل والملاحقة القانونية",
      "PTW صالح لموقع محدد وفريق محدد — لا يُنقل لموقع آخر"
    ],
    commonMistakes: [
      "تجاوز نطاق العمل طمعاً في إنجاز أكثر — حتى التمديد البسيط يستلزم تعديل PTW رسمياً",
      "إغلاق PTW دون التحقق من إزالة جميع أدوات التأريض"
    ],
    references: [
      "SEC Safety Rules — Permit to Work System",
      "IEC 60900 — Live Working Safety Procedures",
      "Saudi Labor Law — Occupational Safety Requirements"
    ]
  },
  ...
  "c9-s1-1": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم مبدأ LOTO وكيف يحمي العمال من الطاقة غير المتوقعة",
      "إتقان إجراءات LOTO خطوة بخطوة",
      "معرفة متطلبات أقفال وبطاقات LOTO",
      "فهم إجراءات رفع LOTO بعد انتهاء العمل"
    ],
    content: `<h3>LOTO — عزل الطاقة بشكل مُؤمَّن</h3><p><strong>LOTO (Lock-Out Tag-Out)</strong> منهجية لعزل مصادر الطاقة من الجهاز المُصان ومنعها من العودة أثناء العمل. الـ Lock-Out يُغلق فيزيائياً مصدر الطاقة، والـ Tag-Out يُعلّق بطاقة تحذيرية.</p><h3>تسلسل LOTO في أنظمة HV</h3><ol><li><strong>تحديد مصادر الطاقة</strong>: جميع الكيابل والقواطع المتصلة</li><li><strong>إبلاغ الأطراف المعنية</strong>: مشغّل المحطة ومركز التحكم</li><li><strong>فصل القواطع</strong>: فتح جميع القواطع الرئيسية والخدمية</li><li><strong>Lock-Out</strong>: تركيب قفل شخصي على كل قاطع — مفتاحه فقط مع صاحبه</li><li><strong>Tag-Out</strong>: تعليق بطاقة DANGER — DO NOT OPERATE</li><li><strong>التحقق من الجهد الصفري</strong>: قياس بـ Voltage Detector المعتمد</li><li><strong>تطبيق Portable Earthing</strong>: تأريض يدوي على الكيابل</li></ol><h3>القواعد الذهبية لـ LOTO</h3><ul><li>كل شخص في الفريق يضع قفله الشخصي — لا أحد يمسّه إلا صاحبه</li><li>القفل لا يُرفع حتى ينتهي صاحبه من العمل</li><li>Multi-Hasp للأقفال عند تعدد الفرق</li></ul>`,
    tools: [
      { name: "LOTO Lock (Personal Key)", icon: "shield" },
      { name: "DANGER Tag", icon: "alert-triangle" },
      { name: "Multi-Hasp Lockout Device", icon: "box" },
      { name: "HV Voltage Detector", icon: "zap" }
    ],
    hseWarnings: [
      "رفع قفل LOTO شخص آخر لأي سبب = جريمة تُعرّض للفصل الفوري — حتى رئيس العمل لا يحق له ذلك",
      "LOTO يُطبَّق على الكيابل الحية المُعزَّلة أيضاً — لا تفترض أن الكيبل المُفصول آمن بدون تأريض"
    ],
    commonMistakes: [
      "استخدام قفل مشترك بين الفريق بدلاً من أقفال شخصية",
      "إهمال Tag-Out معتمداً على Lock-Out فقط — البطاقة توضّح السبب وتمنع الإزالة الخاطئة"
    ],
    references: [
      "OSHA 29 CFR 1910.147 — Control of Hazardous Energy",
      "SEC Safety Rules — LOTO Procedure",
      "IEC 60900 — Electrical Safety"
    ]
  },

  "c9-s1-2": {
    title: "Portable Earthing",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من التأريض اليدوي المحمول",
      "إتقان تسلسل تطبيق وإزالة التأريض اليدوي",
      "معرفة معايير اختيار Portable Earth Set",
      "فهم خطر الجهد المستحث على الكيابل المعزولة"
    ],
    content: `<h3>Portable Earthing — آخر حاجز قبل العمل</h3><p><strong>Portable Earthing</strong> توصيل مؤقت يُربط يدوياً بين الكوابل المعزولة والأرض. يضمن أن أي طاقة تعود للكيبل تُصرَّف للأرضي فوراً بدلاً من المرور بجسم العامل.</p><h3>لماذا التأريض اليدوي ضروري رغم فصل القواطع؟</h3><ul><li><strong>الجهد المستحث</strong>: الكيابل الموازية الحية تُحثّ جهداً على الكيابل المعزولة</li><li><strong>الطاقة المخزنة (Capacitive)</strong>: الكيابل الطويلة مكثفات تظل مشحونة بعد الفصل</li><li><strong>الخطأ البشري</strong>: إعادة توصيل خاطئة لقاطع</li></ul><h3>تسلسل تطبيق Portable Earthing</h3><ol><li>التحقق من الجهد الصفري بـ Voltage Detector المعتمد</li><li>توصيل طرف الأرضي (Earth Lead) <strong>أولاً</strong></li><li>توصيل طرف الكيبل بالفاز باستخدام Hot Stick</li><li>تكرار للفازات الثلاث</li></ol><h3>تسلسل الإزالة (عكسي تماماً)</h3><ol><li>فصل طرف الكيابل أولاً من كل فاز</li><li>فصل طرف الأرضي أخيراً</li></ol><h3>مواصفات Portable Earth Set</h3><ul><li>للنظام 110 kV (Isc = 31.5 kA): مقطع ≥ 95mm² Cu</li><li>مقاومة تماس الـ Clamp < 10 mΩ</li></ul>`,
    tools: [
      { name: "Portable Earth Set (HV Rated)", icon: "shield" },
      { name: "Hot Stick (Insulating Rod)", icon: "zap" },
      { name: "HV Voltage Detector", icon: "activity" },
      { name: "Earth Clamp Resistance Tester", icon: "settings" }
    ],
    hseWarnings: [
      "تطبيق الأرضي اليدوي دون التحقق من الجهد الصفري أولاً = خطر الموت الفوري",
      "إزالة الأرضي قبل انتهاء العمل وانسحاب الفريق = خطر القصر على العمال"
    ],
    commonMistakes: [
      "توصيل طرف الكيبل قبل طرف الأرضي — إذا وُجد جهد متبقٍ، يمر عبر جسم العامل",
      "استخدام Portable Earth Set بمقطع أصغر من المطلوب — ينصهر عند القصر"
    ],
    references: [
      "IEC 61230 — Portable Earthing Equipment",
      "SEC Safety Rules — Earthing Procedure",
      "OSHA 29 CFR 1910.269 — Electric Power Generation"
    ]
  },

  "c9-s2-0": {
    title: "Induced Voltages",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم مصادر الجهد المستحث وآليات التحريض",
      "معرفة مقدار الجهود المستحثة المتوقعة في مشاريع SEC",
      "إتقان إجراءات الحماية من الجهود المستحثة",
      "معرفة قياس الجهد المستحث وتفسير النتائج"
    ],
    content: `<h3>Induced Voltages — الخطر الصامت</h3><p><strong>Induced Voltages</strong> جهود كهربائية تتولّد في الكيابل المعزولة والهياكل المعدنية بسبب قربها من كيابل وخطوط حية. في مشاريع UGC، الكيابل الجديدة المدفونة بجانب كيابل حية تحمل هذا الجهد حتى قبل توصيلها.</p><h3>مصادر التحريض</h3><ul><li><strong>Magnetic Induction</strong>: التيار في الكيابل الحية يُولّد مجالاً مغناطيسياً يُحثّ جهداً في الكيابل المجاورة</li><li><strong>Capacitive Coupling</strong>: الجهد العالي في كيابل حية يُحثّ جهداً عبر السعة بين الكيابل القريبة</li></ul><h3>قيم الجهد المستحث المتوقعة</h3><ul><li>كيبل 110 kV بجانب كيبل حي حامل 500A لمسافة 1 كم: V_induced ≈ 30-60V</li><li>عند القصر الأرضي: قد يصل V_induced لآلاف الفولتات</li></ul><h3>إجراءات الحماية</h3><ul><li><strong>قياس الجهد أولاً</strong>: قبل أي لمس للكيابل المعزولة</li><li><strong>تأريض نقطة واحدة</strong>: لتصريف الجهد المستحث</li><li><strong>Bonding العمال</strong>: ربط العامل بشريط توصيل بهيكل مؤرَّض</li><li><strong>تأريض مؤقت</strong>: Portable Earth في نطاق 5م من موقع العمل</li></ul>`,
    tools: [
      { name: "HV Voltmeter (True RMS)", icon: "activity" },
      { name: "Bonding Strap (Conductive)", icon: "shield" },
      { name: "Portable Earth Set", icon: "layers" },
      { name: "Induced Voltage Calculator", icon: "cpu" }
    ],
    hseWarnings: [
      "جهد 50V على كيبل 'معزول' في بيئة رطبة كافٍ لصدمة مميتة — لا تفترض أن الكيبل المفصول آمن",
      "العمال على التربة يلمسون كيبلاً مستحثاً يُكوّنون دائرة كهربائية — ارتداء حذاء EH-Rated إلزامي"
    ],
    commonMistakes: [
      "افتراض أن الجهد المستحث ضعيف في التشغيل العادي — ارتفاع الحمل فجأة يُضاعف الجهد المستحث",
      "إهمال التأريض المؤقت للكيابل الجديدة أثناء التمديد بجانب كيابل حية"
    ],
    references: [
      "IEC 60479 — Effects of Current on Human Body",
      "CIGRÉ Technical Brochure 283 — Induced Voltages in Cable Systems",
      "SEC Safety Rules — Induced Voltage Protection"
    ]
  },
  ...
  "c9-s2-1": {
    ...
    difficulty: "متقدم",
    objectives: [
      "فهم ظاهرة Arc Flash وأسبابها في مشاريع UGC",
      "معرفة كيفية حساب Incident Energy وتصنيف PPE",
      "إتقان الإجراءات الوقائية قبل العمل في مناطق Arc Flash",
      "معرفة متطلبات Arc Flash Label في مشاريع SEC"
    ],
    content: `<h3>Arc Flash — الوميض الكهربائي القاتل</h3><p><strong>Arc Flash</strong> قوس كهربائي عرضي يُصدر حرارة تصل 20,000°C، ضوءاً مُعمياً، موجة ضغط، ومعادن مُصهَّرة في الهواء. يحدث عند Terminations، Link Boxes، ولوحات التوزيع.</p><h3>حساب Incident Energy</h3><p>طاقة Arc Flash المتوقعة عند نقطة عمل (بـ cal/cm²) تحدد نوع PPE:</p><pre>E = 4.184 × Cf × En × (t/0.2) × (610^x / D^x)</pre><h3>تصنيفات Arc Flash (IEEE 1584 / NFPA 70E)</h3><ul><li><strong>Category 1</strong>: 1.2-4 cal/cm² — سترة FR + وجه Shield</li><li><strong>Category 2</strong>: 4-8 cal/cm² — Coverall Arc-Rated</li><li><strong>Category 3</strong>: 8-25 cal/cm² — Full Arc Flash Suit</li><li><strong>Category 4</strong>: 25-40 cal/cm² — Heavy Arc Flash Suit</li><li><strong>> 40 cal/cm²</strong>: محظور العمل على الإطلاق في الوضع الحي</li></ul><h3>Approach Boundaries</h3><ul><li><strong>Flash Protection Boundary</strong>: الحد الأبعد حيث قد تحدث حروق</li><li><strong>Limited Approach Boundary</strong>: حد تحذيري يتطلب مؤهلات خاصة</li><li><strong>Restricted Approach Boundary</strong>: منطقة الخطر الشديد — PPE كامل</li></ul>`,
    tools: [
      { name: "Arc Flash PPE (Cat 2/4)", icon: "shield" },
      { name: "Face Shield (Arc-Rated)", icon: "camera" },
      { name: "Arc Flash Calculator (IEEE 1584)", icon: "cpu" },
      { name: "Arc Flash Label Printer", icon: "pen-line" }
    ],
    hseWarnings: [
      "Arc Flash يحدث خلال milliseconds — PPE يجب أن يكون مُرتدَى قبل الاقتراب من Energized Equipment",
      "فتح Panel أو Link Box حي بدون Arc Flash Analysis = خطر قاتل"
    ],
    commonMistakes: [
      "ارتداء PPE Cat 2 في بيئة تتطلب Cat 4 — الفرق في الحماية لا يُعوَّض",
      "إهمال تركيب Arc Flash Labels على Link Boxes"
    ],
    references: [
      "IEEE 1584 — Guide for Arc Flash Hazard Calculations",
      "NFPA 70E — Standard for Electrical Safety in the Workplace",
      "SEC Safety Standards — Arc Flash Protection"
    ]
  },
  ...
  "c9-s2-2": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم تعريف Confined Space وتصنيف المناهيل الكهربائية",
      "معرفة المخاطر الخاصة بالمناهيل",
      "إتقان إجراءات دخول Confined Space وفق SEC",
      "معرفة متطلبات Rescue Plan"
    ],
    content: `<h3>Confined Space — الفضاء المحدود</h3><p><strong>Confined Space</strong> مكان له مدخل/مخرج محدود، غير مُصمَّم للإشغال المستمر، وقد يحتوي على مخاطر تنفسية. المناهيل الكهربائية تُصنَّف كـ <strong>Permit-Required Confined Space</strong>.</p><h3>المخاطر الخاصة بالمناهيل الكهربائية</h3><ul><li><strong>نقص الأكسجين</strong>: تحت 19.5% O₂ يُسبب فقدان الوعي</li><li><strong>غاز CO₂</strong>: أثقل من الهواء يتراكم في القاع. مميت وبلا رائحة</li><li><strong>غاز الميثان (CH₄)</strong>: قابل للاشتعال</li><li><strong>H₂S</strong>: في مناطق قرب الصرف. سام بتركيزات منخفضة</li><li><strong>حرارة شديدة</strong>: المنهل في صيف السعودية قد يصل 60°C+</li></ul><h3>إجراءات دخول Confined Space (SEC)</h3><ol><li>إصدار Confined Space Entry Permit مستقل</li><li>اختبار الهواء بـ 4-Gas Detector: O₂، CO، CH₄، H₂S</li><li>تشغيل تهوية قسرية ≥ 10 دقائق قبل الدخول</li><li>Standby Person خارج المنهل طوال الوقت — لا يدخل</li><li>Rescue Kit جاهز (حبل، Tripod، SCBA)</li><li>مراقبة مستمرة للغازات أثناء العمل</li></ol>`,
    tools: [
      { name: "4-Gas Detector (O₂, CO, CH₄, H₂S)", icon: "wind" },
      { name: "Portable Ventilation Fan", icon: "settings" },
      { name: "Tripod + Rescue Winch", icon: "box" },
      { name: "SCBA (Self-Contained Breathing)", icon: "shield" }
    ],
    hseWarnings: [
      "لا تدخل المنهل بدون Gas Test حتى لو فُتح منذ 5 دقائق — الغازات تعود بسرعة",
      "مغادرة Standby Person أثناء وجود شخص في المنهل = انتهاك فوري"
    ],
    commonMistakes: [
      "الدخول للمنهل 'لالتقاط صورة سريعة' — H₂S يُفقد الوعي بدون إنذار",
      "إيقاف المروحة بعد الدخول لتقليل الضوضاء — لا تُوقف التهوية طالما هناك شخص في المنهل"
    ],
    references: [
      "OSHA 29 CFR 1910.146 — Permit-Required Confined Spaces",
      "SEC Safety Rules — Confined Space Entry Procedure",
  ...
  "c9-s2-3": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم أسباب انهيار جدران الحفر وعوامل الخطر",
      "معرفة فئات التربة وتصنيفها",
      "إتقان الإجراءات الوقائية الإلزامية",
      "معرفة علامات الإنذار المبكر للانهيار"
    ],
    content: `<h3>Excavation Collapse — الخطر الأكثر فتكاً في UGC</h3><p>انهيار جدران الحفر يُسبب ضغطاً > طن على جسم الإنسان. الوقت من الانهيار لنقطة اللاعودة: < 3 ثوانٍ. الوقاية الكاملة هي الحل الوحيد.</p><h3>عوامل الخطر</h3><ul><li>عمق > 1.2م في تربة غير متماسكة</li><li>التربة الرطبة أو المشبعة بالمياه الجوفية</li><li>أحمال مجاورة (مركبات، تربة محفورة على الحافة)</li><li>التربة الصبخية في المنطقة الشرقية</li></ul><h3>تصنيف التربة وفق OSHA</h3><ul><li><strong>Type A</strong>: طين متماسك، مقاومة > 144 kPa — أكثر استقراراً</li><li><strong>Type B</strong>: تربة حبيبية رطبة، 48-144 kPa</li><li><strong>Type C</strong>: رمل، تربة مشبعة، < 48 kPa — أخطر أنواع</li></ul><h3>إجراءات الوقاية الإلزامية</h3><ul><li>Competent Person يُقيّم التربة قبل الحفر</li><li>Shoring أو Benching أو Sloping للعمق > 1.2م</li><li>Spoil على بُعد ≥ 0.6م من حافة الحفر</li><li>سلم الإخلاء كل 7.5م</li></ul><h3>علامات الإنذار المبكر</h3><ul><li>تشققات أفقية في جدار الخندق</li><li>صوت طقطقة أو انهيار صغير</li><li>تسرب ماء غير متوقع</li></ul>`,
    tools: [
      { name: "Trench Box (Steel/Aluminium)", icon: "box" },
      { name: "Soil Penetrometer", icon: "settings" },
      { name: "Escape Ladder", icon: "layers" },
      { name: "Spoil Distance Marker", icon: "ruler" }
    ],
    hseWarnings: [
      "لا تدخل الخندق قبل تركيب الـ Shoring — حتى 'لحظة سريعة' قد تكون الأخيرة",
      "انسحب فوراً من الخندق عند أي علامة إنذار مبكر"
    ],
    commonMistakes: [
      "الاعتماد على التقدير البصري للتربة بدلاً من Penetrometer — رمل جاف يبدو متماسكاً لكنه Type C",
      "وضع معدات على حافة الخندق بدلاً من إبعادها 0.6م"
    ],
    references: [
      "OSHA 29 CFR 1926 Subpart P — Excavations",
      "SEC Civil Works Safety Manual",
      "BS 6031 — Code of Practice for Earthworks Safety"
    ]
  },
  ...
  "c9-s2-4": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "معرفة مخاطر Manual Handling في مواقع UGC",
      "إتقان تقنية الرفع الصحيح للأوزان",
      "معرفة الحدود الوزنية الإلزامية",
      "فهم متطلبات Training للعمال في مشاريع SEC"
    ],
    content: `<h3>Manual Handling — الإصابة الأكثر شيوعاً في المواقع</h3><p>إصابات الظهر والعضلات تُمثّل 30-40% من إصابات العمل في مواقع UGC. في السعودية، ارتفاع درجات الحرارة يُضعف العضلات ويرفع خطر الإصابة في الصيف.</p><h3>الحدود الوزنية (NIOSH / ISO 11228)</h3><ul><li><strong>فرد واحد - رفع مثالي</strong>: ≤ 25 كجم</li><li><strong>فرد واحد - حد أقصى مطلق</strong>: ≤ 50 كجم</li><li><strong>رفع فوق مستوى الكتفين</strong>: ≤ 10 كجم</li><li><strong>رفع جماعي</strong>: للأوزان > 50 كجم — تنسيق وتزامن إلزامي</li></ul><h3>تقنية الرفع الصحيح</h3><ol><li>قيّم الوزن قبل الرفع</li><li>اقترب من الحمل — لا تمد يدك للأمام</li><li>افرد قدميك (عرض الكتفين)</li><li>انحنِ بالركبتين لا بالظهر</li><li>ارفع ببطء مستخدماً عضلات الساق</li><li>لا تلتوِ أثناء الرفع — حرّك القدمين للاستدارة</li></ol><h3>أوزان شائعة في UGC</h3><ul><li>Cable Tile (خرسانية): 20-25 كجم — حد الفرد الواحد</li><li>Manhole Cover: 80-200 كجم — رافعة ميكانيكية إلزامية</li></ul>`,
    tools: [
      { name: "Mechanical Manhole Lifter", icon: "settings" },
      { name: "Hand Truck / Trolley", icon: "box" },
      { name: "Back Support Belt", icon: "shield" }
    ],
    hseWarnings: [
      "الرفع في درجات > 40°C يُضاعف إجهاد العضلات — راحة إلزامية كل 45 دقيقة",
      "لا ترفع غطاء المنهل بدون أداة رفع ميكانيكية — 100+ كجم بالشد المباشر = إصابة ظهر مضمونة"
    ],
    commonMistakes: [
      "الرفع بالظهر مستقيماً والركبتان ممدودتان — يُضغط على الأقراص الفقرية",
      "تقسيم حمل 200 كجم بين 4 أشخاص دون تنسيق"
    ],
    references: [
      "ISO 11228-1 — Ergonomics of Manual Handling",
      "HSE UK — Manual Handling Operations Regulations",
      "SEC HSE Manual — Manual Handling Guidelines"
    ]
  },

  "c9-s3-0": {
    title: "Arc-Rated Coveralls (Cat 2/4)",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "7 دقائق",
    difficulty: "مبتدئ",
    objectives: [
      "فهم الفرق بين ملابس Arc-Rated العادية وغير المقاومة",
      "معرفة تصنيفات Arc Flash PPE (Cat 1-4)",
      "إتقان إجراءات فحص وصيانة Arc-Rated Coveralls",
      "معرفة شروط الاستخدام في مشاريع SEC"
    ],
    content: `<h3>Arc-Rated Coveralls — الحاجز بين الإنسان والوميض</h3><p><strong>Arc-Rated Coveralls</strong> ملابس مصنوعة من أقمشة FR + AR تحمي مرتديها من حروق Arc Flash. الملابس العادية (بوليستر، نايلون) تُشتعل وتذوب على الجلد مُضاعِفةً الإصابة.</p><h3>تصنيفات Arc-Rated PPE (NFPA 70E)</h3><ul><li><strong>Category 1</strong>: Arc Rating ≥ 4 cal/cm²</li><li><strong>Category 2</strong>: Arc Rating ≥ 8 cal/cm² — الأكثر استخداماً في UGC (Link Boxes، Terminations 110 kV)</li><li><strong>Category 3</strong>: Arc Rating ≥ 25 cal/cm²</li><li><strong>Category 4</strong>: Arc Rating ≥ 40 cal/cm²</li></ul><h3>متطلبات في مشاريع SEC</h3><ul><li>جميع الأعمال على Energized Equipment تستلزم Arc-Rated PPE</li><li>Coverall مغلق بالكامل (زرايب، أكمام، رقبة)</li><li>الملابس الداخلية: Cotton فقط — بوليستر تحت FR = خطر</li></ul><h3>فحص وصيانة</h3><ul><li>فحص قبل كل استخدام: تمزقات، بقع زيت، ثقوب</li><li>غسيل وفق تعليمات المصنع فقط</li><li>استبدال بعد 5 سنوات أو 100 غسلة</li></ul>`,
    tools: [
      { name: "Arc-Rated Coverall (Cat 2)", icon: "shield" },
      { name: "Arc Flash Face Shield", icon: "camera" },
      { name: "FR Gloves (Leather)", icon: "shield" },
      { name: "PPE Inspection Checklist", icon: "check-circle" }
    ],
    hseWarnings: [
      "Coverall FR بدون Arc Rating لا يحمي من Arc Flash — تأكد من أن الملصق يذكر cal/cm²",
      "بقعة زيت على FR Coverall تُشعلها — الملابس الملوثة بالزيت يجب غسلها أولاً"
    ],
    commonMistakes: [
      "اعتبار أي ملابس داكنة اللون 'آمنة' — اللون ليس معياراً، Arc Rating هو المعيار",
      "ارتداء Coverall Category 2 في موقع يتطلب Category 4"
    ],
    references: [
      "NFPA 70E — Standard for Electrical Safety, PPE Requirements",
      "IEEE 1584 — Arc Flash PPE Categories",
      "ASTM F1506 — Performance Spec for Flame Resistant Textiles"
    ]
  },
  ...
  "c9-s3-1": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "معرفة أنواع Safety Helmets وتصنيفاتها الكهربائية",
      "فهم متطلبات Chin Strap في مواقع UGC",
      "معرفة عمر الخوذة وإجراءات استبدالها",
      "تحديد الألوان والرموز المعتمدة في مشاريع SEC"
    ],
    content: `<h3>Safety Helmet في مشاريع UGC</h3><p>الخوذة تحمي من: الأجسام الساقطة، الاصطدام، والجهود الكهربائية في بيئات HV.</p><h3>تصنيفات السلامة</h3><ul><li><strong>Class E (Electrical)</strong>: تتحمل 20,000V AC — مطلوب في أعمال الكهرباء HV</li><li><strong>Class G (General)</strong>: تتحمل 2,200V</li><li><strong>Class C (Conductive)</strong>: لا حماية كهربائية — غير مقبولة في مشاريع UGC</li></ul><h3>Chin Strap — إلزامي في</h3><ul><li>العمل في الارتفاعات</li><li>البيئات ذات الرياح الشديدة</li><li>جميع أعمال HV Testing</li></ul><h3>عمر الخوذة</h3><ul><li>5 سنوات من تاريخ التصنيع</li><li>3 سنوات من تاريخ الاستخدام في البيئة القاسية</li><li>استبدال فوري عند: تشقق، صدمة كبيرة، تغيير في اللون</li></ul><h3>ألوان الخوذات في SEC</h3><ul><li>أبيض: مهندسون ومشرفون | أصفر: عمال عامون | أخضر: مفتشو السلامة</li></ul>`,
    tools: [
      { name: "Class E Safety Helmet", icon: "shield" },
      { name: "Chin Strap", icon: "layers" },
      { name: "Helmet Inspection Form", icon: "check-circle" }
    ],
    hseWarnings: [
      "الخوذة التي أُسقطت من > 2م يجب استبدالها فوراً حتى لو تبدو سليمة",
      "الكتابة على الخوذة بالمذيبات تُتلف المادة وتُقلل الحماية"
    ],
    commonMistakes: [
      "استخدام Class G في أعمال HV Testing",
      "ارتداء الخوذة بشكل متأخر على الرأس (Tilted Back)"
    ],
    references: [
      "ANSI Z89.1 — Industrial Head Protection",
      "EN 397 — Industrial Safety Helmets",
      "SEC HSE Requirements — PPE Selection Guide"
    ]
  },
  ...
  "c9-s3-2": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم تصنيف EH (Electrical Hazard) للأحذية",
      "معرفة الفرق بين EH وStatically Dissipative وConductive",
      "معرفة متطلبات اختبار الأحذية",
      "فهم أهمية EH Boots في الحماية"
    ],
    content: `<h3>EH Boots — الحماية من تحت القدم</h3><p><strong>EH (Electrical Hazard) Boots</strong> أحذية تمنع مرور التيار عبر الجسم من خلال الأرض. النعل يعمل كعازل يمنع الدائرة الكهربائية في حالة وقوف العامل على موصّل حي.</p><h3>تصنيفات الأحذية الكهربائية</h3><ul><li><strong>EH</strong>: تتحمل 18,000V AC — للأعمال الكهربائية في SEC. مقاومة النعل ≥ 10⁷ Ω</li><li><strong>Statically Dissipative (SD)</strong>: تُفرّغ الكهرباء الساكنة. مقاومة 10⁵-10⁸ Ω</li><li><strong>Conductive (C)</strong>: مقاومة < 10⁵ Ω. مُحظور في أعمال HV</li></ul><h3>متطلبات EH Boots في مشاريع SEC</h3><ul><li>جميع العمال في مناطق الكهرباء يرتدون EH Boots</li><li>فحص دوري: لا تشققات، لا ثقوب، سماكة نعل ≥ 3mm</li><li>استبدال عند أي تلف أو بعد 3 سنوات</li></ul>`,
    tools: [
      { name: "EH Safety Boots (18kV)", icon: "shield" },
      { name: "Boot Resistance Tester", icon: "activity" },
      { name: "Boot Inspection Form", icon: "check-circle" }
    ],
    hseWarnings: [
      "EH Boots مبللة من الداخل تفقد خصائصها العازلة — تبديل الجوارب إلزامي عند البلل",
      "Conductive Boots في مشاريع HV = خطر قاتل — ابحث دائماً عن رمز EH"
    ],
    commonMistakes: [
      "شراء أحذية 'Safety' عادية دون رمز EH",
      "إهمال فحص النعل قبل كل يوم عمل — تشقق بسيط يُلغي الحماية"
    ],
    references: [
      "ASTM F2413 — Performance Requirements for Safety Footwear",
      "EN 50321 — Footwear for Electrical Workers",
      "SEC PPE Selection Guide — Electrical Work"
    ]
  },
  ...
  "c9-s3-3": {
    ...
    difficulty: "متوسط",
    objectives: [
      "معرفة تصنيفات Insulated Gloves من Class 00 إلى Class 6",
      "فهم متطلبات اختبار الجهد الدوري",
      "إتقان إجراءات فحص القفازات قبل الاستخدام",
      "معرفة قواعد تخزين القفازات المعزولة"
    ],
    content: `<h3>Insulated Rubber Gloves — الحماية الكهربائية لليدين</h3><p><strong>Insulated Gloves</strong> قفازات مطاطية تعمل كعازل بين يدي العامل والمعدات الحية. هي PPE الأكثر أهمية للعمل على الكيابل والوصلات.</p><h3>تصنيفات الجهد (ASTM D120 / IEC 60903)</h3><ul><li><strong>Class 00</strong>: جهد عمل ≤ 500V AC</li><li><strong>Class 0</strong>: ≤ 1,000V AC</li><li><strong>Class 1</strong>: ≤ 7,500V AC</li><li><strong>Class 2</strong>: ≤ 17,000V AC — مناسب لكيابل 11-33 kV</li><li><strong>Class 3</strong>: ≤ 26,500V AC — لكيابل 33-69 kV</li><li><strong>Class 4</strong>: ≤ 36,000V AC — لكيابل حتى 132 kV</li></ul><h3>الاختبار الدوري الإلزامي</h3><ul><li>كل <strong>6 أشهر</strong>: اختبار AC جهد كامل × 3 دقائق في مختبر معتمد</li><li>كل قفاز يحمل تاريخ الاختبار والانتهاء</li></ul><h3>فحص ميداني قبل الاستخدام (Air Inflation Test)</h3><ol><li>لفّ القفاز على نفسه من الجزء المفتوح</li><li>انفخ هواءً وأغلق الفتحة</li><li>افحص بصرياً واستمع لأي تسرب</li><li>أي تسرب = قفاز مرفوض</li></ol>`,
    tools: [
      { name: "Rubber Insulating Gloves (Class 2/4)", icon: "shield" },
      { name: "Leather Protector (Outer Glove)", icon: "box" },
      { name: "Glove Inflator (Air Test)", icon: "wind" },
      { name: "Glove Test Record Card", icon: "file-text" }
    ],
    hseWarnings: [
      "القفاز المطاطي وحده هش ميكانيكياً — يجب ارتداء Leather Protector فوقه دائماً",
      "قفاز Class 2 على كيابل 110 kV = خطر قاتل — تحقق من تطابق Class القفاز مع جهد الكيبل"
    ],
    commonMistakes: [
      "استخدام قفازات منتهية صلاحية اختبارها 'في الطوارئ'",
      "ارتداء القفازات بدون Leather Protector — أول اتصال بحافة حادة يثقب المطاط"
    ],
    references: [
      "IEC 60903 — Insulating Gloves for Electrical Work",
      "ASTM D120 — Rubber Insulating Gloves",
      "SEC PPE Standard — Electrical Glove Requirements"
    ]
  },
  ...
  "c9-s3-4": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم أهمية Gas Detector قبل دخول المناهيل",
      "معرفة الغازات الأربعة المُقاسة وحدودها الآمنة",
      "إتقان إجراءات معايرة واستخدام Gas Detector",
      "معرفة إجراء الإخلاء الفوري عند الإنذار"
    ],
    content: `<h3>Gas Detector — الحارس الإلكتروني للمناهيل</h3><p><strong>Gas Detector (4-Gas Monitor)</strong> جهاز يقيس تركيز الغازات الخطرة. إلزامي قبل وأثناء كل دخول للمناهيل الكهربائية.</p><h3>الغازات الأربعة</h3><ul><li><strong>O₂</strong>: طبيعي 20.9%. تحذير < 19.5%. قاتل < 16%</li><li><strong>LEL (CH₄)</strong>: تحذير عند 10% LEL. إخلاء عند 25%</li><li><strong>CO</strong>: تحذير 25 ppm. خطر 200 ppm</li><li><strong>H₂S</strong>: تحذير 5 ppm. قاتل 300 ppm. يُفقد حاسة الشم بعد لحظات!</li></ul><h3>إجراءات الاستخدام</h3><ol><li>معايرة يومياً بغاز مرجعي معروف</li><li>تشغيل الجهاز في الهواء النقي لتصفيره</li><li>إدخال مسبار في المنهل من الأعلى للأسفل</li><li>انتظار 60 ثانية لقراءة مستقرة</li><li>إذا جميع القيم آمنة: تهوية 10 دقائق ثم دخول</li></ol><h3>إجراء الإخلاء عند الإنذار</h3><ul><li>اخرج فوراً — لا تجمع أدواتك</li><li>لا يعود أحد حتى يُحدَّد مصدر الغاز</li></ul>`,
    tools: [
      { name: "4-Gas Monitor (O₂/LEL/CO/H₂S)", icon: "wind" },
      { name: "Calibration Gas Cylinder", icon: "box" },
      { name: "Extension Probe (Sampling)", icon: "layers" },
      { name: "Gas Detector Test Record", icon: "file-text" }
    ],
    hseWarnings: [
      "Gas Detector غير مُعايَر = قراءات خاطئة = ثقة زائفة. معايرة يومية غير قابلة للتفاوض",
      "H₂S يُفقد حاسة الشم بعد لحظات — لا تعتمد على الرائحة كمؤشر للخطر"
    ],
    commonMistakes: [
      "قياس الغازات من الأعلى فقط — H₂S وCO₂ تتراكم في القاع. أدخل المسبار للقاع",
      "إيقاف Gas Detector داخل المنهل لتوفير بطارية — المراقبة المستمرة إلزامية"
    ],
    references: [
      "OSHA 29 CFR 1910.146 — Gas Testing for Confined Space",
      "BS EN 60079-29 — Gas Detector Performance",
      "SEC Safety Rules — Gas Testing Procedure"
    ]
  },
  ...
  "c9-s4-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "معرفة مكونات خطة الطوارئ الشاملة في مشاريع UGC",
      "إتقان تسلسل الاستجابة للحوادث الكبرى",
      "معرفة متطلبات Muster Point وإجراءات التجمع",
      "فهم متطلبات Mock Drill الدوري"
    ],
    content: `<h3>خطة الطوارئ — الاستعداد قبل الكارثة</h3><p><strong>Emergency Response Plan (ERP)</strong> وثيقة تُحدد الإجراءات المُعتمَدة للاستجابة للحوادث. يجب اعتمادها من SEC قبل بدء الأعمال وتدريب جميع العمال عليها.</p><h3>مكونات ERP الرئيسية</h3><ul><li><strong>Hazard Identification</strong>: قائمة الأخطار المحتملة</li><li><strong>Emergency Contacts</strong>: أرقام هاتف واضحة مُعلَّقة في الموقع</li><li><strong>Muster Points</strong>: نقاط التجمع خارج منطقة الخطر</li><li><strong>Rescue Equipment Location</strong>: موقع Confined Space Rescue Kit، AED</li><li><strong>Evacuation Routes</strong>: مسارات الإخلاء</li></ul><h3>تسلسل الاستجابة للحوادث الكبرى</h3><ol><li>STOP — إيقاف جميع الأنشطة فوراً</li><li>SECURE — منع الوصول للمنطقة المُتضررة</li><li>CALL — الاتصال بالطوارئ (911) + مسؤول السلامة في SEC</li><li>AID — الإسعافات الأولية إن كان الوضول آمناً</li><li>REPORT — الإبلاغ الكامل خلال 24 ساعة</li></ol><h3>Mock Drill</h3><p>SEC تُطلب تنفيذ Mock Drill مرة واحدة كل 3 أشهر على الأقل. يُسجَّل في سجل الموقع.</p>`,
    tools: [
      { name: "Emergency Response Plan (Document)", icon: "file-text" },
      { name: "First Aid Kit", icon: "shield" },
      { name: "AED (Automated External Defibrillator)", icon: "activity" },
      { name: "Emergency Contact Board", icon: "alert-triangle" }
    ],
    hseWarnings: [
      "خطة الطوارئ على الورق دون تدريب العمال = ورقة عديمة الفائدة في اللحظة الحرجة",
      "Muster Point في منطقة يصعب وصول سيارات الإسعاف إليها = يُعيق الإنقاذ"
    ],
    commonMistakes: [
      "خطة طوارئ بأرقام هواتف غير مُحدَّثة — مسؤول طوارئ تغيّر ولم يُحدَّث رقمه",
      "Muster Point داخل نطاق الموقع — يجب أن يكون خارج منطقة الخطر"
    ],
    references: [
      "OSHA 29 CFR 1910.38 — Emergency Action Plans",
      "SEC HSE Standard — Emergency Response Requirements",
      "Saudi Civil Defense — Industrial Emergency Guidelines"
    ]
  },
  ...
  "c9-s4-1": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "معرفة أرقام الطوارئ الوطنية السعودية",
      "معرفة أرقام الطوارئ الخاصة بشركة SEC/GRIDCO",
      "فهم كيفية توصيل هذه الأرقام للعمال",
      "إتقان ما تقوله عند الاتصال بالطوارئ"
    ],
    content: `<h3>أرقام الاتصال الطارئ — كل ثانية تُحدث فارقاً</h3><h3>الأرقام الوطنية السعودية</h3><ul><li><strong>911</strong>: الطوارئ الموحد (شرطة + إسعاف + دفاع مدني)</li><li><strong>997</strong>: الدفاع المدني (حريق، كوارث)</li></ul><h3>أرقام خاصة بالمشروع</h3><ul><li>مسؤول السلامة في SEC/GRIDCO للمشروع</li><li>مشغّل المحطة الكهربائية المعنية</li><li>مركز التحكم الإقليمي (RCC)</li><li>المستشفى الأقرب للموقع (مع العنوان)</li></ul><h3>توصيل الأرقام للعمال</h3><ul><li>لوحة طوارئ كبيرة عند مدخل الموقع</li><li>بطاقة جيب لكل عامل (تُوزَّع في اليوم الأول)</li><li>تذكير في كل Toolbox Talk أسبوعي</li></ul><h3>ما تقوله عند الاتصال بـ 911</h3><ol><li>موقعك الدقيق (إحداثيات GPS أو عنوان)</li><li>نوع الحادثة</li><li>عدد المُصابين وحالتهم</li><li>الأخطار الموجودة (كهرباء حية، غاز)</li></ol>`,
    tools: [
      { name: "Emergency Contact Board", icon: "alert-triangle" },
      { name: "Pocket Emergency Card", icon: "file-text" },
      { name: "GPS Location App", icon: "map-pin" }
    ],
    hseWarnings: [
      "في حالة الصدمة الكهربائية: لا تلمس المصاب قبل التأكد من فصل الكهرباء",
      "أخبر مركز 911 بوجود كهرباء حية في الموقع"
    ],
    commonMistakes: [
      "الاتصال بالمشرف أولاً قبل 911 في الحوادث الخطيرة — الدقيقة الأولى هي الأهم",
      "عدم معرفة الإحداثيات GPS للموقع — في الصحراء GPS يوفر وقتاً ثميناً"
    ],
    references: [
      "Saudi Civil Defense — Emergency Reporting Guidelines",
      "SEC HSE Manual — Emergency Contact Requirements",
      "OSHA — Emergency Response Communications"
    ]
  },

  "c9-s4-2": {
    title: "First Aid للصدمة الكهربائية",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "9 دقائق",
    difficulty: "متوسط",
    objectives: [
      "إتقان الخطوات الفورية لإنقاذ ضحية الصدمة الكهربائية",
      "فهم الفرق بين تأثير التيار المنخفض والعالي",
      "معرفة إجراءات CPR في حالات إيقاف القلب",
      "فهم أعراض الحروق الكهربائية الداخلية"
    ],
    content: `<h3>الصدمة الكهربائية — كيف تنقذ حياة</h3><p>التدخل السريع والصحيح خلال الدقائق الأولى هو الفارق بين الحياة والوفاة.</p><h3>الخطوة الأولى والأهم: إيقاف التيار</h3><p><strong>لا تلمس الضحية قبل قطع الكهرباء</strong>. إذا لامستها وهي ملتصقة بمصدر التيار ستصبح ضحية ثانية:</p><ul><li>أوقف التيار من المفتاح أو القاطع الأقرب</li><li>إذا تعذّر: استخدم جسماً غير موصّل (خشب جاف، حبل بلاستيكي)</li></ul><h3>بعد إيقاف التيار — DRS ABC</h3><ul><li><strong>D</strong>: Danger — تأكد من أمان البيئة</li><li><strong>R</strong>: Response — ناده وانقر على كتفيه</li><li><strong>S</strong>: Send for help — اطلب الإسعاف فوراً (911)</li><li><strong>A</strong>: Airway | <strong>B</strong>: Breathing | <strong>C</strong>: Circulation</li></ul><h3>إذا لم يتنفس / لا نبض: CPR فوراً</h3><p>30 ضغطة صدرية + 2 تنفس. استمر حتى وصول الإسعاف. استخدم AED فور توفره.</p><h3>الحروق الكهربائية</h3><p>تبدو صغيرة خارجياً لكنها ضخمة داخلياً. <strong>كل ضحية صدمة كهربائية يجب فحصها في المستشفى حتى لو بدت بخير</strong> — توقف القلب قد يحدث بعد ساعات.</p>`,
    tools: [
      { name: "AED (Automated External Defibrillator)", icon: "activity" },
      { name: "First Aid Kit", icon: "shield" },
      { name: "CPR Face Shield", icon: "box" },
      { name: "Insulating Rod (Non-Conductive)", icon: "layers" }
    ],
    hseWarnings: [
      "لا تُحرّك ضحية الصدمة الكهربائية أكثر من الضروري — احتمال إصابة العمود الفقري",
      "الضحية 'التي تبدو بخير' بعد صدمة HV قد يتوقف قلبها لاحقاً — المستشفى إلزامي"
    ],
    commonMistakes: [
      "لمس الضحية فوراً دون التحقق من إيقاف الكهرباء — سبب رئيسي لتضاعف الضحايا",
      "إعطاء الضحية الماء — لا شيء عن طريق الفم حتى تقييم الطبيب"
    ],
    references: [
      "American Heart Association — CPR Guidelines",
      "IEC 60479-1 — Effects of Current on Human Body",
      "Saudi Red Crescent — Electrical Injury First Aid"
    ]
  },

  "c9-s5-0": {
    title: "ITP (Inspection Test Plan)",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "10 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم هيكل ITP وعلاقته بضمان الجودة",
      "معرفة الفرق بين Hold Points وWitness Points وReview Points",
      "إتقان إعداد ITP مطابق لمتطلبات SEC",
      "معرفة إجراءات اعتماد ITP"
    ],
    content: `<h3>ITP — خارطة الجودة التنفيذية</h3><p><strong>Inspection and Test Plan (ITP)</strong> وثيقة رسمية تُحدد: ماذا يُفتّش، ومن يُفتّش، ومتى يُوقَّف العمل، وكيف تُوثَّق النتائج. هي الوثيقة المحورية في ضمان الجودة لمشاريع UGC.</p><h3>أنواع نقاط التفتيش</h3><ul><li><strong>Hold Point (HP)</strong>: العمل يتوقف كلياً حتى يُوقّع المفتش. للأنشطة الحرجة غير القابلة للتفتيش لاحقاً (Duct Proving، Sheath Test، Jointing)</li><li><strong>Witness Point (WP)</strong>: SEC/الاستشاري يُخطَر بـ 48 ساعة. إذا لم يحضر، يمكن للمقاول المتابعة مع التوثيق</li><li><strong>Review Point (RP)</strong>: المقاول يُجري العمل ويُقدّم التوثيق للمراجعة لاحقاً</li></ul><h3>هيكل ITP النموذجي</h3><p>النشاط + المرجع + دور المقاول (HP/WP/RP) + دور الاستشاري + دور SEC. مثال: Sheath Test = HP للمقاول + HP للاستشاري + HP لـ SEC.</p><h3>اعتماد ITP</h3><p>يُعدّه المقاول → يُراجعه الاستشاري → يعتمده SEC. أي عمل قبل اعتماد ITP = Non-Conformance.</p>`,
    tools: [
      { name: "ITP Template (Excel)", icon: "file-text" },
      { name: "Document Control System", icon: "hard-drive" },
      { name: "Hold Point Release Form", icon: "check-circle" }
    ],
    hseWarnings: [
      "تجاوز Hold Point بدون توقيع يُبطل القبول لهذا النشاط كاملاً",
      "إغلاق Hold Point بتوقيع غير مُخوَّل = مخالفة عقدية خطيرة"
    ],
    commonMistakes: [
      "إخطار SEC بـ 24 ساعة بدلاً من 48 لـ Witness Points",
      "تسجيل نتيجة Test قبل حضور المفتش في Hold Point"
    ],
    references: [
      "ISO 9001 — Quality Management Systems",
      "SEC Project Quality Plan Requirements",
      "FIDIC — Quality Inspection Plans"
    ]
  },
  ...
  "c9-s5-1": {
    ...
    difficulty: "متوسط",
    objectives: [
      "إتقان إعداد Method Statement مطابق لمتطلبات SEC",
      "معرفة المحتوى الإلزامي لـ MS في مشاريع HV/EHV",
      "فهم عملية مراجعة واعتماد MS",
      "معرفة كيفية تحديث MS عند تغيير الظروف"
    ],
    content: `<h3>Method Statement — صوت المقاول المكتوب</h3><p><strong>Method Statement (MS)</strong> وثيقة فنية تصف: كيف سيُنفَّذ العمل، بأي موارد، وبأي تسلسل، وبأي احتياطات جودة وسلامة.</p><h3>المحتوى الإلزامي لـ MS في مشاريع UGC</h3><ol><li><strong>Scope of Work</strong>: وصف النشاط والموقع والأبعاد</li><li><strong>References</strong>: SEC TMSS، IEC Standards، رقم الرسم</li><li><strong>Responsibilities</strong>: من المسؤول عن كل خطوة</li><li><strong>Materials & Equipment</strong>: قائمة كاملة مع مواصفات</li><li><strong>Step-by-Step Procedure</strong>: الخطوات بالتفصيل</li><li><strong>Quality Control</strong>: نقاط الفحص والمعايير</li><li><strong>Risk Assessment</strong>: الأخطار وإجراءات التحكم</li><li><strong>Emergency Procedures</strong>: ماذا نفعل عند الحوادث</li></ol><h3>عملية الاعتماد</h3><p>المقاول يُقدّم MS ≥ 7 أيام قبل النشاط → الاستشاري يُراجع خلال 5 أيام → تعديل → اعتماد. نسخة الاعتماد الأخيرة هي المرجع في الموقع.</p>`,
    tools: [
      { name: "MS Template (Word)", icon: "file-text" },
      { name: "Risk Assessment Matrix", icon: "alert-triangle" },
      { name: "Document Transmittal Form", icon: "pen-line" }
    ],
    hseWarnings: [
      "تنفيذ نشاط حرج بـ MS منتهي الصلاحية أو بدون MS معتمد = NCR فوري",
      "MS المعتمد يجب أن يكون في موقع العمل نفسه طوال التنفيذ"
    ],
    commonMistakes: [
      "نسخ MS من مشروع سابق بدون تعديل الأرقام والمراجع",
      "إهمال تحديث MS عند تغيير المعدات أو الكوادر"
    ],
    references: [
      "SEC Project Execution Manual — MS Requirements",
      "ISO 9001 — Documented Procedures",
      "CIRIA — Method Statement Best Practice"
    ]
  },
  ...
  "c9-s5-2": {
    ...
    difficulty: "متوسط",
    objectives: [
      "إتقان تطبيق Risk Assessment على أنشطة UGC",
      "بناء Risk Matrix شاملة لنشاط ميداني",
      "معرفة هرمية إجراءات التحكم (Hierarchy of Controls)",
      "فهم متطلبات توثيق RA"
    ],
    content: `<h3>Risk Assessment — منهجية التحكم في المخاطر</h3><p><strong>Risk Assessment (RA)</strong> عملية منهجية لتحديد المخاطر وتقييم احتمالية حدوثها وشدة عواقبها ووضع إجراءات التحكم. كل نشاط حرج في SEC يتطلب RA موثَّقاً.</p><h3>خطوات Risk Assessment</h3><ol><li>تحديد الأخطار</li><li>من يتأثر: عمال، جمهور، بيئة</li><li>تقييم المخاطر: Risk = Likelihood (1-5) × Severity (1-5)</li><li>إجراءات التحكم</li><li>Re-assessment: Risk المتبقي بعد التحكم</li></ol><h3>هرمية التحكم (Hierarchy of Controls)</h3><ul><li><strong>Elimination (الأفضل)</strong>: إزالة الخطر كلياً</li><li><strong>Substitution</strong>: استبدال بطريقة أقل خطراً</li><li><strong>Engineering Controls</strong>: حواجز، Shoring، تهوية</li><li><strong>Administrative Controls</strong>: PTW، تدريب</li><li><strong>PPE (الأضعف)</strong>: خوذة، قفازات — خط دفاع أخير</li></ul><h3>Risk Matrix</h3><pre>Risk Score: ≤6 = منخفض | 8-12 = متوسط | ≥15 = عالٍ</pre>`,
    tools: [
      { name: "Risk Matrix Template (Excel)", icon: "file-text" },
      { name: "JSA Form (Daily)", icon: "check-circle" },
      { name: "Incident Reporting System", icon: "alert-triangle" }
    ],
    hseWarnings: [
      "RA على الورق دون Toolbox Talk مع العمال = العمال لا يعرفون الأخطار",
      "تعيين Risk Score منخفض لكل شيء لتسهيل الاعتماد = ممارسة غير أمينة"
    ],
    commonMistakes: [
      "إهمال تحديث RA عند تغيير ظروف الموقع — RA للحفر الجاف لا يُغطي خطر الانهيار بعد الأمطار",
      "الاكتفاء بـ PPE كإجراء تحكم وحيد في مخاطر عالية"
    ],
    references: [
      "ISO 45001 — Risk Assessment",
      "HSE UK — Five Steps to Risk Assessment",
      "SEC HSE Manual — Risk Assessment Procedure"
    ]
  },
  ...
  "c9-s6-0": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم الغرض من Hold Points في ضمان الجودة",
      "معرفة Hold Points الحرجة في مشاريع UGC",
      "إتقان إجراءات الإخطار والإفراج",
      "فهم عواقب تجاوز Hold Point بدون إذن"
    ],
    content: `<h3>Hold Points — بوابات الجودة الإلزامية</h3><p><strong>Hold Points (HP)</strong> نقاط لا يُسمح فيها بالاستمرار حتى يحضر المفتش المُحدد ويُوقّع. تُوضع على الأنشطة التي إذا تجاوزتها لا يمكن العودة للتحقق.</p><h3>Hold Points الحرجة في مشاريع UGC</h3><ul><li>قبل صب الـ Duct Bank: التحقق من مواضع الأنابيب</li><li>قبل الردم فوق الكيابل: Sheath Test + Cable Tiles + Warning Tape</li><li>قبل سحب الكيابل: Duct Proving + Mandrel Test</li><li>قبل HV Test: جميع Sheath Tests + توصيلات الـ Bonding</li><li>قبل التشغيل النهائي: جميع اختبارات الـ Commissioning</li></ul><h3>إجراء الإخطار والإفراج</h3><ol><li>المقاول يُخطر الاستشاري وSEC بـ 48 ساعة مسبقاً</li><li>مفتش SEC يفحص في الوقت المحدد</li><li>عند القبول: توقيع على Hold Point Release Form</li></ol><h3>ماذا يحدث عند تجاوز Hold Point؟</h3><ul><li>Non-Conformance Report (NCR) فوري</li><li>إيقاف العمل في هذا النشاط</li><li>إعادة العمل أو إثبات مكافئ — أحياناً مستحيل</li></ul>`,
    tools: [
      { name: "Hold Point Release Form", icon: "check-circle" },
      { name: "Inspection Notification Letter", icon: "file-text" },
      { name: "ITP Status Tracker", icon: "cpu" }
    ],
    hseWarnings: [
      "مفتش SEC يصل للموقع ليجد Hold Point مُتجاوَزاً = إيقاف فوري وNCR. لا مفاوضة",
      "المقاول الذي يتجاوز Hold Points يدخل في سجل انتهاكات قد يُؤثر على تأهله مستقبلاً"
    ],
    commonMistakes: [
      "إخطار SEC بـ 24 ساعة بدلاً من 48 — قد لا يتمكن المفتش من الحضور",
      "توقيع Hold Point Release بدون فحص فعلي"
    ],
    references: [
      "SEC Project Quality Procedure — Hold Points",
      "ISO 9001 — Inspection and Test Control",
      "FIDIC — Quality Inspection Hold Points"
    ]
  },
  ...
  "c9-s6-1": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم الفرق بين Witness Points وHold Points",
      "معرفة الأنشطة التي تُحدَّد كـ Witness Points",
      "إتقان إجراء الإخطار",
      "فهم حق المقاول في المتابعة دون انتظار"
    ],
    content: `<h3>Witness Points — حضور مُفضَّل غير ملزِم</h3><p><strong>Witness Points (WP)</strong> نقاط يُخطَر فيها الاستشاري أو SEC مسبقاً ليحضروا. الفارق الجوهري عن Hold Points: إذا لم يحضر المفتش في الوقت المحدد، يحق للمقاول الاستمرار مع التوثيق.</p><h3>أمثلة Witness Points في UGC</h3><ul><li>سحب الكيابل (Cable Pulling): المفتش يُراقب قراءات Dynamometer</li><li>Proctor Test وSand Cone Test: المفتش يشهد أخذ العينات</li><li>Thermal Resistivity Test: المفتش يشهد إجراء القياس</li><li>بعض مراحل الوصل</li></ul><h3>إجراء إخطار Witness Points</h3><ol><li>إرسال Notice of Inspection (NOI) بـ 48 ساعة مسبقاً</li><li>تحديد الموقع والوقت والنشاط بدقة</li><li>إذا حضر المفتش: توقيع على Witness Report</li><li>إذا لم يحضر: انتظر ساعة ثم تابع مع توثيق كامل</li></ol>`,
    tools: [
      { name: "Notice of Inspection (NOI) Form", icon: "file-text" },
      { name: "Witness Report Form", icon: "check-circle" },
      { name: "Digital Camera (Timestamped)", icon: "camera" }
    ],
    hseWarnings: [
      "لا تُسيء استخدام غياب المفتش للتجاوز على الجودة — التوثيق يُبرئك قانونياً لكن لا يُقبّح عملاً رديئاً"
    ],
    commonMistakes: [
      "افتراض أن Witness Point مرن تماماً — إذا تكرر غياب المفتش يُشير لمشكلة تنسيق يجب رفعها",
      "إرسال NOI بالبريد العادي فقط — استخدم بريداً إلكترونياً مع طلب إيصال الاستلام"
    ],
    references: [
      "SEC Quality Procedure — Witness Points",
      "ISO 9001 — Inspection Planning",
      "FIDIC — Quality Monitoring Requirements"
    ]
  },
  ...
  "c9-s6-2": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم طبيعة Review Points وانخفاض حرجيتها",
      "معرفة الأنشطة المناسبة لـ Review Points",
      "إتقان إعداد التوثيق الخاضع للمراجعة",
      "فهم دور Review Points في منظومة الجودة"
    ],
    content: `<h3>Review Points — المراجعة البعدية</h3><p><strong>Review Points (RP)</strong> أدنى مستويات التفتيش في ITP. المقاول يُنفّذ النشاط ثم يُقدّم التوثيق للاستشاري للمراجعة. لا توقف للعمل ولا حضور مطلوب.</p><h3>أمثلة Review Points في UGC</h3><ul><li>نتائج Compaction Tests للطبقات الوسيطة غير الحرجة</li><li>سجلات الدمك اليومية</li><li>شهادات المواد (MTCs) الواردة</li><li>سجلات صيانة المعدات</li></ul><h3>متطلبات التوثيق</h3><ul><li>سجلات مُكتملة، مُؤرَّخة، وموقَّعة</li><li>صور فوتوغرافية مؤرخة</li><li>نتائج الاختبارات مع معايير القبول</li><li>تقديم الحزمة في التقرير الأسبوعي أو الشهري</li></ul><h3>Review Points لا تعني التساهل</h3><p>التوثيق الناقص سيُكشف في المراجعة ويُسبب تعليقات وطلبات إضافية تُعيق شهادة الإنجاز النهائية.</p>`,
    tools: [
      { name: "Review Package Checklist", icon: "check-circle" },
      { name: "Daily Site Record Forms", icon: "file-text" },
      { name: "Digital Photo Log", icon: "camera" }
    ],
    hseWarnings: [
      "Review Points للتوثيق لا للتقصير في الجودة — نتائج سيئة يجب تسجيلها"
    ],
    commonMistakes: [
      "الخلط بين RP وعدم وجود تفتيش — المراجعة تحدث، فقط بعد الانتهاء",
      "تقديم توثيق RP في نهاية المشروع دفعة واحدة"
    ],
    references: [
      "SEC Project Quality Plan — Inspection Classification",
      "ISO 9001 — Quality Records",
      "ITP Best Practices — Review Point Documentation"
    ]
  },
  ...
  "c9-s7-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من NCR في منظومة الجودة",
      "معرفة أنواع NCRs وتصنيفاتها",
      "إتقان إجراءات رفع NCR والاستجابة لها",
      "فهم التمييز بين NCR وObservation وPunch List Item"
    ],
    content: `<h3>NCR — الكشّاف عن الانحراف</h3><p><strong>Non-Conformance Report (NCR)</strong> وثيقة رسمية تُصدَر عند اكتشاف انحراف عن المواصفات. NCR ليس عقوبة — هو أداة لتحديد المشاكل وضمان تصحيحها منهجياً.</p><h3>أنواع NCRs</h3><ul><li><strong>Critical NCR</strong>: انحراف يُؤثر على سلامة المنظومة — إيقاف النشاط فوراً</li><li><strong>Major NCR</strong>: يُؤثر على الجودة والأداء — يستلزم Corrective Action Report</li><li><strong>Minor NCR</strong>: انحراف إداري أو توثيقي — لا يُوقف العمل</li></ul><h3>إجراء رفع وإغلاق NCR</h3><ol><li>المفتش يكتشف الانحراف ويُصدر NCR مكتوباً</li><li>المقاول يُحدد Root Cause خلال 24-48 ساعة</li><li>المقاول يُقدّم Corrective Action Plan</li><li>تنفيذ الإجراء التصحيحي</li><li>التحقق من الفعالية بالاستشاري</li><li>إغلاق NCR</li></ol><h3>NCR مقابل Observation مقابل Punch List</h3><ul><li><strong>NCR</strong>: انحراف رسمي عن مواصفة محددة</li><li><strong>Observation</strong>: ملاحظة تحذيرية — لم يصل لمستوى NCR بعد</li><li><strong>Punch List</strong>: بنود ناقصة أو غير مكتملة قبل التسليم</li></ul>`,
    tools: [
      { name: "NCR Form (SEC Standard)", icon: "alert-triangle" },
      { name: "CAR (Corrective Action Report)", icon: "file-text" },
      { name: "NCR Register (Excel)", icon: "hard-drive" }
    ],
    hseWarnings: [
      "NCR لم يُعالَج يتراكم ويُؤثر على PAC وFAC — متابعة إغلاق NCRs جزء أساسي من إدارة المشروع",
      "إخفاء انحراف خشية NCR = المشكلة تكبر وتُكتشف لاحقاً بتكلفة أعلى"
    ],
    commonMistakes: [
      "الرد على NCR بـ 'لن يحدث مرة أخرى' دون Root Cause Analysis",
      "اعتبار NCR إهانة وليس أداة تحسين"
    ],
    references: [
      "ISO 9001 — Non-Conformity and Corrective Action",
      "SEC NCR Procedure Manual",
      "FIDIC — Quality Non-Conformance Handling"
    ]
  },
  ...
  "c9-s7-1": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم أهمية Material Traceability في مشاريع UGC",
      "معرفة منظومة الترقيم والتتبع من المصنع للموقع",
      "إتقان إجراءات استلام ومطابقة المواد",
      "معرفة ما يحدث عند اكتشاف مواد غير مُعرَّفة"
    ],
    content: `<h3>Material Traceability — من المصنع للأرض</h3><p><strong>Material Traceability</strong> قدرة تتبع كل قطعة مادة من مصنعها إلى موقعها النهائي. إذا ظهر عطل في كيبل بعد سنوات، Traceability تُتيح معرفة هل هي مشكلة دفعة إنتاج كاملة.</p><h3>سلسلة التتبع في مشاريع UGC</h3><ul><li><strong>في المصنع</strong>: Batch Number + Test Certificate لكل طبل</li><li><strong>عند الاستلام</strong>: Material Receiving Inspection — مطابقة Drum Number مع MTC</li><li><strong>أثناء التنفيذ</strong>: Drum Number في Jointing Records، Batch Number لـ Joint Kits</li><li><strong>في As-Built</strong>: خريطة تُظهر أي Drum في أي مقطع</li></ul><h3>مواد غير مُعرَّفة (Unmarked Materials)</h3><p>أي مادة تصل بدون MTC أو بـ MTC غير مطابق تُوضع في Quarantine Area ولا تُستخدم حتى التحقق. إذا تعذّر التحقق: الرفض والإرجاع.</p>`,
    tools: [
      { name: "Material Receiving Inspection Form", icon: "check-circle" },
      { name: "Cable Register (Excel)", icon: "file-text" },
      { name: "Barcode/QR Scanner", icon: "search" },
      { name: "Quarantine Area Tags", icon: "alert-triangle" }
    ],
    hseWarnings: [
      "مادة بدون MTC قد تكون مُقلَّدة أو من دفعة مرفوضة — استخدامها يُلغي ضمان المشروع",
      "مزج كيابل من دفعات مختلفة في نفس المقطع دون توثيق يجعل Traceability مستحيلة"
    ],
    commonMistakes: [
      "الاكتفاء بالفحص البصري دون مطابقة الـ Drum Number مع الـ MTC",
      "رمي مُلصقات الـ Drum بعد فتح الكيبل — احتفظ بها حتى توثّقها في Cable Register"
    ],
    references: [
      "SEC TMSS — Material Traceability Requirements",
      "ISO 9001 — Product Identification and Traceability",
      "IEC 60840 — Drum Marking and Documentation"
    ]
  },
  ...
  "c9-s7-2": {
    ...
    difficulty: "مبتدئ",
    objectives: [
      "فهم دور Batch Numbers في ضمان الجودة",
      "معرفة كيفية قراءة وتفسير Batch Number",
      "إتقان توثيق Batch Numbers في سجلات المشروع",
      "فهم أهميتها في حالات الاستدعاء (Recall)"
    ],
    content: `<h3>Batch Number — بصمة المصنع</h3><p><strong>Batch Number</strong> رقم تسلسلي يُحدد دفعة إنتاج بعينها. كل كيابل مُنتَجة في نفس الفترة وبنفس المواد تشترك في Batch Number واحد. هو مفتاح Traceability الكاملة.</p><h3>أين يُجد Batch Number</h3><ul><li>على الطبل: مطبوع على Label الطبل</li><li>على Jacket الكيبل: مطبوع كل 1-2م</li><li>في MTC: مذكور في رأس الشهادة</li><li>على علب Jointing Kits: على الصندوق وكل مكوّن رئيسي</li></ul><h3>توثيق Batch Numbers في المشروع</h3><ul><li>في Cable Register: Batch Number لكل طبل</li><li>في Jointing Record: Batch Number لكل Joint Kit</li><li>في As-Built: ربط الموقع الجغرافي بـ Batch Numbers</li></ul><h3>أهمية Batch Numbers في حالات Recall</h3><p>إذا أصدر المصنع تحذيراً بشأن دفعة معيبة، سجل Batch Numbers يُتيح التعرف الفوري على المواقع المتأثرة في الشبكة.</p>`,
    tools: [
      { name: "Drum Label Scanner", icon: "search" },
      { name: "Batch Number Log Sheet", icon: "file-text" },
      { name: "Barcode Reader (Optional)", icon: "camera" }
    ],
    hseWarnings: [
      "Batch Number الذي لا يطابق MTC يُشير لخلط أو تزوير — أوقف الاستخدام وحقق"
    ],
    commonMistakes: [
      "تسجيل Drum Number فقط دون Batch Number",
      "عدم تسجيل Batch Number لـ Joint Kits — الملحقات أكثر حساسيةً للتقادم"
    ],
    references: [
      "IEC 60840 — Drum Labeling Requirements",
      "ISO 9001 — Product Identification",
      "SEC TMSS — Batch Number Documentation"
    ]
  },

  "c9-s7-3": {
    title: "MTC (Material Test Certificates)",
    category: "السلامة والجودة",
    categoryEn: "Safety & Quality",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم ما تحتويه MTC وكيفية قراءتها",
      "معرفة معايير قبول MTC في مشاريع SEC",
      "التمييز بين Mill Certificate وFactory Test Certificate وType Test Certificate",
      "معرفة إجراءات التحقق من صحة MTC"
    ],
    content: `<h3>MTC — جواز سفر المادة</h3><p><strong>Material Test Certificate (MTC)</strong> وثيقة رسمية تُثبت أن المادة تجاوزت الاختبارات المطلوبة. في مشاريع SEC، لا تُقبَل أي مادة بدون MTC معتمدة.</p><h3>أنواع MTCs في مشاريع UGC</h3><ul><li><strong>Mill Certificate</strong>: لمواد البناء الأساسية — يُثبت التركيب الكيميائي والخواص الميكانيكية</li><li><strong>Factory Test Certificate (FTC)</strong>: نتائج Routine Tests على كل طبل كيبل</li><li><strong>Type Test Certificate</strong>: نتائج Type Tests الشاملة من مختبر مستقل معتمد (KEMA، CESI)</li></ul><h3>ماذا تحتوي FTC للكيابل</h3><ul><li>رقم الطبل، طوله، الوزن الصافي</li><li>نتائج PD Test وAC Voltage Test</li><li>مقاومة الموصل DC</li><li>توقيع مهندس الجودة + ختم المختبر</li></ul><h3>التحقق من صحة MTC</h3><ul><li>اسم المصنع متطابق مع الـ Approved Vendor List</li><li>Batch/Drum Number يطابق المادة الفعلية</li><li>مختبر الاختبار ILAC Accredited</li><li>لا علامات تعديل أو تزوير</li></ul>`,
    tools: [
      { name: "MTC Verification Checklist", icon: "check-circle" },
      { name: "ILAC Accreditation Database", icon: "search" },
      { name: "MTC Filing System", icon: "hard-drive" }
    ],
    hseWarnings: [
      "MTC مزوّرة موثقة في الصناعة — تحقق دائماً من أرقام الاعتماد مع المصنع مباشرةً",
      "قبول MTC من مختبر غير معتمد (Non-ILAC) = لا قيمة قانونية لها"
    ],
    commonMistakes: [
      "قبول MTC بدون التحقق من أن Drum Number يطابق الطبل الفعلي",
      "تخزين MTCs في ملف غير منظم — البحث عن MTC محدد مستحيل بدون نظام"
    ],
    references: [
      "SEC TMSS — Material Certification Requirements",
      "IEC 60840 — Factory Test Certificates",
      "ISO/IEC 17025 — Laboratory Accreditation (ILAC)"
    ]
  },
// ===== c10: الصيانة والتسليم =====

  "c10-s1-0": {
    title: "DTS — Distributed Temperature Sensing",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "12 دقيقة",
    difficulty: "متقدم",
    objectives: [
      "فهم مبدأ عمل DTS وكيف يقيس درجة الحرارة على طول الكيبل",
      "معرفة تفسير DTS Profile والكشف عن Hot Spots",
      "معرفة متطلبات تركيب DTS في مشاريع SEC",
      "فهم ربط DTS بنظام SCADA والإنذارات التلقائية"
    ],
    content: `<h3>DTS — العيون الحرارية على طول الكيبل</h3><p><strong>Distributed Temperature Sensing (DTS)</strong> نظام يقيس درجة الحرارة على طول الكيبل كاملاً بدقة ±0.5°C كل متر — باستخدام الفايبر الضوئي كمستشعر ممتد. يُعدّ أكثر أنظمة المراقبة الحرارية تطوراً وأهمها في كيابل EHV.</p><h3>مبدأ عمل DTS (Raman Backscattering)</h3><p>جهاز DTS يُرسل نبضات ليزر عبر الفايبر. الضوء يتفاعل مع جزيئات الفايبر وينعكس — جزء منه بطاقة أعلى (Anti-Stokes) وجزء بطاقة أقل (Stokes). نسبة Anti-Stokes/Stokes تتناسب طردياً مع درجة الحرارة في تلك النقطة.</p><h3>مواصفات DTS الشائعة في SEC</h3><ul><li>دقة درجة الحرارة: ±0.5-1°C</li><li>دقة موقع القياس: ±1-2م</li><li>طول الفايبر الأقصى: 30-70 كم</li><li>زمن القراءة: كل 5-15 دقيقة</li></ul><h3>تفسير DTS Profile</h3><ul><li><strong>درجة حرارة مرتفعة موضعياً</strong>: Hot Spot يستلزم التحقيق (ضغط تربة، جسم مجاور، تدفق مياه)</li><li><strong>ارتفاع عام على طول المقطع</strong>: حمل زائد أو ضعف نقل حراري في الدفن</li><li><strong>حرارة مرتفعة بشكل مفاجئ > 90°C</strong>: تحذير فوري — قد يسبق التلف</li></ul><h3>ربط DTS بـ SCADA</h3><p>DTS يُرسل Alarm لـ SCADA عند: تجاوز T_max (الطارئ: 90°C لـ XLPE)، تجاوز معدل ارتفاع الحرارة (> 2°C/ساعة).</p>`,
    tools: [
      { name: "DTS Unit (Raman-based)", icon: "thermometer" },
      { name: "Optical Fiber (Sensing)", icon: "activity" },
      { name: "SCADA Integration Software", icon: "cpu" },
      { name: "DTS Profile Analyzer", icon: "bar-chart-2" }
    ],
    hseWarnings: [
      "DTS يكشف الحالة الحرارية — لكن لا يُتخذ قرار الإيقاف بناءً عليه وحده. يستلزم تأكيداً من المهندس المسؤول"
    ],
    commonMistakes: [
      "إهمال معايرة DTS سنوياً — الانجراف الحراري يُعطي قراءات غير دقيقة",
      "تعيين T_alarm = T_max مباشرة دون هامش — لا وقت للتدخل"
    ],
    references: [
      "IEC 60287 — Thermal Monitoring of Cables",
      "CIGRÉ Technical Brochure 556 — DTS Systems",
      "SEC TMSS — DTS Installation Requirements"
    ]
  },

  "c10-s1-1": {
    title: "PD Online Monitoring",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "10 دقيقة",
    difficulty: "متقدم",
    objectives: [
      "فهم الفرق بين PD Online وPD Offline Testing",
      "معرفة تقنيات PD Online المستخدمة في كيابل EHV",
      "تفسير نتائج PD Online واتخاذ القرار",
      "معرفة متطلبات التركيب في محطات SEC"
    ],
    content: `<h3>PD Online Monitoring — المراقبة المستمرة</h3><p><strong>PD Online Monitoring</strong> يكشف التفريغات الجزئية في الكيابل أثناء التشغيل الحي — بدون إيقاف الكيبل عن الخدمة. يُعدّ من أهم أدوات الصيانة التنبؤية لكيابل EHV.</p><h3>الفرق عن PD Offline</h3><ul><li><strong>Offline</strong>: كيبل مُعزَّل، جهد اختبار من مصدر خارجي، دقة عالية، تُجرى في Commissioning والصيانة الدورية</li><li><strong>Online</strong>: كيبل في الخدمة الكاملة، يكشف PD على جهد التشغيل الحقيقي، مستمر 24/7، دقة أقل بسبب الضوضاء</li></ul><h3>تقنيات PD Online</h3><ul><li><strong>HFCT (High Frequency Current Transformer)</strong>: يُركَّب حول شاشة الكيبل في المنهل. يكشف نبضات التيار الناتجة عن PD في نطاق 100 kHz - 30 MHz</li><li><strong>TEV (Transient Earth Voltage)</strong>: يُركَّب على خزائن المحطة. أقل حساسيةً لكن أسهل تركيباً</li><li><strong>Acoustic (UHF)</strong>: يكشف PD بالموجات فوق الصوتية</li></ul><h3>التفسير واتخاذ القرار</h3><ul><li>PD Level مستقر < 100 pC: مراقبة</li><li>PD Level مرتفع 100-1000 pC: تحقيق + فحص Offline إضافي</li><li>PD مستمر > 1000 pC مع اتجاه متصاعد: تخطيط لتخفيف الحمل أو الإيقاف</li></ul>`,
    tools: [
      { name: "HFCT Sensor (Online PD)", icon: "activity" },
      { name: "PD Data Logger", icon: "hard-drive" },
      { name: "PD Trending Software", icon: "cpu" },
      { name: "Noise Discrimination Filter", icon: "settings" }
    ],
    hseWarnings: [
      "HFCT يُركَّب حول شاشة كيبل حي — يستلزم PTW وتأريض مناسب أثناء التركيب"
    ],
    commonMistakes: [
      "عدم التمييز بين PD حقيقي وضوضاء الشبكة — Noise Discrimination إلزامي",
      "قرار الإيقاف بناءً على قراءة واحدة — الاتجاه (Trend) أهم من القيمة المطلقة"
    ],
    references: [
      "IEC 60270 — PD Measurements",
      "CIGRÉ Technical Brochure 728 — Online PD Monitoring",
      "SEC TMSS — PD Monitoring Systems"
    ]
  },

  "c10-s1-2": {
    title: "Sheath Current Monitoring",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "8 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم ما يُشير إليه تيار الشاشة في أنظمة Cross Bonding",
      "معرفة قيم تيار الشاشة المقبولة",
      "إتقان تفسير ارتفاع تيار الشاشة وتشخيص السبب",
      "معرفة كيفية ربط قياسات Sheath Current بـ SCADA"
    ],
    content: `<h3>Sheath Current Monitoring — مؤشر صحة نظام الـ Bonding</h3><p><strong>Sheath Current Monitoring</strong> يقيس باستمرار تيار الشاشة المعدنية في كيابل Cross Bonding. في نظام متوازن مثالي، تيار الشاشة = صفر. أي تيار ملاحَظ يُشير لخلل أو عدم توازن.</p><h3>أسباب ارتفاع تيار الشاشة في Cross Bonding</h3><ul><li><strong>عدم التساوي في أطوال Minor Sections</strong>: الأطول يُنتج جهداً لا يُلغى كاملاً</li><li><strong>عيب في Jacket الشاشة (Sheath Fault)</strong>: تيار يتسرب للتربة ويخلق تيار عودة في الشاشة</li><li><strong>SVL مقصورة (Short Circuit)</strong>: تُوفر مسار دائم للتيار</li><li><strong>خطأ في توصيلات Link Box</strong>: صلة مقلوبة أو غير محكمة</li></ul><h3>قيم مرجعية</h3><ul><li><strong>Cross Bonding مثالي</strong>: تيار الشاشة < 5% من تيار الموصل</li><li><strong>قابل للقبول</strong>: < 10% من تيار الموصل</li><li><strong>يستلزم تحقيقاً</strong>: > 10% أو ارتفاع مفاجئ > 50% عن القراءة المعتادة</li></ul><h3>ربط بـ SCADA</h3><p>Clamp-On CT على شاشة الكيبل في كل Link Box يُرسل البيانات لـ SCADA. الـ Alarm يُطلق عند تجاوز العتبة المبرمجة.</p>`,
    tools: [
      { name: "Clamp-On CT (Sheath Current)", icon: "activity" },
      { name: "SCADA Integration Module", icon: "cpu" },
      { name: "Sheath Current Logger", icon: "hard-drive" }
    ],
    hseWarnings: [
      "تيار شاشة مرتفع مفاجئ = احتمال عطل Jacket نشط. افحص فوراً ولا تتجاهل الإنذار"
    ],
    commonMistakes: [
      "قياس تيار الشاشة عند حمل خفيف ثم التوقع أنه سيبقى كذلك عند الحمل الكامل",
      "إهمال عدم التوازن البسيط في أطوال Minor Sections — يتراكم مع الزمن"
    ],
    references: [
      "CIGRÉ Technical Brochure 283 — Sheath Bonding Monitoring",
      "IEC 60840 — Sheath Current Requirements",
      "SEC TMSS — Online Monitoring Systems"
    ]
  },

  "c10-s1-3": {
    title: "DAS — Dynamic Ampacity Monitoring",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "10 دقيقة",
    difficulty: "متقدم",
    objectives: [
      "فهم مفهوم Dynamic Ampacity وكيف يختلف عن Static Rating",
      "معرفة مكونات نظام DAS وكيف يعمل",
      "معرفة فوائد DAS في تحسين استخدام الكيابل",
      "فهم متطلبات تركيب DAS في مشاريع SEC"
    ],
    content: `<h3>DAS — الحد الأقصى الذكي للتيار</h3><p><strong>Dynamic Ampacity System (DAS)</strong> نظام يحسب في الوقت الحقيقي الحد الأقصى للتيار المسموح به في الكيبل بناءً على: درجة الحرارة الفعلية (من DTS)، حالة التربة، والحمل السابق. يُتيح تشغيل الكيابل بحمل أعلى بأمان في الظروف الملائمة.</p><h3>Static Ampacity vs Dynamic Ampacity</h3><ul><li><strong>Static Ampacity</strong>: قيمة ثابتة مُحسوبة بأسوأ ظروف — تربة جافة (ρ = 1.2 K.m/W)، درجة حرارة مرتفعة (40°C). آمنة لكن متحفظة جداً</li><li><strong>Dynamic Ampacity</strong>: تتغير مع الظروف الفعلية. في الشتاء وتربة رطبة: Ampacity الفعلية قد تكون أعلى 20-30% من Static</li></ul><h3>مكونات DAS</h3><ul><li>DTS: يُوفّر توزيع درجة الحرارة على طول الكيبل</li><li>Soil Moisture Sensors: يُوفّران مقاومة التربة الحرارية الفعلية</li><li>Weather Station (للكيابل الجوية جزئياً): بيانات الهواء المحيط</li><li>Real-Time Thermal Model: يُحسب Ampacity في الوقت الحقيقي</li><li>SCADA Integration: يُرسل Rating الديناميكي للمشغّل</li></ul><h3>الفوائد في مشاريع SEC</h3><ul><li>تشغيل كيابل الذروة (N-1 Contingency) بطاقة أعلى</li><li>تأجيل مشاريع التوسعة بتحسين استخدام الكيابل الموجودة</li><li>مراقبة مستمرة لصحة الكيبل</li></ul>`,
    tools: [
      { name: "DTS + DAS Software (ABB/Prysmian)", icon: "cpu" },
      { name: "Soil Moisture Sensor", icon: "layers" },
      { name: "Real-Time Thermal Model", icon: "thermometer" },
      { name: "SCADA DAS Integration", icon: "activity" }
    ],
    hseWarnings: [
      "DAS يسمح بحمل أعلى — لكن الخطأ في النموذج الحراري يُسبب Overheating. التحقق الدوري من دقة النموذج إلزامي"
    ],
    commonMistakes: [
      "استخدام DAS Rating بدون التحقق من سلامة DTS — DTS معطوب يُعطي Rating خاطئاً",
      "إغفال التقييم الدوري للنموذج الحراري مع تغير خصائص التربة"
    ],
    references: [
      "IEC 60287 — Dynamic Ampacity Calculation",
      "CIGRÉ Technical Brochure 556 — DAS Systems",
      "SEC TMSS — Real-Time Thermal Monitoring"
    ]
  },
  ...
  "c10-s2-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "معرفة برنامج الصيانة الوقائية الشامل لكيابل HV/EHV في SEC",
      "فهم التسلسل الزمني للفحوصات الدورية",
      "إتقان توثيق الصيانة في سجلات SEC",
      "فهم الفرق بين الصيانة الوقائية والتنبؤية"
    ],
    content: `<h3>Preventive Maintenance — الصيانة قبل العطل</h3><p><strong>Preventive Maintenance</strong> برنامج منظم لفحص الكيابل وملحقاتها بشكل دوري قبل حدوث أي عطل. يُقلل من الأعطال المفاجئة ويُطيل عمر الأصول.</p><h3>جدول الصيانة الوقائية (SEC Standard)</h3><h3>يومياً / أسبوعياً</h3><ul><li>مراجعة قراءات DTS و SCADA</li><li>التحقق من قراءات Sheath Current</li><li>مراجعة سجلات Surge Counter في Link Boxes</li></ul><h3>ربع سنوي (3 شهور)</h3><ul><li>فحص بصري للمناهيل: رطوبة، تسرب، أبواب، إضاءة</li><li>فحص بصري لـ Link Boxes: اختام، بطاقات التعريف</li><li>قياس Sheath Integrity (5 kV DC)</li></ul><h3>سنوي</h3><ul><li>Sheath Test الكامل (10 kV DC)</li><li>فحص SVL: Leakage Current، Surge Counter</li><li>Thermal Imaging لـ Terminations والـ Link Boxes</li><li>فحص ECC Continuity</li></ul><h3>كل 5 سنوات</h3><ul><li>Tan Delta Test (VLF أو Resonant)</li><li>PD Test Offline</li><li>مراجعة شاملة لوثائق الـ As-Built والتغييرات</li></ul>`,
    tools: [
      { name: "Maintenance Management System (CMMS)", icon: "cpu" },
      { name: "10 kV DC Sheath Test Set", icon: "zap" },
      { name: "Thermal Imaging Camera (IR)", icon: "thermometer" },
      { name: "Maintenance Record Forms", icon: "file-text" }
    ],
    hseWarnings: [
      "الصيانة على كيابل حية تستلزم PTW وLOTO حتى للفحص البصري البسيط في المناهيل"
    ],
    commonMistakes: [
      "تأجيل الفحوصات الربع سنوية 'لانشغال الفريق' — فحص مؤجل يُخفي مشكلة تكبر",
      "عدم توثيق نتائج الصيانة — تاريخ الأعطال والمقاسات ثروة لا تُعوَّض"
    ],
    references: [
      "IEC 60840 — Maintenance Requirements for HV Cables",
      "CIGRÉ Technical Brochure 490 — Cable Maintenance",
      "SEC Asset Management — Preventive Maintenance Plan"
    ]
  },

  "c10-s2-1": {
    title: "Thermography (IR Scanning)",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم كيفية استخدام Thermal Imaging في صيانة كيابل HV",
      "معرفة ما يُبحث عنه في Terminations وLink Boxes",
      "إتقان تفسير Thermogram وتصنيف الأولوية",
      "معرفة متطلبات توثيق Thermography Reports"
    ],
    content: `<h3>Thermography — الرؤية الحرارية</h3><p><strong>Thermography (IR Scanning)</strong> تصوير بالأشعة تحت الحمراء يكشف نقاط الحرارة غير الطبيعية في Terminations والـ Link Boxes والـ Switchgear — وهي أولى علامات المشاكل الكهربائية.</p><h3>ما يُبحث عنه في الـ Thermogram</h3><ul><li><strong>Terminations</strong>: Hot Spot في رأس الكيبل يُشير لتوصيل ضعيف أو PD داخلي</li><li><strong>Link Boxes</strong>: SVL ساخنة = SVL متدهور أو مقصور</li><li><strong>Circuit Breakers & Disconnectors</strong>: فارق حراري > 10°C بين الأقطاب الثلاثة = مشكلة</li><li><strong>Busbar Connections</strong>: توصيل متآكل أو متراخٍ</li></ul><h3>تصنيف الأولوية (Delta T)</h3><ul><li><strong>ΔT < 5°C</strong>: طبيعي — مراقبة دورية</li><li><strong>ΔT 5-15°C</strong>: تحقيق — جدولة إصلاح</li><li><strong>ΔT 15-40°C</strong>: خطر — إصلاح فوري</li><li><strong>ΔT > 40°C</strong>: حرج — إيقاف فوري ممكن</li></ul><h3>شروط التصوير الجيد</h3><ul><li>حمل لا يقل عن 40% من الاسمي — تحت الحمل الخفيف لا تظهر المشاكل</li><li>الكاميرا مُعايَرة + Emissivity صحيح لكل سطح</li></ul>`,
    tools: [
      { name: "IR Thermal Camera (FLIR/Fluke)", icon: "thermometer" },
      { name: "Emissivity Reference Table", icon: "file-text" },
      { name: "Thermography Report Template", icon: "camera" }
    ],
    hseWarnings: [
      "Thermography على Energized Equipment يُجرى من بعد آمن — لا تفتح الألواح أثناء التصوير",
      "إنذار حراري على SVL = احتمال Arc Flash لاحق. لا تتجاهله"
    ],
    commonMistakes: [
      "Thermography عند حمل < 30% — المشاكل لا تظهر بوضوح",
      "إسناد كل ΔT لمشكلة توصيل بدون تحليل — الاختلاف في Emissivity والزاوية يُؤثر"
    ],
    references: [
      "IEC TR 62271-310 — Thermographic Inspection of Switchgear",
      "NFPA 70B — Recommended Practice for Electrical Maintenance",
      "SEC Maintenance Standard — Thermography Requirements"
    ]
  },

  "c10-s2-2": {
    title: "فحص المناهيل والمسار",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "إتقان إجراء الفحص البصري الدوري للمناهيل",
      "معرفة المعايير التي يُحكم بها على حالة المنهل",
      "معرفة فحوصات المسار السطحي",
      "إتقان التوثيق في سجل المناهيل"
    ],
    content: `<h3>فحص المناهيل — صمام الأمان البنيوي</h3><p>المناهيل تُوفّر الوصول للكيابل والوصلات وأنظمة التأريض. تدهورها يُؤثر مباشرةً على سلامة المنظومة الكهربائية.</p><h3>بنود فحص المنهل</h3><ul><li><strong>غطاء المنهل</strong>: تشقق، كسر، عدم انطباق، بطاقة تعريف</li><li><strong>الجدران والقاعدة</strong>: تشققات، تآكل خرساني، تسرب مياه</li><li><strong>حاملات الكيابل</strong>: صدأ، كسر، كيابل متدلية</li><li><strong>التهوية</strong>: مجاري هواء غير مسدودة</li><li><strong>التأريض</strong>: وصلات ECC سليمة، عدم أكسدة الموصلات</li><li><strong>الرطوبة والمياه</strong>: أي تجمع مياه في القاع يُعالَج</li><li><strong>حشرات وقوارض</strong>: أي أعشاش أو كبلات منهوشة</li></ul><h3>فحص المسار السطحي</h3><ul><li>علامات الحفر الحديث غير المُصرَّح به بالقرب من المسار</li><li>هبوط في الأرض يُشير لانهيار أسفلي</li><li>العلامات المرجعية (Marker Pots) في مواضعها</li><li>لوحات التحذير سليمة وواضحة</li></ul><h3>التوثيق</h3><p>كل منهل يحمل رقماً وصفحة في سجل المناهيل. النتائج + الصور تُسجَّل مع ختم التاريخ.</p>`,
    tools: [
      { name: "4-Gas Detector (قبل الدخول)", icon: "wind" },
      { name: "Digital Camera (Timestamped)", icon: "camera" },
      { name: "Manhole Inspection Checklist", icon: "check-circle" },
      { name: "Manhole Register", icon: "file-text" }
    ],
    hseWarnings: [
      "فحص المنهل = دخول Confined Space. Gas Test + Confined Space Permit إلزاميان",
      "منهل مليء بالمياه = خطر كهربائي مزدوج. لا تدخل قبل ضخ المياه وفحص الغازات"
    ],
    commonMistakes: [
      "إهمال فحص وصلات ECC داخل المنهل — أكثر نقطة عرضة للتآكل",
      "التصوير بدون توقيت واضح — الصور بدون تاريخ عديمة الفائدة توثيقياً"
    ],
    references: [
      "SEC Asset Management — Manhole Inspection Standard",
      "OSHA 29 CFR 1910.146 — Confined Space Entry",
      "CIGRÉ Technical Brochure 490 — Cable Route Inspection"
    ]
  },

  "c10-s2-3": {
    title: "تحديث As-Built",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم أهمية As-Built الدقيق والمُحدَّث",
      "معرفة ما يجب تحديثه عند كل تغيير",
      "إتقان إجراءات تحديث As-Built في نظام SEC",
      "فهم عواقب As-Built الخاطئ في حالات الطوارئ"
    ],
    content: `<h3>As-Built — ذاكرة الشبكة</h3><p><strong>As-Built Drawings</strong> مجموعة رسومات تعكس حالة المنظومة المُنفَّذة فعلياً — لا التصميم النظري. هي المرجع الأول في الصيانة والطوارئ وإصلاح الأعطال.</p><h3>ماذا يجب أن تتضمن As-Built للكيابل</h3><ul><li>مسار الكيابل الدقيق (إحداثيات GPS لكل نقطة تحول)</li><li>عمق الدفن في كل نقطة</li><li>أماكن المناهيل والوصلات</li><li>مواقع Link Boxes والـ SVLs</li><li>Drum Numbers في كل مقطع</li><li>تفاصيل الـ Bonding System</li><li>مسار الفايبر الضوئي</li></ul><h3>إجراءات تحديث As-Built</h3><ol><li>أي تغيير (إصلاح، استبدال، إضافة) يُوثَّق فوراً</li><li>المهندس المنفذ يعلّم التغيير على النسخة الورقية في الموقع</li><li>إدخال التحديث في نظام GIS خلال 7 أيام</li><li>موافقة المشرف الفني على النسخة المُحدَّثة</li></ol><h3>عواقب As-Built الخاطئ</h3><ul><li>حفر فوق كيابل حية بناءً على رسم قديم</li><li>فريق الطوارئ يُضيّع الوقت في البحث عن الموقع الصحيح</li><li>خسائر اقتصادية وبشرية</li></ul>`,
    tools: [
      { name: "GPS Survey Device", icon: "map-pin" },
      { name: "GIS Software (ArcGIS/AutoCAD)", icon: "cpu" },
      { name: "As-Built Revision Form", icon: "file-text" },
      { name: "Cable Route Marker", icon: "pen-line" }
    ],
    hseWarnings: [
      "As-Built خاطئ يُسبب حفراً فوق كيابل حية — أعمال الحفر دون As-Built مُحدَّث خطر مباشر"
    ],
    commonMistakes: [
      "الاكتفاء بتوثيق التغييرات يدوياً دون إدخالها في GIS",
      "عدم تحديث As-Built بعد أعمال الإصلاح الطارئة — الطوارئ تترك أعمالاً غير مُوثَّقة"
    ],
    references: [
      "SEC GIS Standards — Cable Route Documentation",
      "ISO 14500 — Asset Management Records",
      "CIGRÉ Technical Brochure — As-Built Documentation"
    ]
  },
  ...
  "c10-s3-0": {
    ...
    difficulty: "متقدم",
    objectives: [
      "فهم مبدأ TDR وكيف يحدد موقع الأعطال",
      "إتقان تشغيل جهاز TDR وتفسير الـ Reflectogram",
      "معرفة أنواع الأعطال التي يكشفها TDR",
      "تطبيق معادلة حساب موقع العطل"
    ],
    content: `<h3>TDR — رادار الكيبل</h3><p><strong>Time Domain Reflectometry (TDR)</strong> يُرسل نبضة كهربائية في الكيبل ويقيس الوقت الذي تستغرقه موجة الانعكاس للعودة. أي انقطاع أو تغيير في Impedance يُسبب انعكاساً — يُحدَّد موقعه بالمعادلة.</p><h3>معادلة حساب موقع العطل</h3><pre>d = (v × t) / 2</pre><ul><li>d = المسافة للعطل (m)</li><li>v = سرعة الإشارة في الكيبل (م/s) — تتراوح 150,000-180,000 كم/ث لـ XLPE</li><li>t = الزمن من الإرسال للاستقبال (s)</li></ul><h3>تفسير الـ Reflectogram</h3><ul><li><strong>انعكاس موجب (Upward)</strong>: زيادة في Impedance — قطع كامل، فتح دائرة</li><li><strong>انعكاس سالب (Downward)</strong>: نقصان في Impedance — قصر أرضي، رطوبة</li><li><strong>انعكاسات متعددة</strong>: وصلات في المسار (طبيعية)</li><li><strong>نهاية الكيبل</strong>: انعكاس موجب كبير</li></ul><h3>تقنيات TDR المتقدمة للكيابل HV</h3><ul><li><strong>Impulse Current Method (ICM)</strong>: نبضة عالية الطاقة لحرق الـ High Resistance Fault لتسهيل TDR</li><li><strong>Decay Method</strong>: شحن الكيبل ثم قياس انهيار الجهد عند العطل</li><li><strong>Arc Reflection Method (ARM)</strong>: للأعطال ذات المقاومة العالية</li></ul>`,
    tools: [
      { name: "TDR (Riser Bond / Megger)", icon: "activity" },
      { name: "High Voltage Pulse Generator", icon: "zap" },
      { name: "Cable Route Map", icon: "map-pin" },
      { name: "Velocity Factor Table", icon: "file-text" }
    ],
    hseWarnings: [
      "ICM تُطبق جهداً عالياً لـ Burn Down العطل — PTW كامل واحتياطيات HV Testing",
      "TDR على كيبل حي ممنوع — عزل كامل وتفريغ الشحنة قبل TDR"
    ],
    commonMistakes: [
      "استخدام Velocity Factor خاطئ — 5% خطأ في V يُعطي عشرات الأمتار خطأ في الموقع",
      "تجاهل انعكاسات الوصلات في Reflectogram — تُخلط مع انعكاسات الأعطال"
    ],
    references: [
      "IEC 62067 — Fault Location Methods for HV Cables",
      "CIGRÉ Technical Brochure — Cable Fault Locating",
      "Megger/Riser Bond TDR Application Notes"
    ]
  },

  "c10-s3-1": {
    title: "Murray Loop Test",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم مبدأ Murray Loop Test وتطبيقاته",
      "إتقان إعداد الدائرة وإجراء الاختبار",
      "تطبيق معادلة Murray لحساب موقع العطل",
      "معرفة محدودية Murray Loop وحالات الاستخدام"
    ],
    content: `<h3>Murray Loop Test — الكلاسيكي الموثوق</h3><p><strong>Murray Loop Test</strong> طريقة تقليدية موثوقة لتحديد موقع القصر الأرضي (Earth Fault) في الكيابل. يعتمد على مبدأ Wheatstone Bridge — يقيس نسبة المقاومة بين نقطة الاختبار والعطل.</p><h3>إعداد الدائرة</h3><ol><li>قصر الكيبل المعطوب بكيبل سليم في الطرف البعيد (Loop)</li><li>توصيل Wheatstone Bridge أو جهاز Murray Loop من الطرف القريب</li><li>ضبط الجسر حتى التوازن</li><li>قراءة نسبة التوازن (P/(P+Q))</li></ol><h3>معادلة Murray</h3><pre>d = 2L × (P / (P + Q))</pre><ul><li>d = المسافة من الطرف القريب للعطل (m)</li><li>L = طول الكيبل الكامل (m)</li><li>P وQ = قيم مقاومة الجسر عند التوازن</li></ul><h3>مثال</h3><p>كيبل طول 2 كم، قراءة التوازن P/(P+Q) = 0.35:</p><pre>d = 2 × 2000 × 0.35 = 1400م من الطرف القريب</pre><h3>محدودية Murray Loop</h3><ul><li>يُعطي موقعاً طولياً فقط لا موقعاً جغرافياً دقيقاً</li><li>يستلزم كيبلاً سليماً موازياً لعمل الـ Loop</li><li>للأعطال ذات المقاومة العالية (> 100 kΩ): يحتاج تكنيك Burn Down أولاً</li></ul>`,
    tools: [
      { name: "Murray Loop Bridge", icon: "activity" },
      { name: "DC Power Supply", icon: "zap" },
      { name: "Cable Length Record", icon: "file-text" },
      { name: "Short Circuit Clamp (Far End)", icon: "box" }
    ],
    hseWarnings: [
      "الطرف البعيد فيه وصلة قصر — تأكد من اتفاق الفريقين وLOTO في كلا الطرفين"
    ],
    commonMistakes: [
      "إهمال أخذ مقاومة الكيبل السليم (Return) بعين الاعتبار في الحساب",
      "استخدام Murray Loop على كيابل ثلاثية الموصل دون فهم أن القيمة تعكس مجموع أطوال الثلاث فازات"
    ],
    references: [
      "IEC 62067 — Cable Fault Location Methods",
      "Megger Application Note — Murray Loop Testing",
      "IEEE 400 — Cable Fault Locating"
    ]
  },
  ...
  "c10-s3-2": {
    ...
    difficulty: "متقدم",
    objectives: [
      "فهم Bridge Method لتحديد موقع الأعطال",
      "التمييز بين Murray Loop وVariley Loop وHibble Test",
      "معرفة حالات تطبيق كل تقنية",
      "إتقان تفسير نتائج Bridge Methods"
    ],
    content: `<h3>Bridge Methods — عائلة Wheatstone</h3><p>طرق تحديد موقع الأعطال المبنية على مبدأ Wheatstone Bridge. كلها تقيس نسبة مقاومة للتحديد الدقيق للعطل.</p><h3>1. Murray Loop (للقصر الأرضي)</h3><p>تمت مناقشته في الموضوع السابق. الأكثر استخداماً للـ Earth Fault ذات المقاومة المنخفضة.</p><h3>2. Varley Loop</h3><p>مشابه لـ Murray لكن يستخدم مقاومة متغيرة بدلاً من نسبة جسر. أكثر دقة للكيابل ذات مقاومة موصل عالية (مقطع صغير).</p><pre>d = (R × L) - r × L / 2</pre><h3>3. Hibble Test (للقطع الكامل)</h3><p>يُستخدم عندما يكون العطل Open Circuit (قطع كامل). لا يمكن عمل Loop. يقيس السعة (Capacitance) من الطرف القريب للعطل.</p><pre>C_fault / C_total = d / L</pre><h3>اختيار الطريقة المناسبة</h3><ul><li>مقاومة عطل منخفضة (< 100 Ω): Murray Loop أو Varley</li><li>مقاومة عطل عالية (1 kΩ - 10 MΩ): Burn Down ثم Murray</li><li>قطع كامل (Open Circuit): Hibble أو TDR</li></ul>`,
    tools: [
      { name: "Varley Loop Bridge", icon: "activity" },
      { name: "Capacitance Meter (Hibble)", icon: "settings" },
      { name: "High Current Burn Down Set", icon: "zap" }
    ],
    hseWarnings: [
      "Burn Down يُطبق تياراً عالياً لتحويل عطل مقاومة عالية لعطل منخفض — خطر Arc Flash"
    ],
    commonMistakes: [
      "تطبيق Murray على عطل مقاومة عالية بدون Burn Down — الجسر لا يتوازن",
      "الخلط بين نتيجة Hibble (بالسعة) ونتيجة Murray (بالمقاومة)"
    ],
    references: [
      "IEC 62067 — Cable Fault Location",
      "Megger Application Note — Bridge Methods",
      "CIGRÉ — Cable Fault Diagnosis Guide"
    ]
  },

  "c10-s3-3": {
    title: "Acoustic Pinpointing",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "9 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم مبدأ Acoustic Pinpointing وكيف يُحدد الموقع الجغرافي الدقيق",
      "إتقان تسلسل عملية التحديد الصوتي",
      "معرفة الأجهزة المستخدمة في Acoustic Pinpointing",
      "معرفة محدودية الطريقة وكيفية تحسين دقتها"
    ],
    content: `<h3>Acoustic Pinpointing — الإصغاء للعطل</h3><p><strong>Acoustic Pinpointing</strong> الخطوة الثانية بعد تحديد الموقع التقريبي بـ TDR أو Bridge Methods. تُحدد الموقع الجغرافي الدقيق على سطح الأرض لمعرفة أين تحفر.</p><h3>مبدأ العمل</h3><p>جهاز Surge Generator يُرسل نبضات جهد عالٍ للكيبل. العطل يعمل كـ Arc بشكل متكرر — كل Arc يُصدر صوتاً يُسمع على سطح الأرض فوق موقع العطل. الفريق يتحرك بـ Acoustic Sensor (Geophone) حتى يجد أعلى نقطة صوت.</p><h3>خطوات Acoustic Pinpointing</h3><ol><li>TDR أو Bridge Method يُحدد المنطقة التقريبية (± 2-10م)</li><li>توصيل Surge Generator على الكيبل</li><li>رفع الجهد بشكل متكرر (10-30 kV) — كل نبضة تُشعل Arc في العطل</li><li>السير ببطء بـ Geophone على سطح الأرض في المنطقة المُحددة</li><li>أعلى صوت = أقرب نقطة للعطل</li><li>تضييق النطاق حتى دقة ±0.5م</li></ol><h3>تحسين الدقة</h3><ul><li>التنسيق مع Magnetic Detector لمزامنة الصوت مع نبضة Surge</li><li>العمل في أوقات هادئة (فجراً) لتقليل الضوضاء السطحية</li></ul>`,
    tools: [
      { name: "Surge Generator (HV Pulse)", icon: "zap" },
      { name: "Acoustic Sensor (Geophone)", icon: "activity" },
      { name: "Magnetic Signal Detector", icon: "radio" },
      { name: "Marking Paint", icon: "pen-line" }
    ],
    hseWarnings: [
      "Surge Generator يُطبق HV على الكيبل — كل الاحتياطيات وPTW سارية",
      "لا تقترب من Surge Generator أثناء تشغيله — الجهد الخارج > 20 kV"
    ],
    commonMistakes: [
      "محاولة Acoustic Pinpointing بدون TDR مسبق — البحث بالصوت على مسار 5 كم مضيعة وقت",
      "العمل في أوقات الذروة المرورية — الضوضاء تُغرق صوت Arc"
    ],
    references: [
      "CIGRÉ Technical Brochure — Cable Fault Pinpointing",
      "Megger/Baur Application Note — Acoustic Pinpointing",
      "IEC 62067 — Fault Location Procedure"
    ]
  },

  "c10-s3-4": {
    title: "Surge Wave Method",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "8 دقائق",
    difficulty: "متقدم",
    objectives: [
      "فهم Surge Wave Method ومتى يُستخدم",
      "إتقان إجراء Surge Wave Fault Location",
      "معرفة الفرق بين Surge Wave وTDR العادي",
      "معرفة تفسير Oscillogram الناتج"
    ],
    content: `<h3>Surge Wave Method — للأعطال الصعبة</h3><p><strong>Surge Wave Method</strong> طريقة تُستخدم للأعطال ذات المقاومة العالية التي لا يكشفها TDR العادي. تُطبق نبضة HV وتلتقط انعكاس الموجة من نقطة العطل عند لحظة انطلاق Arc.</p><h3>لماذا الأعطال عالية المقاومة صعبة؟</h3><p>TDR العادي يُرسل نبضة صغيرة الجهد. الكيبل بعطل مقاومة عالية (1 MΩ مثلاً) يُمرّر الإشارة دون انعكاس واضح — لا يكشفه TDR.</p><h3>مبدأ Surge Wave</h3><ol><li>شحن مكثف بجهد عالٍ (5-30 kV)</li><li>تفريغ الجهد في الكيبل — نبضة سريعة</li><li>العطل يتحول لـ Arc لحظياً عند الجهد الكافي</li><li>Arc يُسبب انعكاساً قوياً يُلتقط بـ TDR</li><li>تحليل Oscillogram لتحديد الموقع</li></ol><h3>قراءة Oscillogram</h3><ul><li>الانعكاس الأول = انعكاس من بداية الكيبل (مرجعي)</li><li>الانعكاس الثاني = انعكاس من نقطة العطل</li><li>فرق الزمن بين الاثنين × سرعة الإشارة / 2 = موقع العطل</li></ul>`,
    tools: [
      { name: "Surge Voltage Generator", icon: "zap" },
      { name: "TDR with HV Coupling", icon: "activity" },
      { name: "Oscilloscope / Digital Analyzer", icon: "cpu" }
    ],
    hseWarnings: [
      "Surge Wave Method يُطبق 5-30 kV على الكيبل — كل الاحتياطيات الكاملة لـ HV Testing",
      "Arc في نقطة العطل يُصدر ضغطاً وحرارة — ابتعد عن المنطقة التقريبية أثناء الاختبار"
    ],
    commonMistakes: [
      "عدم ضبط سرعة الإشارة (Velocity Factor) بدقة — الخطأ يصل عشرات الأمتار",
      "الخلط بين انعكاس البداية وانعكاس العطل في Oscillogram"
    ],
    references: [
      "IEC 62067 — Advanced Fault Location Methods",
      "BAUR Application Note — Surge Wave Method",
      "CIGRÉ — High Resistance Fault Location"
    ]
  },
  ...
  "c10-s4-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من Punch List في مرحلة التسليم",
      "معرفة كيفية إعداد Punch List شامل",
      "فهم تصنيفات بنود Punch List",
      "معرفة إجراءات إغلاق Punch List"
    ],
    content: `<h3>Punch List — قائمة الناقص</h3><p><strong>Punch List</strong> قائمة بجميع البنود التي تحتاج إكمالاً أو تصحيحاً قبل منح شهادة التسليم النهائية. تُعدّ بعد الفحص الأولي (Pre-Commissioning Walkthrough).</p><h3>تصنيف بنود Punch List</h3><ul><li><strong>Category A</strong>: حرجة — يجب إغلاقها قبل الـ PAC أو التشغيل. مثال: Sheath Test فاشل، توثيق ناقص لـ Hold Point</li><li><strong>Category B</strong>: مهمة — تُغلق خلال مدة محددة بعد التشغيل (30-90 يوم). مثال: ملصقات ناقصة، بسط غير مكتمل</li><li><strong>Category C</strong>: ملاحظات — تُوثَّق لكن لا تُؤخر التسليم</li></ul><h3>إعداد Punch List شامل</h3><ol><li>Walkthrough ميداني من الفريق المشترك (المقاول + الاستشاري + SEC)</li><li>تسجيل كل بند: رقم، وصف، موقع، تصنيف، الجهة المسؤولة، الموعد</li><li>صور فوتوغرافية لكل بند</li></ol><h3>إغلاق بنود Punch List</h3><p>المقاول يُصحح البند → يُخطر المفتش → يُتحقق المفتش → يُغلق البند بتوقيع. نسبة إغلاق Category A يجب أن تكون 100% قبل PAC.</p>`,
    tools: [
      { name: "Punch List Tracker (Excel)", icon: "file-text" },
      { name: "Digital Camera", icon: "camera" },
      { name: "Punch List Closure Form", icon: "check-circle" }
    ],
    hseWarnings: [
      "Category A Punch List Item لم يُغلق = التشغيل ممنوع"
    ],
    commonMistakes: [
      "تصنيف بند حرج كـ Category B لتجنب تأخير التسليم",
      "إغلاق بند في Punch List دون تحقق فعلي من الإصلاح"
    ],
    references: [
      "FIDIC — Defects Notification Period",
      "SEC Project Execution Manual — Punch List",
      "ISO 9001 — Product Verification"
    ]
  },
  ...
  "c10-s4-1": {
    ...
    difficulty: "متقدم",
    objectives: [
      "فهم الغرض من SAT وتسلسله في منظومة التسليم",
      "معرفة الاختبارات المُدرجة في SAT لمشاريع HV/EHV",
      "إتقان إجراء الـ SAT ومتطلبات التوثيق",
      "معرفة معايير القبول وإجراءات الرفض"
    ],
    content: `<h3>SAT — اختبار القبول في الموقع</h3><p><strong>Site Acceptance Test (SAT)</strong> اختبارات شاملة تُجرى في الموقع بعد اكتمال التركيب للتحقق من أن المنظومة جاهزة للتشغيل. تسبق الـ PAC مباشرةً.</p><h3>منظومة SAT لكيابل HV/EHV</h3><ul><li><strong>Sheath Test (10 kV DC)</strong>: جميع الكيابل والمقاطع — Hold Point</li><li><strong>HV AC/DC Test</strong>: على الكيابل والوصلات والنهايات</li><li><strong>PD Test (IEC 60270)</strong>: تحت جهد HV</li><li><strong>Tan Delta (اختياري)</strong>: للكيابل EHV</li><li><strong>Sheath Bonding Tests</strong>: Induced Voltage، SVL، ECC</li><li><strong>Phasing Test</strong></li><li><strong>Protection Relay Tests</strong>: 87L، 21، 50/51</li><li><strong>CT/VT Tests</strong></li><li><strong>SCADA Verification</strong></li><li><strong>Interlocking Tests</strong></li><li><strong>End-to-End Trip Test</strong></li><li><strong>Closed Loop Test</strong></li></ul><h3>معايير القبول</h3><p>جميع الاختبارات يجب أن تجتاز قيم القبول في SEC TMSS. أي اختبار فاشل يُمنع منحه PAC حتى الإصلاح وإعادة الاختبار.</p>`,
    tools: [
      { name: "SAT Test Pack (All Test Equipment)", icon: "settings" },
      { name: "SAT Record Forms", icon: "file-text" },
      { name: "SAT Summary Report Template", icon: "cpu" }
    ],
    hseWarnings: [
      "SAT تشمل HV Testing — جميع إجراءات السلامة الكاملة لـ HV Tests سارية"
    ],
    commonMistakes: [
      "إجراء SAT قبل إغلاق جميع Category A Punch List Items",
      "تسجيل نتيجة اختبار قبل حضور مفتش SEC في Hold Points"
    ],
    references: [
      "IEC 60840 — Site Tests for HV Cables",
      "CIGRÉ Technical Brochure 531 — Commissioning of HV Cable Systems",
      "SEC TMSS — SAT Requirements"
    ]
  },

  "c10-s4-2": {
    title: "PAC (Provisional Acceptance Certificate)",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "8 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم شروط منح PAC في مشاريع SEC",
      "معرفة الوثائق المطلوبة لحزمة PAC",
      "فهم التزامات المقاول خلال Defects Liability Period",
      "معرفة الفرق بين PAC وFAC"
    ],
    content: `<h3>PAC — التسليم المبدئي</h3><p><strong>Provisional Acceptance Certificate (PAC)</strong> شهادة تُصدرها SEC تُؤكد أن المشروع أُنجز وفق المواصفات ومستعد للتشغيل، مع إبقاء المقاول مسؤولاً عن العيوب خلال فترة ضمان محددة.</p><h3>شروط منح PAC</h3><ul><li>جميع اختبارات SAT اجتازت معايير القبول</li><li>جميع Category A Punch List Items مُغلقة</li><li>النسبة المتفق عليها من Category B مُغلقة (عادة ≥ 70%)</li><li>الوثائق الكاملة مُسلَّمة</li></ul><h3>حزمة وثائق PAC</h3><ul><li>نتائج جميع اختبارات SAT موقَّعة</li><li>As-Built Drawings مُعتمدة</li><li>Operation & Maintenance Manual</li><li>Spare Parts List</li><li>Material Test Certificates</li><li>Cable Register (Drum Numbers)</li></ul><h3>Defects Liability Period (DLP)</h3><p>عادة 12-24 شهراً بعد PAC. خلالها، المقاول مُلزم بإصلاح أي عيب يظهر على نفقته. SEC تحتجز جزءاً من الدفعة (Retention Money) حتى FAC.</p>`,
    tools: [
      { name: "PAC Application Form", icon: "file-text" },
      { name: "Document Submission Checklist", icon: "check-circle" },
      { name: "Retention Money Calculator", icon: "cpu" }
    ],
    hseWarnings: [
      "المنظومة مُشغَّلة بعد PAC — أي أعمال صيانة خلال DLP تستلزم PTW كامل"
    ],
    commonMistakes: [
      "تقديم As-Built بدون مراجعة نهائية — أخطاء في As-Built تتحول لمشكلة قانونية في PAC",
      "إهمال توثيق Category B Punch List Items المتبقية في محضر PAC"
    ],
    references: [
      "FIDIC — Provisional Acceptance Certificate",
      "SEC Contract Conditions — PAC Requirements",
      "ISO 9001 — Product Handover Requirements"
    ]
  },

  "c10-s4-3": {
    title: "FAC (Final Acceptance Certificate)",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "فهم شروط منح FAC وكيف يختلف عن PAC",
      "معرفة إجراءات فحص نهاية DLP",
      "معرفة حقوق وواجبات الطرفين عند FAC",
      "فهم إجراءات تحرير Retention Money"
    ],
    content: `<h3>FAC — التسليم النهائي وإغلاق الملف</h3><p><strong>Final Acceptance Certificate (FAC)</strong> شهادة التسليم النهائية تُصدَر بعد انتهاء Defects Liability Period بنجاح. تُغلق العقد رسمياً وتُحرَّر Retention Money الباقية.</p><h3>شروط منح FAC</h3><ul><li>انتهاء Defects Liability Period (12-24 شهراً)</li><li>جميع العيوب الظاهرة خلال DLP مُصلَّحة بالكامل</li><li>جميع Punch List Items (جميع الفئات) مُغلقة</li><li>اختبارات التحقق النهائية ناجحة (إن طُلبت)</li></ul><h3>إجراءات فحص نهاية DLP</h3><ol><li>SEC وMقاول يُجريان Final Walkthrough</li><li>مراجعة جميع تقارير الصيانة خلال DLP</li><li>التحقق من إغلاق جميع NCRs والعيوب المُبلَّغة</li><li>مراجعة سجلات الصيانة والتشغيل</li></ol><h3>بعد منح FAC</h3><ul><li>تحرير Retention Money كاملاً للمقاول</li><li>انتهاء مسؤولية المقاول التعاقدية</li><li>انتقال المسؤولية الكاملة لـ SEC</li></ul>`,
    tools: [
      { name: "FAC Application Form", icon: "file-text" },
      { name: "DLP Defects Register", icon: "hard-drive" },
      { name: "Final Walkthrough Checklist", icon: "check-circle" }
    ],
    hseWarnings: [
      "بعد FAC، المقاول لا يدخل الموقع إلا بإذن رسمي من SEC — الموقع أصبح منشأة مشغَّلة"
    ],
    commonMistakes: [
      "قبول FAC بينما هناك عيوب لم تُصلح — قد تتحول لنزاع تعاقدي بعد تحرير الكفالات",
      "عدم توثيق العيوب خلال DLP رسمياً — يُضعف موقف SEC في المطالبة عند FAC"
    ],
    references: [
      "FIDIC — Final Acceptance Certificate",
      "SEC Contract Conditions — FAC and DLP",
      "ISO 9001 — Final Product Acceptance"
    ]
  },
  ...
  "c10-s4-4": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم محتوى O&M Manual المطلوب في مشاريع SEC",
      "معرفة كيفية استخدام O&M Manual في التشغيل اليومي",
      "إتقان إجراءات تحديث O&M Manual",
      "فهم دور O&M Manual في التدريب"
    ],
    content: `<h3>O&M Manual — دستور التشغيل</h3><p><strong>Operation & Maintenance Manual</strong> الدليل الشامل الذي يصف كيفية تشغيل وصيانة المنظومة المُسلَّمة. لا PAC بدونه — وبدون O&M جيد تضيع خبرة المقاول مع انتهاء العقد.</p><h3>محتوى O&M Manual المطلوب (SEC)</h3><ul><li><strong>Section 1: System Description</strong> — وصف المنظومة، المكونات، المواصفات</li><li><strong>Section 2: Operating Procedures</strong> — إجراءات التشغيل الاعتيادية والطارئة</li><li><strong>Section 3: Maintenance Procedures</strong> — الجدول الوقائي + إجراءات كل نشاط</li><li><strong>Section 4: Fault Finding</strong> — دليل تشخيص الأعطال وإجراءات الإصلاح</li><li><strong>Section 5: Spare Parts</strong> — قائمة قطع الغيار + أرقام طلب المصنع</li><li><strong>Section 6: Technical References</strong> — المعايير والمواصفات المُطبَّقة</li><li><strong>Section 7: Drawings</strong> — As-Built بالكامل</li><li><strong>Section 8: Certificates</strong> — نسخ من MTC، FAT، SAT</li></ul><h3>تحديث O&M</h3><p>أي تغيير في المنظومة (إصلاح، استبدال، إضافة) يستلزم تحديث الـ Section المعني في O&M خلال 30 يوماً.</p>`,
    tools: [
      { name: "O&M Manual Template (Word)", icon: "file-text" },
      { name: "Document Management System", icon: "hard-drive" },
      { name: "Training Materials Derived from O&M", icon: "cpu" }
    ],
    hseWarnings: [
      "إجراءات الطوارئ في O&M يجب أن تكون متاحة للمشغّلين 24/7 — نسخة رقمية ونسخة ورقية"
    ],
    commonMistakes: [
      "تسليم O&M نسخة من مشروع سابق بتغيير الاسم فقط — مراجع ومواصفات مختلفة تماماً",
      "عدم تضمين Fault Finding Guide — فريق الصيانة لاحقاً لا يعرف كيف يتصرف عند الأعطال"
    ],
    references: [
      "SEC TMSS — O&M Manual Requirements",
      "IEC 60300-3-14 — Maintenance Documentation",
      "CIGRÉ — Best Practice for Cable System Documentation"
    ]
  },
  ...
  "c10-s5-0": {
    ...
    difficulty: "متوسط",
    objectives: [
      "إتقان إجراء متابعة وإغلاق Punch List Items",
      "معرفة إجراءات تسريع إغلاق البنود المتأخرة",
      "فهم آليات التحقق من إغلاق Punch List",
      "معرفة دور Punch List في إصدار PAC"
    ],
    content: `<h3>Punch List Completion — الخط الأخير قبل التسليم</h3><p>إغلاق Punch List يستلزم منهجية وتتبعاً دقيقاً — بنود تبدو بسيطة قد تُسبب تأخير PAC أسابيع.</p><h3>إجراء متابعة Punch List</h3><ol><li>تعيين مسؤول واحد من المقاول لكل Category</li><li>اجتماع أسبوعي مراجعة Punch List بين المقاول والاستشاري</li><li>تحديث Status لكل بند (Open, In Progress, Closed)</li><li>تحديد بنود الطريق الحرج (Critical Path Items)</li></ol><h3>إغلاق البند</h3><ol><li>المقاول يُصلح/يُكمل البند</li><li>يُخطر الاستشاري بالإغلاق</li><li>الاستشاري يتحقق ميدانياً</li><li>توقيع Closure على Punch List Register</li></ol><h3>Punch List المتأخر — خيارات SEC</h3><ul><li>خصم من الدفعة المالية المعلَّقة</li><li>تفويض مقاول آخر لإتمام البنود على حساب المقاول الأصلي</li><li>عدم منح PAC حتى إغلاق Category A بالكامل</li></ul>`,
    tools: [
      { name: "Punch List Tracker (Excel/Procore)", icon: "cpu" },
      { name: "Punch List Closure Form", icon: "check-circle" },
      { name: "Progress Meeting Minutes Template", icon: "file-text" }
    ],
    hseWarnings: [
      "إصلاح Punch List Items على كيابل حية يستلزم PTW — لا إصلاح بدون تصريح"
    ],
    commonMistakes: [
      "إغلاق بند في السجل بدون تحقق ميداني — يُكتشف في Final Walkthrough مُسبباً تأخيراً",
      "عدم تحديث Punch List Register أسبوعياً — فقدان السيطرة على الوضع"
    ],
    references: [
      "FIDIC — Defects and Punch List Management",
      "SEC Contract — Punch List Closure Requirements",
      "PMI — Project Closeout Best Practices"
    ]
  },

  "c10-s5-1": {
    title: "SAT Documentation",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "معرفة متطلبات توثيق SAT الكاملة",
      "إتقان إعداد SAT Summary Report",
      "فهم إجراءات مراجعة واعتماد SAT",
      "معرفة كيفية التعامل مع النتائج الفاشلة في SAT"
    ],
    content: `<h3>SAT Documentation — الدليل الرسمي على النجاح</h3><p>توثيق SAT هو الدليل القانوني والفني على أن المنظومة اختُبرت وأُقرَّت. وثائق SAT تبقى في أرشيف SEC مدى حياة المنظومة.</p><h3>محتوى SAT Documentation Package</h3><ul><li>SAT Test Schedule: جدول زمني لجميع الاختبارات</li><li>Individual Test Records: نموذج لكل اختبار بقيمه وتوقيعات</li><li>Equipment Calibration Certificates: شهادات معايرة كل جهاز مستخدم</li><li>Non-Conformances: أي نتيجة فاشلة مع Corrective Action</li><li>Retesting Records: نتائج إعادة الاختبار</li><li>SAT Summary Report: ملخص شامل بالنتائج الكلية</li><li>Witness Signatures: توقيع مفتش SEC على كل Hold Point</li></ul><h3>التعامل مع النتائج الفاشلة</h3><ol><li>توثيق الفشل فوراً في Test Record</li><li>إصدار NCR إذا تجاوز الحد المقبول</li><li>الإصلاح + Corrective Action</li><li>إعادة الاختبار الكامل (لا يكفي الاختبار الجزئي)</li><li>توثيق نتيجة إعادة الاختبار</li></ol>`,
    tools: [
      { name: "SAT Test Record Forms (All Tests)", icon: "file-text" },
      { name: "Calibration Certificate File", icon: "check-circle" },
      { name: "SAT Summary Report Template", icon: "cpu" }
    ],
    hseWarnings: [
      "توثيق مزوَّر لنتائج SAT جريمة قانونية — لا تُوقّع على نتيجة لم تُشهدها"
    ],
    commonMistakes: [
      "تقديم SAT Package بدون شهادات معايرة الأجهزة — مرفوض فوراً",
      "إهمال توثيق الاختبارات الفاشلة والإجراءات التصحيحية"
    ],
    references: [
      "SEC TMSS — SAT Documentation Requirements",
      "ISO 9001 — Records of Inspection and Testing",
      "IEC 60840 — Test Documentation for HV Cables"
    ]
  },

  "c10-s5-2": {
    title: "PAC/FAC وثائق التسليم",
    category: "الصيانة والتسليم",
    categoryEn: "Maintenance & Handover",
    duration: "7 دقائق",
    difficulty: "متوسط",
    objectives: [
      "معرفة القائمة الكاملة لوثائق PAC وFAC",
      "إتقان ترتيب حزمة وثائق التسليم",
      "فهم إجراءات مراجعة واعتماد وثائق التسليم",
      "معرفة الأرشفة الرقمية لوثائق التسليم"
    ],
    content: `<h3>وثائق PAC/FAC — الميراث الوثائقي للمشروع</h3><p>حزمة وثائق التسليم هي ما يبقى بعد انتهاء المقاول. جودتها تحدد سهولة تشغيل وصيانة المنظومة لعقود قادمة.</p><h3>قائمة وثائق PAC الكاملة</h3><ul><li>As-Built Drawings (PDF + DWG)</li><li>O&M Manual (مُطبوع + رقمي)</li><li>Cable Register (Drum Numbers، Lengths، Batch)</li><li>SAT Test Package كاملاً</li><li>Material Test Certificates (كل المواد)</li><li>Jointing Certificates (كل وصلة)</li><li>Contractor Quality Plan + NCR Register</li><li>Vendor Manuals والـ Spare Parts</li><li>Training Records (تدريب فريق التشغيل)</li></ul><h3>إجراءات مراجعة وثائق التسليم</h3><ol><li>المقاول يُقدّم حزمة أولية ≥ 4 أسابيع قبل PAC</li><li>الاستشاري يُراجع ويُعيد بملاحظات</li><li>المقاول يُصحح ويُعيد الحزمة النهائية</li><li>SEC تعتمد وتُصدر PAC</li></ol><h3>الأرشفة الرقمية</h3><p>SEC تتطلب نسخاً رقمية منظمة: PDF للوثائق، DWG للرسومات، Excel للبيانات. ترتيب حسب نظام الترقيم المُحدد في المواصفات.</p>`,
    tools: [
      { name: "Document Submission Checklist", icon: "check-circle" },
      { name: "Document Management System (DMS)", icon: "hard-drive" },
      { name: "Document Register (Excel)", icon: "file-text" }
    ],
    hseWarnings: [
      "حفظ وثائق التسليم في مكان واحد دون نسخ احتياطية — فقدانها يُسبب مشاكل قانونية"
    ],
    commonMistakes: [
      "تقديم As-Built كـ PDF فقط بدون DWG — SEC تحتاج الملف القابل للتعديل",
      "إهمال Training Records — يُثبت أن فريق التشغيل درّب على المنظومة الجديدة"
    ],
    references: [
      "SEC Document Management Standard",
      "FIDIC — Contractor's Documents and Records",
  ...
  "c10-s5-3": {
    ...
    difficulty: "متوسط",
    objectives: [
      "إتقان إجراء Handover Meeting الرسمي",
      "معرفة محتوى محضر التسليم",
      "فهم إجراء نقل مسؤولية التشغيل",
      "فهم إجراءات تدريب فريق التشغيل"
    ],
    content: `<h3>Handover Protocol — لحظة نقل المسؤولية</h3><p><strong>Handover</strong> ليس مجرد تسليم مفاتيح — هو نقل رسمي ومنهجي للمعرفة والمسؤولية من المقاول لفريق التشغيل في SEC.</p><h3>Handover Meeting الرسمي</h3><p>يُعقد حضوره: مدير مشروع المقاول، المهندس الفني الرئيسي، مدير التشغيل في SEC، مهندس الصيانة، مسؤول السلامة. يُوثَّق بمحضر رسمي.</p><h3>محتوى محضر التسليم</h3><ul><li>إقرار باستلام جميع وثائق التسليم</li><li>إقرار باستلام Spare Parts المُتفق عليها</li><li>إقرار بإتمام التدريب</li><li>قائمة الملاحظات المفتوحة (Category B وC)</li><li>جدول زمني لإغلاق الملاحظات</li><li>توقيع جميع الأطراف</li></ul><h3>تدريب فريق التشغيل</h3><p>المقاول مُلزَم بتقديم تدريب عملي لفريق SEC قبل Handover:</p><ul><li>التشغيل الاعتيادي</li><li>الصيانة الوقائية الأساسية</li><li>إجراءات الطوارئ</li><li>استخدام جميع أنظمة المراقبة (DTS، SCADA)</li></ul>`,
    tools: [
      { name: "Handover Meeting Minutes Template", icon: "file-text" },
      { name: "Spare Parts Handover Receipt", icon: "check-circle" },
      { name: "Training Completion Certificates", icon: "layers" }
    ],
    hseWarnings: [
      "فريق تشغيل غير مُدرَّب على المنظومة الجديدة = خطر في حالات الطوارئ"
    ],
    commonMistakes: [
      "Handover بدون تسليم Spare Parts الكاملة — قطع الغيار الأولى يجب أن تكون جاهزة",
      "التدريب النظري فقط بدون تدريب عملي على الأنظمة المُركَّبة"
    ],
    references: [
      "SEC Project Execution Manual — Handover Protocol",
      "FIDIC — Taking Over Certificate",
      "IEC 60300-3-14 — Operations and Maintenance Handover"
    ]
  },
  ...
  "c10-s5-4": {
    ...
    difficulty: "متوسط",
    objectives: [
      "فهم الغرض من Knowledge Transfer في مشاريع UGC",
      "معرفة محتوى برنامج Knowledge Transfer",
      "إتقان توثيق Lessons Learned",
      "فهم كيفية الاستفادة من Knowledge Transfer في المشاريع المستقبلية"
    ],
    content: `<h3>Knowledge Transfer — نقل الحكمة المكتسبة</h3><p><strong>Knowledge Transfer</strong> ضمان أن الخبرة المكتسبة خلال المشروع لا تنتهي مع انتهاء عقد المقاول. هي الرابط بين مشروع الحاضر ومشاريع المستقبل.</p><h3>محتوى برنامج Knowledge Transfer</h3><ul><li><strong>Technical Training</strong>: تدريب فريق SEC على المنظومة بالتفصيل</li><li><strong>Lessons Learned</strong>: وثيقة تُوثّق: ما نجح، ما فشل، وكيف حُلَّت المشاكل</li><li><strong>Best Practices</strong>: الممارسات المثلى المُطبَّقة في هذا المشروع</li><li><strong>Vendor Contacts</strong>: قائمة بمصنعي المواد وممثليهم لـ After-Sales Support</li></ul><h3>توثيق Lessons Learned</h3><p>وثيقة Lessons Learned تُوزَّع على: مكتب إدارة المشاريع في SEC، فريق الاستشاري، قسم التصميم — لتُعزَّز في المشاريع القادمة.</p><h3>فوائد Knowledge Transfer</h3><ul><li>تقليل منحنى التعلم في المشاريع المستقبلية</li><li>تحسين دقة التقدير والتخطيط</li><li>بناء قدرات SEC الداخلية</li><li>تحسين مواصفات المشاريع القادمة بناءً على التجربة</li></ul>`,
    tools: [
      { name: "Lessons Learned Template (Word)", icon: "file-text" },
      { name: "Training Materials Package", icon: "cpu" },
      { name: "Vendor Contact Database", icon: "hard-drive" }
    ],
    hseWarnings: [
      "إهمال Knowledge Transfer يعني أن فريق التشغيل يبدأ من الصفر في كل مشروع"
    ],
    commonMistakes: [
      "كتابة Lessons Learned بعد انتهاء المشروع فقط — يجب توثيقها أولاً بأول طوال المشروع",
      "عدم توزيع Lessons Learned على الأقسام المعنية — تبقى في درج ولا تُستفاد منها"
    ],
    references: [
      "PMI — Project Knowledge Management",
      "SEC Asset Management — Knowledge Transfer Requirements",
      "CIGRÉ — Lessons Learned from Cable Projects"
    ]
  },
